...
CONFIG = {
	...
	--mapEvent = "@7894773", -- dia da marmota (charlotte)
...
RULE = {
	...
	mess = {
		...
		-- tracking
		conflict = {"noaction","stack","sequence","perfection","neighbor","clean","death","gift","trade","carousel","chair","spy","rain","equality","imitate","meep","random","bomb","chess","rule","steal","web","thunder","clone","luck","box","wish","ink","confuse","portal","compass","batata","curse","magnet","tornado","theft","simon","ban","dice","paradox","half","oddeven","mimic","mix","justice","share","key","hell","bluegreen"},
		type = "PASSIVE",
	},
	limbo = {
		name = "HOUSE_LIMBO",
...
CHAIRS ={"Chairs","Cadeiras","Chaises","Кресла","Sillas","椅子","Krzesła","Trónok","Koltuklar"},
MEDALS ={"Medals","Medalhas","","","","","","Medálok",""},
...
SPOTLIGHTS ={"Spotlights","Holofotes","","Подсветка","聚光燈","","Reflektorfények","Sahne ışıkları"},
VICTORY_SCREEN ={"Victory Screens","Telas de Vitória","","","","","Győzelmi Képernyők",""},
WILD_SKIN ={"Wild Card Skins","Skins de Curinga","","","","","Színválasztó Kinézetek",""},
...
FAVORITES ={"Favorites","Favoritos","","Избранное","","喜愛","","Kedvencek","Favoriler"},
FAVORITES_ADD ={"Add to favorites","Adicionar aos favoritos","","Добавить в избранное","","加到喜愛","","Hozzáadás a kedvencekhez","Favorilere ekle"},
...
CHAIRS_UNLOCKED ={"Chairs unlocked","Cadeiras desbloqueadas","Chaises débloquées","Разблокированные кресла","Sillas desbloqueadas","解鎖了的椅子數量","Odblokowane krzesła","Feloldott trónok","Açılan Koltuklar"},
FAVORITE ={"Current chair","Cadeira atual","Chaise actuelle","Текущее кресло","Silla actual","使用中的椅子","Obecne krzesło","Aktuális trón","Kullanılan Koltuk"},
...
SET_CHALLENGE ={"Ask for confirmation before challenging a +4 card","Confirmar ao desafiar +4","Demandez confirmation avant de défier une carte +4","Спросите подтверждения, прежде чем бросите карту +4","Confirmar antes de cambiar +4","在質疑 +4 卡牌的時候彈出確認視窗","Potwierdź przed Wyzwaniem +4","Megerősítés a +4-es kártya kihívásakor"," +4'e itiraz etmeden önce onay isteyin"},
...
THANKS_POPUPS ={"pop-up design","design das pop-ups","apparence des fenêtes","дизайн всплывающих окон","diseño de pop-ups","彈出動畫設計","zaprojektowanie okien","felugró üzenetek tervezése","pop-up tasarımı"},
...
THANKS_CHAIRS ={"chair design","design de cadeiras","apparence des chaises","дизайн кресел","diseño de sillas","椅子設計","zaprojektowanie krzeseł","trónok tervezése","koltukları tasarlayanlara"},
...
CHANGE_HAND ={"Change cards","Trocar cartas","Changer les cartes","Сменить карты","Cambiar Cartas","更換卡牌","Zmiana kart","Kártyák lecserélése","Değiştir"},
CHAIR_ALLERT ={"Back to your chair!","Volte para sua cadeira!","Retournez a votre chaise!","Вернитесь к своему креслу!","¡Vuelve a tu silla!","返回你的座位!","Wróć na swój fotel!","Menj vissza a trónodhoz!","Sandalyenize geri dönün!"},
PROCESSING ={"Processing...","Processando...","","","","處理中...","","Feldolgozás alatt...","İşleniyor..."},
...
CHALENGE_COLOR ={"Do you think %s has a card with this color?","Você acha que %s tem uma carta dessa cor?","","Вы думаете, что у %s есть карта такого цвета?","","你認為 %s 手上有這顏色的卡牌嗎?","","Szerinted %s rendelkezik egy ilyen színű kártyával?","Sizce %s bu renkte bir karta sahip mi?"},
...
MISSION_DESC ={"You receive a new quest every day. You can accumulate up to 3 quests.","Você recebe uma nova missão por dia. É possível acumular até 3 missões.","","Каждый день вы получаете новый квест. Вы можете накопить до 3-х квестов.","","你每天都會接到一個新任務。而最多可以累積至 3 個任務。","","Minden nap kapsz új küldetést. Összesen 3 küldetést halmozhatsz fel.","Her gün yeni bir görev alırsınız. En fazla 3 görev toplayabilirsiniz."},
MISSION_CHANGE ={"Change","Trocar","","Сменить","","更換","","Megváltoztatás","Değişiklik"},
MISSION_NEW ={"New quest in %s.","Nova missão em %s.","","Новый квест ‒ %s.","","新任務在 %s 之後。","","%s az új küldetésig.","%s içinde yeni görev."},
MISSION ={"Quests","Missões","","Квесты","","任務","","Küldetések","Görevler"},
MISSION1 ={"All Reds","Tudo Vermelho","","","","滿堂紅","","Csak Pirosak","Tüm Kırmızılar"},
MISSION1_DESC ={"Play %s red cards.","Jogue %s cartas vermelhas.","","Пойти %s раз с красной карты.","","發出 %s 張紅卡","","Játssz %s piros kártyát.","%s  kırmızı kartı oynayın."},
MISSION2 ={"All Blues","Tudo Azul","","","","一片藍","","Csak Kékek","Tüm Maviler"},
MISSION2_DESC ={"Play %s blue cards.","Jogue %s cartas azuis.","","Пойти %s раз с синей карты.","","發出 %s 張藍卡","","Játssz %s kék kártyát.","%s mavi kartları oynayın."},
MISSION3 ={"All Yellows","Tudo Amarelo","","","","黃澄澄","","Csak Sárgák","Tüm Sarılar"},
MISSION3_DESC ={"Play %s yellow cards.","Jogue %s cartas amarelas.","","Пойти %s раз с жёлтой карты.","","發出 %s 張黃卡","","Játssz %s sárga kártyát.","%s sarı kart oynayın."},
MISSION4 ={"All Greens","Tudo Verde","","","","綠油油","","Csak Zöldek","Tüm Yeşiller"},
MISSION4_DESC ={"Play %s green cards.","Jogue %s cartas verdes.","","Пойти %s раз с зелёной карты.","","發出 %s 張綠卡","","Játssz %s zöld kártyát.","%s yeşil kart oynayın."},
MISSION5 ={"Draw, friend, draw!","Compre, amigo. Compre!","","","","抽, 朋友, 抽吧!","","Húzz, barátom, húzz!","Çek, arkadaş, çek!"},
MISSION5_DESC ={"Play %s +2 cards.","Jogue %s cartas +2.","","Положить %s карт +2.","","發出 %s 張 +2 卡","","Játssz %s +2-es kártyát.","%s +2 kart oynayın."},
MISSION6 ={"Turning the Game","Vai e Vem.","","","","","","A Játékmenet Megfordítása","Oyun dönüyor"},
MISSION6_DESC ={"Play %s Reverse cards.","Jogue %s cartas Reverter.","","Положить %s карт Смены направления.","","","","Játssz %s Visszafordító kártyát.","%s Ters kartları oynat."},
MISSION7 ={"Blocker","Bloqueador","","","","","","Védő","Engelleyici"},
MISSION7_DESC ={"Play %s Skip cards.","Jogue %s cartas Pular.","","Положить %s карт Пропуска хода.","","","","Játssz %s Kimaradsz kártyát.","%s Kartları atla."},
MISSION8 ={"In Search of Zeros","Em Busca dos Zeros","","","","","","Nullák Nyomában","Sıfırlar Arayışı"},
MISSION8_DESC ={"Play %s zero cards.","Jogue %s cartas 0.","","Сходить %s раз картами с цифрой 0.","","","","Játssz %s nullás kártyát.","%s sıfır kart oynayın."},
MISSION9 ={"Persistence","Persistência","","Стойкость","","","","Kitartás","Süreklilik"},
MISSION9_DESC ={"Play %s rounds.","Jogue %s partidas.","","Сыграть %s раундов.","","","","Játssz egy játékot %s alkalommal.","%s tur oynayın."},
MISSION10 ={"Victorious","Vitorioso","","","","","","Győztes","Başarılı"},
MISSION10_DESC ={"Win %s rounds.","Vença %s partidas.","","Выиграть %s раундов.","","","","Nyerj egy játékot %s alkalommal.","%s tur kazanın."},
MISSION11 ={"UNO!","","","УНО!","","","","",""},
MISSION11_DESC ={"Say UNO %s times.","Diga UNO %s vezes.","","Сказать УНО %s раз.","","","","Kiálts UNO-t %s alkalommal.","%s kere UNO de."},
MISSION12 ={"Supply","Abastecimento","","","","","","Tartalék","Tedarik"},
MISSION12_DESC ={"Draw %s cards (without intentional drawing).","Compre %s cartas (sem compras propositais).","","Получить %s карт (не вытягивая их специально).","","","","Húzz %s kártyát (önkéntes húzás nélkül).","%s kartları çiz (kasıtlı çizim olmadan)."},
MISSION13 ={"Passing","Passando","","","","","","Továbbítás","Geçen"},
MISSION13_DESC ={"Block +2 or +4 %s times.","Bloqueie +2 ou +4 %s vezes.","","Заблокировать +2 или +4 %s раз.","","","","Védj ki +2-es vagy +4-es kártyákat % alkalommal.","%s kez +2 veya +4 ile engelle."},
MISSION14 ={"Team Win","Vitória em Dupla","","Командная победа","","","","Csapatgyőzelem","Takım Galibiyeti"},
MISSION14_DESC ={"Win a Team Match round.","Vença uma Partida em Duplas.","","Выиграть командный матч.","","","","Nyerj meg egy Csapatmérkőzést.","Bir Takım Maçı turu kazanın."},
MISSION15 ={"Red Win","Vitória Vermelha","","","","","","Piros Győzelem","Kırmızı Zafer"},
MISSION15_DESC ={"Win a round using a red card.","Vença uma partida usando uma carta vermelha.","","Выиграть с красной картой.","","","","Nyerj meg egy játékot piros kártyával.","Kırmızı kart kullanarak bir tur kazanın."},
MISSION16 ={"Blue Win","Vitória Azul","","","","","","Kék Győzelem","Mavi Zafer"},
MISSION16_DESC ={"Win a round using a blue card.","Vença uma partida usando uma carta azul.","","Выиграть с синей картой.","","","","Nyerj meg egy játékot kék kártyával.","Mavi kart kullanarak bir tur kazanın."},
MISSION17 ={"Yellow Win","Vitória Amarela","","","","","","Sárga Győzelem","Sarı Zafer"},
MISSION17_DESC ={"Win a round using a yellow card.","Vença uma partida usando uma carta amarela.","","Выиграть с жёлтой картой.","","","","Nyerj meg egy játékot sárga kártyával.","Sarı kart kullanarak bir tur kazanın."},
MISSION18 ={"Green Win","Vitória Verde","","","","","","Zöld Győzelem","Yeşil Zafer"},
MISSION18_DESC ={"Win a round using a green card.","Vença uma partida usando uma carta verde.","","Выиграть с зелёной картой.","","","","Nyerj meg egy játékot zöld kártyával.","Sarı kart kullanarak bir tur kazanın."},
MISSION19 ={"Attentive Player","Jogador Atento","","Внимательный игрок","","","","Figyelmes Játékos","Özenli Oyuncu"},
MISSION19_DESC ={"Win a round without the timer appearing during your turn.","Vença uma partida sem deixar o cronômetro aparecer na sua vez.","","Выиграть без показов таймера во время вашего хода.","","","","Nyerj meg egy játékot anélkül, hogy megjelenne az időzítő.","Sıranız sırasında zamanlayıcı görünmeden bir tur kazanın."},
MISSION20 ={"Chaotic Win","Vitória Caótica","","","","","","Kaotikus Győzelem","Kaotik Zafer"},
MISSION20_DESC ={"Win a round with the Mess rule.","Vença uma partida com a regra Bagunça.","","Выиграть с правилом Беспорядка.","","","","Nyerj meg egy játékot a Zűrzavar házszabállyal.","Karmakarışık kuralı ile bir tur kazanın."},
MISSION21 ={"Double Trouble!","Encrenca em Dobro!","","","","","","Dupla Baj!","Çifte Bela!"},
MISSION21_DESC ={"Play %s Team Match rounds.","Jogue %s Partidas em Duplas.","","Сыграть %s командных матчей.","","","","Játssz %s Csapatmérkőzést.","%s kez Takım maçı turu oynayın."},
MISSION22 ={"Chaos is Fun!","Caos é Divertido!","","","","","","A Káosz Szórakoztató!","Kaos Eğlencelidir!"},
MISSION22_DESC ={"Play %s rounds with the Mess rule.","Jogue %s partidas com a regra Bagunça.","","Сыграть %s раундов с правилом Беспорядка.","","","","Játssz %s játékot a Zűrzavar házszabállyal.","Karmakarışık kuralıyla %s tur oynayın."},
MISSION23 ={"Action Win","Vitória com Ação","","","","","","Akció Győzelem","Aksyon Zafer"},
MISSION23_DESC ={"Win a round using action card.","Vença com uma carta de ação.","","Выиграть с картой Действий.","","","","Nyerj meg egy játékot akciókártyával.","Aksiyon kartını kullanarak bir tur kazanın."},
MISSION24 ={"Together is More Fun","Juntos é Mais Divertido","","","","","","Együtt Sokkal Szórakoztatóbb","Birlikte Daha Eğlenceli"},
MISSION24_DESC ={"Play a round with your soulmate.","Jogue uma partida com sua alma-gêmea.","","Сыграть раунд вместе с вашим партнёром.","","","","Játssz egy játékot a lélektársaddal.","Ruh eşinizle bir tur oynayın."},
MISSION25 ={"Ace in the Hole","Carta na Manga","","Козырная карта","","","","Ász a Lyukban","Son Koz"},
MISSION25_DESC ={"Win a round using a Wild card.","Vença uma partida usando uma carta curinga.","","Выиграть с чёрной картой.","","","","Nyerj egy játékot Színválasztó kártyával.","Renk kartı kullanarak bir tur kazanın."},
CONSUMABLES ={"Consumables","Consumíveis","","","","","","Fogyóeszközök","Tüketim maddeleri"},
USE ={"Use","Usar","","Использовать","","","","Használ","Kullan"},
ACTIVATE ={"Enable","Ativar","","","","","","Engedélyez","Etkinleştirme"},
DEACTIVATE ={"Disable","Desativar","","","","","","Letilt","Devre Dışı"},
PUT_RULE ={"Put this rule in the next round","Colocar regra na próxima partida","","Назначить это правило для следующего раунда","","","","Rakd be ezt a házszabályt a következő játékba.","Bu kuralı bir sonraki tura koy"},
RULE_FAIL ={"Your choosen rule isn't compatible with this match. We'll try to add it in your next match.","A sua regra escolhida não é compativel com essa partida. Tentaremos adicioná-la na sua próxima partida.","","","","","","A kiválasztott szabály nem kompatibilis ezzel a játékkal. Megpróbáljuk a következő játékba berakni.",""},
OPEN_ROOM ={"Enter the name of the player (the room will remain open until they enter, if it takes 1 minute or if the room has 20 players)","Digite o nome do jogador (a sala ficará aberta até ele entrar, der 1 minuto ou a sala tiver 20 jogadores)","","","","","","Írd be a játékos nevét (a szoba nyitva marad addig amíg belép, 1 percen át, vagy amíg 20 játékos nem lesz a szobában)",""},
CANCEL ={"Cancel","Cancelar","","Отменить","","","","Mégse","İptal etmek"},
ITEM_BOT ={"Auto Play","Jogada Automática","","","","","","Automatikus Játszás","Otomatik oynatma"},
ITEM_BOT_DESC ={"Play for you when your time is up. Spend 1 unit per use.","Joga por você quando seu tempo acabar. Gasta 1 unidade por uso.","","","","","","Játszik a helyedben, ha lejár az időd. 1 egységbe kerül használatonként.","Zamanın dolduğunda senin için oyna. Her kullanım için 1 birim harcayın."},
ITEM_UNO ={"Auto UNO","UNO Automático","","","","","","Automatikus UNO","Otomatik UNO"},
ITEM_UNO_DESC ={"Say UNO for you in case you forget. Spend 1 unit per use.","Fala UNO por você caso você esqueça. Gasta 1 unidade por uso.","","","","","","UNO-t kiált a helyedben, ha elfelejtenéd. 1 egységbe kerül használatonként.","Unutmanız durumunda Kullanım başına 1 birim harcayarak sizin için UNO der."},
ITEM_LIGHT ={"Highlight Cards","Destacar Cartas","","","","","","Kártyakiemelés","Vurgu Kartları"},
ITEM_LIGHT_DESC ={"Highlights your playable cards. Spend 1 unit per match.","Destaca as suas cartas jogáveis. Gasta 1 unidade por partida.","","","","","","Kiemeli a kijátszható kártyáid. 1 egységbe kerül játékonként."," Maç başına 1 birim harcayarak oynanabilir kartlarınızı vurgular."},
ITEM_RULE ={"Magic Lamp","Lâmpada Mágica","","Волшебная лампа","","","","Varázslámpa","Sihirli Lamba"},
ITEM_RULE_DESC ={"Choose a rule to appear in your next match.","Escolha uma regra para aparecer na sua próxima partida.","","Выбирает правило, которое появится в вашем следующем раунде.","","","","Válassz egy házszabályt hogy megjelenjen a következő játékban.","Bir sonraki maçınızda görünecek bir kural seçin."},
ITEM_RESERVE ={"Reserve Seat","Reservar Lugar","","Забронировать место","","","","Hely Megőrzése","Yedek Koltuk"},
ITEM_RESERVE_DESC ={"Reserve your seat for the next match.","Reserve seu lugar para a próxima partida.","","Забронировать место в следующем раунде.","","","","Megőrzi az ülőhelyed a következő játékban.","Bir sonraki maç için yerinizi ayırtın."},
ITEM_TIME ={"Time Hammer","Marreta do Tempo","","Молот времени","","","","Időkalapács","Zaman Çekiç"},
ITEM_TIME_DESC ={"Stay immune to the hourglass for 1 hour.","Fique livre da ampulheta durante 1 hora.","","Защита от песочных часов на 1 час.","","","","Az időzítő nem hat rád 1 óráig.","Kum saatine karşı 1 saat boyunca bağışık kalın."},
ITEM_KEY ={"Room Key","Chave da Sala","","","","","","Szoba Kulcs",""},
ITEM_KEY_DESC ={"Open the room so a friend can join you.","Abra a sala para que um amigo possa juntar-se a você.","","","","","","Kinyitja a szobát, hogy egy barátod csatlakozhasson hozzád.",""},
...
FLAG_CLOUD2_MISSION ={"Unlocked by winning %s times with the Mess rule.","Desbloqueado ao vencer %s partidas com a regra Bagunça.","","Разблокируется после %s побед с правилом Беспорядка.","","在大混亂模式中勝出50次。","","A feloldáshoz nyerj 50 alkalommal a Zűrzavar szabállyal.","Karmakarışık kuralı ile 50 kez kazanarak kilidi açıldı."},
FLAG_CIRCUIT ={"Circuit","Circuito","","","","電路板","","Áramkör","Devre"},
FLAG_CIRCUIT_DESC ={"If you forget to play a card, we'll play one for you (once per match).","Se você esquecer de jogar carta, jogaremos por você (1 vez por partida)","","Если вы забыли сделать ход, мы сделаем его за вас (один раз за раунд).","","如果你忘了發出卡, 我們會幫你 (一局遊戲只限一次)。","","Ha elfelejtesz kártyát kijátszani, akkor mi megtesszük helyetted. (játékonként egyszer)","Bir kart oynamayı unuttuysanız, sizin için bir tane oynayacağız (maç başına bir kez)."},
FLAG_CIRCUIT_MISSION ={"Unlocked by defeating 9 bots in the same match (without rules).","Desbloqueado ao derrotar 9 bots na mesma partida (sem regras).","","Разблокируется после победы над 9-ю ботами одновременно за один раунд без правил.","","在同一局裡打敗9個機械人鼠解鎖 (不能使用規矩)。","","A feloldáshoz győzz le 9 robotot ugyanabban a játékban (szabályok nélkül).","Aynı maçta 9 botu yenerek kilidi açıldı (kurallar olmadan)."},
FLAG_NO_NAME ={"????","","","","","","","",""},
FLAG_NO_NAME_DESC ={"When you play a 0 over another 0, your next draw will use the Tracking rule.","Ao jogar um 0 sobre outro 0, sua próxima compra usa a regra Rastrear.","","Когда вы кладёте 0 поверх 0, на ваше следующее вытягивание карты сработает правило Отслеживания.","","","","Ha egy 0-t játszol egy másik 0-ra, a következő húzáásod a Nyomkövetés szabály alatt fog megtörténni.","Başka bir 0 üzerinden 0 oynadığınızda, bir sonraki çekilişiniz İzleme kuralını kullanır."},
FLAG_CHAMPION ={"Champion","Campeão","","Чемпион","","","","Bajnok","Şampiyon"},
FLAG_CHAMPION_DESC ={"Your first drawing uses the Fast Drawing rule. You miss your first turn.","Sua primeira compra usa a regra Compra Rápida. Você perde o primeiro turno.","","На ваше первое вытягивание карты действует правило Быстрой Взятки. Вы теряете свой первый ход.","","","","Az első húzásod a Gyors Húzás szabály alatt fog megtörténni. Kimaradsz az első körből.","İlk çiziminiz Hızlı Çizim kuralını kullanır. İlk sıranızı kaybedersiniz."},
LIGHT_YELLOW ={"Yellow Light","Luz Amarela","","","","","","Sárga Fény","Sarı ışık"},
LIGHT_BLUE ={"Blue Light","Luz Azul","","","","","","Kék Fény","Mavi ışık"},
LIGHT_GREEN ={"Green Light","Luz Verde","","","","","","Zöld Fény","Yeşil ışık"},
LIGHT_RED ={"Red Light","Luz Vermelha","","","","","","Piros Fény","Kırmızı ışık"},
LIGHT_WHITE ={"White Light","Luz Branca","","","","","","Fehér Fény","Beyaz ışık"},
LIGHT_PINK ={"Pink Light","Luz Rosa","","","","","","Rózsaszín Fény","Pembe Işık"},
LIGHT_ORANGE ={"Orange Light","Luz Laranja","","","","","","Narancssárga Fény","Turuncu Işık"},
LIGHT_BLUE_SHAMAN ={"Blue Shaman","Shaman Azul","","","","","","Kék Sámán","Mavi Şaman"},
LIGHT_GOLD_SHAMAN ={"Golden Shaman","Shaman Dourado","","","","","","Arany Sámán","Altın Şaman"},
LIGHT_DIVINE_SHAMAN ={"Divine Shaman","Shaman Divino","","","","","","Felséges Sámán","İlahi Şaman"},
MAP_CLASSIC ={"Classic Maps","Pacote Clássico","","","","","","Klasszikus Pályák","Klasik Haritalar"},
MAP_CLASSIC_DESC ={"A random classic map.","Um mapa clássico aleatório.","","","","","","Egy véletlenszerű klasszikus pálya.","Rastgele klasik bir harita."},
MAP_FAVORITE ={"Favorite Maps","Pacote Favoritos","","","","","","Kedvenc Pályák","Favori Haritalar"},
MAP_FAVORITE_DESC ={"A random favorite map.","Um mapa favorito aleatório.","","","","","","Egy véletlenszerű kedvenc pálya.","Rasgele bir favori harita."},
MAP1 ={"Classic","Clássico","","Классика","","","","Klasszikus","Klasik "},
MAP2 ={"Grass","Gramas","","","","","","Fű","Çimen"},
MAP3 ={"Castle","Castelo","","Замок","","","","Kastély","Kale"},
MAP4 ={"Ninja","","","Ниндзя","","","","",""},
MAP5 ={"Gears","Engrenagens","","","","","","Fogaskerekek","Donanımlar"},
MAP6 ={"Cafe","Café","","Кафе","","","","Kávézó","Kafe"},
MAP7 ={"Gourmet","","","Гурман","","","","Ínyenc","Gurme"},
MAP8 ={"Night Fishing","Pesca Noturna","","Ночная рыбалка","","","","Éjszakai Horgászat","Gece Balıkçılık"},
MAP9 ={"Boat","Barco","","Лодка","","","","Hajó","Tekne"},
MAP10 ={"Archeology","Arqueologia","","Археология","","","","Régészet","Arkeoloji"},
MAP11 ={"Waterfall","Cachoeira","","Водопад","","","","Vízesés","Şelale"},
MAP12 ={"Anniversary","Aniversário","","День рождения","","","","Évforduló","Yıldönümü"},
MAP13 ={"Love","Amor","","Любовь","","","","Szerelem","Aşk"},
MAP14 ={"Jurassic","Jurássico","","Юрский период","","","","","Tarih öncesi"},
MAP15 ={"Spooky","Assustador","","","","","","Rémisztő","Ürpertici"},
MAP16 ={"Forest","Floresta","","Лес","","","","Erdő","Orman"},
MAP17 ={"Moon","Lua","","Луна","","","","Hold","Ay"},
MAP18 ={"Mansion","Mansão","","Особняк","","","","Kúria","Konak"},
MAP19 ={"Garden","Jardim","","","","","","Kert","Bahçe"},
MAP20 ={"Party","Festa","","Вечеринка","","","","Buli","Parti"},
MAP21 ={"Stripes","Listras","","Полосы","","","","Csíkok","Çizgili"},
MAP22 ={"Forest 2","Floresa 2","","Лес 2","","","","Erdő 2","Orman 2"},
MAP23 ={"Christmas","Natal","","Рождество","","","","Karácsony","Noel"},
MAP24 ={"Ice","Gelo","","Лёд","","","","Jég","Buz"},
MAP25 ={"Mythology","Mitologia","","Мифология","","","","Mitológia","Mitoloji"},
MAP26 ={"Temple","Templo","","Храм","","","","Templom","Tapınak"},
MAP27 ={"Spooky 2","Assustador 2","","","","","","Rémisztő 2","Ürkütücü 2"},
MAP28 ={"Bells","Sinos","","","","","","Harangok","Çanlar"},
MAP29 ={"Blueprint","Rascunho","","","","","","Tervrajz","Taslak"},
MAP30 ={"Futuristic City","Cidade Futurista","","Город будущего","","","","Futurisztikus Város","Fütüristik şehir"},
MAP31 ={"Rocket","Foguete","","Ракета","","","","Rakéta","Roket"},
MAP32 ={"MyCity","","","","","","","","Benim şehrim"},
MAP33 ={"Party","Balada","","","","","","Buli",""},
...
SKIN_DEFAULT_MISSION ={"Unlocked by default.","Desbloqueado por padrão","Débloqué par défaut","Разблокировано по умолчанию.","Desbloquueado por defecto","自動解鎖。","Odblokowany domyślnie. ","Alapértelmezés szerint feloldva.","Varsayılan olarak kilidi açıktır."},
...
SKIN_WIN_MISSION ={"Unlocked by winning %s times.","Desbloqueado ao vencer %s vezes","Débloqué en gagnant %s fois.","Разблокируется после %s выигрышей.","Desbloqueado después de ganar %s veces","勝出 %s 場遊戲後解鎖。","Odblokuj go wygrywając %s razy","A feloldáshoz nyerj %s alkalommal.","%s kez kazanarak kilidi açıldı."},
...
SKIN_RED_MISSION ={"Unlocked by winning with a red card.","Desbloqueado ao vencer com uma carta vermelha","Débloqué en gagnant avec une carte rouge.","Разблокируется после победы с красной картой.","Desbloqueado por ganar con una carta roja","最後發出紅色卡牌而勝出後解鎖。","Odblokuj go wygrywając czerwoną kartą.","A feloldáshoz nyerj piros kártyával.","Kırmızı kart ile kazanarak kilidi açılır."},
...
SKIN_BLUE_MISSION ={"Unlocked by winning with a blue card.","Desbloqueado ao vencer com uma carta azul","Débloqué en gagnant avec une carte bleue.","Разблокируется после победы с синей картой.","Desbloqueado por ganar con una carta azul","最後發出藍色卡牌而勝出後解鎖。","Odblokuj wygrywając niebieską kartą.","A feloldáshoz nyerj kék kártyával.","Mavi kart ile kazanarak kilidi açıldı."},
...
SKIN_YELLOW_MISSION ={"Unlocked by winning with a yellow card.","Desbloqueado ao vencer com uma carta amarela","Débloqué en gagnant avec une carte jaune.","Разблокируется после победы с жёлтой картой.","Desbloqueado por ganar con una carta amarilla","最後發出黃色卡牌而勝出後解鎖。","Odblokuj go wygrywając żółtą kartą.","A feloldáshoz nyerj sárga kártyával.","Sarı kart ile kazanarak kilidi açılır."},
...
SKIN_GREEN_MISSION ={"Unlocked by winning with a green card.","Desbloqueado ao vencer com uma carta verde","Débloqué en gagnant avec une carte verte.","Разблокируется после победы с зелёной картой.","Desbloqueado por ganar con una carta verde","最後發出綠色卡牌而勝出後解鎖。","Odblokuj go wygrywając zieloną kartą.","A feloldáshoz nyerj zöld kártyával.","Yeşil kartla kazanarak kilidi açılır."},
...
SKIN_WHITE_MISSION ={"Unlocked by winning with a wild card.","Desbloqueado ao vencer com um curinga","Débloqué en gagnant avec une carte noire.","Разблокируется после победы с чёрной картой.","Desbloqueado por ganar con una carta comodín","最後發出換色卡牌而勝出後解鎖。","Odblokuj go wygrywając kartą wild.","A feloldáshoz nyerj Színválasztó kártyával.","Renk kartı ile kazanarak kilidi açılır."},
SKIN_FIRE ={"Fire Throne","Trono do Fogo","Trône de feu","Огненный Трон","Trono de Fuego","烈焰寶座","Ognisty Tron","Tűz Trón","Yangın Tahtı"},
RED_MISSION ={"Unlocked by winning %s times with a red card.","Desbloqueado ao vencer %s vezes com uma carta vermelha","Débloqué en gagnant %s fois avec une carte rouge.","Разблокируется после %s побед с красной картой.","Desbloqueado por ganar %s veces con una carta roja","最後發出紅色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy czerwoną kartą","A feloldáshoz nyerj %s alkalommal piros kártyával.","Kırmızı kart ile %s kez kazanarak kilidi açılır."},
SKIN_WATER ={"Water Throne","Trono da Água","Trône d'eau","Водный Трон","Trono de Agua","水流寶座","Wodny Tron","Víz Trón","Su Tahtı"},
BLUE_MISSION ={"Unlocked by winning %s times with a blue card.","Desbloqueado ao vencer %s vezes com uma carta azul","Débloqué en gagnant %s fois avec une carte bleue.","Разблокируется после %s побед с синей картой.","Desbloqueado por ganar %s veces con una carta azul","最後發出藍色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy niebieską kartą","A feloldáshoz nyerj %s alkalommal kék kártyával.","Mavi kart ile %s kez kazanarak kilidi açıldı."},
SKIN_EARTH ={"Earth Throne","Trono da Terra","Trône de terre","Земной Трон","Trono de Tierra","土壤寶座","Ziemny Tron","Föld Trón","Dünya Tahtı"},
YELLOW_MISSION ={"Unlocked by winning %s times with a yellow card.","Desbloqueado ao vencer %s vezes com uma carta amarela","Débloqué en gagnant %s fois avec une carte jaune.","Разблокируется после %s побед с жёлтой картой.","Desbloqueado por ganar %s veces con una carta amarilla","最後發出黃色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy żółtą kartą","A feloldáshoz nyerj %s alkalommal sárga kártyával.","%s kez sarı kart ile kazanılır."},
SKIN_AIR ={"Air Throne","Trono do Ar","Trône d'air","Воздушный Трон","Trono de Aire","氣團寶座","Powietrzny Tron","Levegő Trón","Hava Tahtı"},
GREEN_MISSION ={"Unlocked by winning %s times with a green card.","Desbloqueado ao vencer %s vezes com uma carta verde","Débloqué en gagnant %s fois avec une carte verte.","Разблокируется после %s побед с зелёной картой.","Desbloqueado por ganar %s veces con una carta verde","最後發出綠色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy zieloną kartą","A feloldáshoz nyerj %s alkalommal zöld kártyával.","Yeşil kart ile %s kez kazanarak kilidi açılır."},
...
WILD_MISSION ={"Unlocked by winning %s times with a wild card.","Desbloqueado ao vencer %s vezes com um curinga","Débloqué en gagnant %s fois avec une carte noire.","Разблокируется после %s побед с чёрной картой.","Desbloqueado por ganar %s veces con un comodín","最後發出換色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy kartą wild.","A feloldáshoz nyerj %s alkalommal Színválasztó kártyával.","Bir Renk kartıyla %s kez kazanarak kilidi açılır."},
SKIN_KING ={"King Throne","Trono do Rei","Trône du roi","Королевский Трон","Trono Real","國王寶座","Królewski Tron","Királyi Trón","Kral Tahtı"},
SKIN_KING_MISSION ={"Unlocked by winning blocking a +2 or +4.","Desbloqueado ao vencer bloqueando um +2 ou +4","Débloqué en gagnant en bloquant un +2 ou un +4.","Разблокируется после того как выиграть, заблокировав +2 или +4.","Desbloqueado por ganar bloqueando una carta +2 o una +4","在上一個玩家發出 +2 或 +4 卡牌之後繼續發出 +2 或 +4 卡牌而獲勝後解鎖。","Odblokuj go wygrywając blokowanie +2 lub +4","A feloldáshoz nyerj azzal, hogy kivédesz egy +2-es vagy +4-es kártyát.","Kazanmaya yakın oyuncuyu +2 veya +4 ile engelleyerek açılır."},
...
SKIN_ANGEL_MISSION ={"Unlocked by winning without the timer appearing during your turn.","Desbloqueado ao vencer sem deixar o cronômetro aparecer na sua vez","Débloqué en gagnant sans que le minuteur apparaisse pendant votre tour.","Разблокируется победой без показов таймера во время вашего хода.","Desbloqueado por ganar sin que el temporizador aparezca en tu turno","在你所有的發卡回合中, 別讓限時器彈出而得到勝利。","Odblokuj go wygrywając rundę bez pokazywania stopera wyznaczającego kolejkę.","A feloldáshoz nyerj anélkül, hogy az időzítő megjelenne.","Sıranız sırasında zamanlayıcı görünmeden kazanarak kilidi açılır."},
...
SKIN_SHAMAN_MISSION ={"Unlocked by accumulating %s points in a room.","Desbloqueado ao acumular mais de %s pontos em uma sala","Débloqué en accumulant %s points dans un salon.","Разблокируется после накопления %s очков в комнате.","Desbloqueado por acumular %s puntos en una sala","在房間累積達到 %s 分數後解鎖。","Odblokuj kumulując %s punktów w pokoju","A feloldáshoz gyűjts össze %s pontot egy szobában.","Bir odada %s puan toplayarak kilidi açılır."},
...
SKIN_FRAISE_MISSION ={"Unlocked by winning with a fraise.","Desbloqueado ao vencer com um morango","Débloqué en jouant avec une fraise.","Разблокируется победой с клубникой.","Desbloqueado por ganar con una fresa","和商店裡的草莓一起勝利後解鎖。","Odblokuj go wygrywając truskawką","A feloldáshoz nyerj eperrel.","Bir fraise kazanarak kilidi açıldı."},
SKIN_ILLUMINATI ={"Illuminati Throne","Trono Illuminati","Trône Illuminati","Трон Иллюминатов","Trono Illuminati","光照派寶座","Tron Illuminati","Illuminati Trón","İllumanati Tahtı"},
...
SKIN_GIFT_MISSION ={"Unlocked by winning donating a card from your hand.","Desbloqueado ao vencer doando uma carta sua para alguém.","Débloqué en gagnant en donnant une carte de votre jeu.","Разблокируется победой путём пожертвования карты из вашей руки.","Desbloqueado por ganar donando una carta de la baraja.","把你的一張卡牌捐出而獲勝後解鎖。","Odblokuj go wygrywając darowaną kartą z twojej ręki.","A feloldáshoz nyerj azzal, hogy átadsz egy kártyát a kezedből másnak.","Elinden bir kart bağışlayarak kilidi açıldı."},
SKIN_BOG ={"Bog","Privada","","Сортир","Ciénaga","坐廁","Klozet","Mocsár","Bataklık"},
SKIN_BOG_MISSION ={"Unlocked by finishing a match without having the opportunity to play.","Desbloqueado ao terminar uma partida sem ter a oportunidade de jogar.","Débloqué en finissant un jeu sans avoir joué.","Разблокируется, если за весь раунд вам не позволили сделать ни одного хода.","Unlocked by finishing a match without having the opportunity to play.","你沒有得到任何發卡牌的機會而完成一局遊戲後解鎖。","Odblokuj go kończąc rundę bez możliwości gry.","A feloldáshoz úgy kell egy játéknak befejeződnie, hogy nem volt lehetőséged játszani.","Oynama şansına sahip olmadan bir maçı bitirerek kilidi açılır."},
...
SKIN_IRON_THRONE_MISSION ={"Unlocked by successfuly challenging three +4 cards in a row.","Desbloqueado ao vencer 3 desafios de +4 consecutivos sem perder.","Débloqué en défiant avec succès trois cartes +4 d'afillée.","Разблокируется, если вызов при получении +4 был успешно брошен 3 раза подряд.","Desbloqueado por ganar tres retos de +4 en una ronda, sin perder","成功連續質疑 +4 卡牌 3 次後解鎖。","Odblokuj wygrywając 3 razy wyzwanie +4 nie ponosząc przy tym straty.","A feloldáshoz hívj ki egymás után három +4-es kártyát sikeresen.","Arka arkaya üç +4 karta başarıyla itiraz ederek kilidi açılır."},
...
SKIN_PSYCHO ={"Psychedelic Armchair","Poltrona Psicodélica","Fauteuil psychédélique","Психоделическое Кресло","Sillón Psicodélico","迷幻扶手椅子","Fotel Psychodeliczny","Pszichedelikus Fotel","Sayko Deli Koltuk"},
...
SKIN_HEART_MISSION ={"Unlocked by donating 5 or more cards at once.","Desbloqueado ao doar 5 ou mais cartas de uma só vez.","Débloqué en donnant 5 ou plus, de cartes d'un coup.","Разблокируется, пожертвовав 5 или более карт одновременно.","Desbloqueado por donar cinco o más cartas seguidas.","在一個回合裡捐出 5 張卡牌或以上後解鎖。","Odblokuj przekazując 5 lub więcej kart naraz.","A feloldáshoz adj át a kezedből másoknak egyszerre 5 vagy több kártyát.","Aynı anda 5 veya daha fazla kart bağışlayarak açılır."},
...
SKIN_SNOWMAN_MISSION ={"Unlocked by having someone eliminated by donating a card to them.","Desbloqueado ao fazer alguém ser eliminado doando uma carta para ele.","Débloqué lorsque quelqu'un est éliminé en leur donnant une carte.","Разблокируется тем, что кого-то исключают, жертвуя им карточку.","Desbloqueado al eliminar a alguien por haberle donado una carta.","向別人捐卡而令他被淘汰後解鎖。","Odblokuj eliminując kogoś przez podarowanie mu karty.","A feloldáshoz távolíts el valakit a játékból azzal, hogy kártyát adsz neki a kezedből.","Birine bir kart bağışlayarak ortadan kaldırılmasıyla açılır."},
...
SKIN_COCA_MISSION ={"Unlocked by donating a +4 to someone.","Desbloqueado ao doar um +4 para alguém.","Débloqué en donnant un +4 a quelqu'un.","Разблокируется, пожертвовав +4 кому-то.","Se desbloquea al donar una carta +4 a otro jugador.","捐出一張 +4 卡牌給別人後解鎖。","Odblokuj podarowywując komuś +4.","A feloldáshoz adj valakinek a kezedből egy +4-es kártyát.","Birine +4 bağışlayarak kilidi açıldı."},
...
SKIN_KISS_MISSION ={"Unlocked by donating to a player that donated to you.","Desbloqueado ao retribuir uma Doação que um jogador fez a você.","","","","把另一個玩家捐贈給你的卡牌給回他後解鎖。","","A feloldáshoz adj vissza egy kártyát, amit egy másik játékos adott neked.","Size bağış yapan bir oyuncuya bağış yaparak açılır."},
...
SKIN_BLACKHOLE ={"Black Hole","Buraco Negro","","","","","","Feketelyuk","Kara delik"},
SKIN_BLACKHOLE_MISSION ={"Unlocked by winning with a card not of this round.","Desbloqueado ao vencer uma partida com uma carta que veio de fora.","","","","","","A feloldáshoz nyerj olyan kártyával, amely nem ebből a játékból származik.","Bu turdan olmayan bir kartla kazanarak açılır."},
SKIN_EVILJEWEL ={"Evil Jewel","Joia Maligna","","","","","","Gonosz Ékszer","Kötü Mücevher"},
SKIN_CACTUS ={"Cactus","Cacto","","","","","","Kaktusz","Kaktüs"},
SKIN_SQUID_HOUSE ={"Squidward House","Casa do Lula Molusco","","","","","","Tunyacsáp Háza","Squidward Evi"},
SKIN_VOLCANO ={"Volcano","Vulcão","","","","","","Vulkán","Volkan"},
SKIN_NYAN ={"Nyancat Armchair","Poltrona de Nyancat","","","","","","Nyancat Fotel","Nyancat Koltuk"},
SKIN_TOY_CASTLE ={"Toy Castle","Castelo de Brinquedo","","","","","","Játékvár","Oyuncak Kale"},
SKIN_BOMBERMAN ={"Bomberman","","","","","","","","Bombacı"},
SKIN_PHOENIX ={"Phoenix","Fênix","","","","","","Főnix","Anka kuşu"},
SKIN_FIRE_TEMPLE ={"Temple of Fire","Templo de Fogo","","","","","","A Tűz Temploma","Ateş Tapınağı"},
SKIN_GHOSTFACE ={"Ghostface","","","","","","","Sikoly","Hayalet Maske"},
SKIN_IRONMAN ={"Ironman","Homem de Ferro","","","","","","Vasember","Demir Adam"},
SKIN_NINETALES ={"Ninetales","","","","","","","",""},
SKIN_PARABOLIC ={"Satellite Dishes","Antenas Parabólicas","","","","","","Parabolaantennák","Uydu antenleri"},
SKIN_TERMINATOR ={"Terminator T-800","Exterminador T-800","","","","","","Terminátor T-800","Terminatör T-800"},
...
SKIN_ANGEL_CLASSIC ={"Angelic Throne Classic","Trono Angelical Clássico","","","","","","Klasszikus Angyali Trón","Melek Taht Klasik"},
SKIN_DIAMOND_CLASSIC ={"Diamond Throne Classic","Trono de Diamante Clássico","","","","","","Klasszikus Gyémánt Trón","Elmas Taht Klasik"},
SKIN_JUNKY_CLASSIC ={"Junky Throne Classic","Trono de Sucata Clássico","","","","","","Klasszikus Kacat Trón","Hurda Taht Klasik"},
SKIN_RAINBOW_CLASSIC ={"Rainbow Throne Classic","Trono Arco-Íris Clássico","","","","","","Klasszikus Szivárvány Trón","Gökkuşağı Tahtı Klasik"},
SKIN_JOKER ={"Joker","Coringa","","","","小丑","","",""},
SKIN_BATMAN ={"Batman","","","","","蝙蝠俠","","",""},
SKIN_BUBBLES ={"Bubbles","Bolhas","","","","","","Buborékok","Kabarcıklar"},
SKIN_FAVORITES ={"Not So Mysterious Throne","Trono Não Tão Misterioso","","","","","","Nem Annyira Titokzatos Trón","O Kadar da Gizemli Olmayan Taht"},
SKIN_FAVORITES_DESC ={"This becomes one of your favorite thrones.","Isto se transforma num dos seus tronos favoritos.","","","","","","Az egyik kedvenc trónoddá változik.","Bu, en sevdiğiniz tahtlardan biri olabilir."},
SKIN_TEST ={"Test Throne","Trono de Teste","Trône de test","Тестовый Трон","Trono de Prueba","測試寶座","Test Tron","Teszt Trón","Test Tahtı"},
SKIN_BUY_MISSION ={"Unlocked by buying it at the shop.","Desbloqueado ao comprar isto na loja.","","","","","","A feloldáshoz vedd meg a boltban.","Mağazadan satın alarak kilidi açılır."},
...
HOUSE_MULLIGAN ={"Mulligan","Segunda Chance","","Пересдача","","穆里根","","","İkinci Şans"},
...
HOUSE_DEATH_DESC ={"After playing this card, anyone who can't play a card or draws due to a penalty will be eliminated.","Após jogar esta carta, quem não puder jogar cartas ou cometer um erro será eliminado.","","","","","","Miután kijátszod ezt a kártyát, bárki aki nem tud mit kijátszani, vagy elkövet egy hibáz, az kiesik a játékból.",""},
...
HOUSE_LUCK_DESC ={"When you play this card, your next drew card will be a playable card in that turn.","Ao jogar esta carta, a sua próxima carta comprada será uma carta jogável naquele turno.","","","","","","",""},
...
HOUSE_NO_U ={"NO U","Contra-ataque","","","","","","Nem, Te",""},
HOUSE_NO_U_DESC ={"You can play Reverse Cards to counterattack card draws.","Você pode jogar cartas Reverter para contra-atacar compras de carta.","","","","","","Kijátszhatsz Visszafordító kártyákat, hogy visszafordítsd a húzó kártyákat.",""},
HOUSE_HOT_COLD ={"Hot and Cold","Quente e Frio","","","","","","Hideg és Meleg",""},
HOUSE_HOT_COLD_DESC ={"Play red and blue cards to warm up or cool the game. Burning cards are replaced by new cards while frozen cards remain in your hand after played.","Jogue cartas vermelhas e azuis para esquentar ou esfriar a partida. Cartas pegando fogo são substituídas por novas cartas enquanto cartas congeladas continuam na sua mão depois de jogadas.","","","","","","Játssz piros és kék kártyákat hogy felmelegítsd vagy lehűtsd a játékot. A felgyulladt lapok új lapokra cserélődnek ki, míg a megfagyott lapok kijátszás után is a kezedben maradnak.",""},
HOUSE_SECRET ={"Secret Play","Jogada Secreta","","","","","","Titkos Játszma",""},
HOUSE_SECRET_DESC ={"You can play cards in a face-down pile. You can challenge the previous player if he does not play a valid card.","Você pode jogar cartas numa pilha virada para baixo. Você pode desafiar o jogador anterior se ele não jogar uma carta válida.","","","","","","Játszhatsz kártyákat egy lefordított halomba. Kihívhatod az előző játékost ha nem érvényes kártyát játszott ki.",""},
...
HOUSE_RED_DESC ={"When Charlotte plays a red numerical card, she donates a numerical card to a random player.","Quando Charlotte joga um número vermelho, ela doa uma carta numérica para alguém.","Lorsque Charlotte joue une carte numérique rouge, elle donne une carte numérique à un joueur aléatoire.","Когда Charlotte ложит красную цифровую карту, она жертвует цифровую карту случайному игроку.","Cuando Charlotte juega una carta numérica roja, le dona una carta a un jugador aleatorio.","當 Charlotte 發出紅色的數字卡牌, 她會向隨機一個玩家捐獻一張數字卡牌。","Kiedy Charlotte zagra czerwoną kartą z liczbą, przekazuje kartę z liczbą losowemu graczowi.","Ha Charlotte piros számkártyát játszik, átad a kezéből egy számkártyát egy véletlenszerű játékosnak.","Charlotte kırmızı bir sayısal kart oynadığında, rastgele bir oyuncuya sayısal bir kart bağışlar."},
...
TIP_4 ={"Hold <b>Shift</b> and click on a card to show it to everyone.","Segure <b>Shift</b> e clique em uma carta para mostrá-la a todos.","","","","","","Tartsd nyomva a <b>Shift</b> gombot és kattints egy kártyára, hogy megmutasd azt mindenkinek.",""},
...
TIP_12 ={"Victories and chairs can only be obtained in public rooms with 4 or more players.","Vitórias e cadeiras só são adquiridos nas salas públicas com 4 ou mais jogadores.","","","","","","Győzelmeket és trónokat csak olyan publikus szobában oldhatsz fel, ahol 4 vagy több játékos van.",""},
...
TIP_26 ={"Difficult to tell colors apart? Press O and activate colorblind mode to show symbols on the cards.","Dificuldades para diferenciar as cores? Pressione O e ative o modo daltônico para mostrar símbolos nas cartas.","","","","","","Nehézséged adódik a színek megkülönböztetésében? Nyomd meg az O gombot és kapcsolt be a színvak módot hogy szimbólumokat jeleníts meg a kártyákon.","Renkleri birbirinden ayırmak zor mu? Kartlarda sembolleri göstermek için O tuşuna basın ve renk körü modunu etkinleştirin."},
...
TIP_28 ={"Complete quests and earn tickets to spend at the #unotfm shop! Press N for more information.","Conclua missões e receba tickets para gastar na loja do #unotfm! Pressione N para mais informações..","","","","","","Végezz el küldetéseket és szerezz jegyeket, amelyeket az #unotfm boltban költhetsz el. Nyomd meg az N gombot további információért.","Görevleri tamamlayın ve #unotfm mağazasında harcayabileceğiniz biletler kazanın! Daha fazla bilgi için N'ye basın."},
TIP_29 ={"Your favorite map will appear in the room if you are the player with the most points.","O seu mapa favorito aparecerá na sala caso você seja o jogador com mais pontos.","","","","","","A kedvenc pályád fog megjelenni a szobában, ha te vagy a játékos a legtöbb ponttal.","En çok puana sahip oyuncuysanız, favori haritanız odada görünecektir."},
TIP_30 ={"At the #unotfm shop you can buy chairs and rules, among other cool items!","Na loja do #unotfm você pode comprar cadeiras, regras, entre outros itens legais!","","","","","","Az #unotfm boltban tudsz trónokat, házszabályokat és egyéb menő dolgokat vásárolni!","#Unotfm mağazasından diğer harika öğelerin yanı sıra sandalye ve kurallar satın alabilirsiniz!"},
TIP_31 ={"The shop offers 10 random items per day. Don't forget to look at it everyday!","A loja oferece 10 itens aleatórios por dia. Não se esqueça de dar uma olhada nela todos os dias!","","","","","","A bolt 10 véletlenszerű dolgot árul minden nap. Ne felejts el naponta rátekinteni!",""},
TIP_32 ={"You can unlock exclusive titles on #unotfm! Type title! for more information.","Tem como desbloquear títulos exclusivos no #unotfm! Digite !title para mais informações.","","","","","","Az #unotfm játékmódban különleges címeket tudsz feloldani! Írd be a title! parancsot további részletekért.","Her zafer için ve ayrıca oyun oynarken rastgele bir bilet alırsınız."},
TIP_33 ={"#unotfm is a non-profit voluntary project. If you want to support it, visit the Credits area in the Menu.","O #unotfm é um projeto voluntário. Se você quiser apoiar, visite a área Créditos no Menu.","","","","","","Az #unotfm egy non-profit önkéntes projekt. Ha szeretnéd támogatni, kattints a Menüben található Köszönetnyílvánítás részre.","#unotfm, kar amacı gütmeyen gönüllü bir projedir. Desteklemek istiyorsanız, Menüdeki Krediler alanını ziyaret edin."},
TIP_34 ={"Consumables can be purchased at the #unotfm shop and provide you with some extra help.","Consumíveis podem ser comprados na loja do #unotfm e oferecem algumas ajudas para você.","","","","","","Az #unotfm boltban tudsz fogyóeszközöket vásárolni, amelyek segítséget nyújthatnak számodra.","Tüketim maddeleri #unotfm mağazasından satın alınabilir ve size ekstra yardım sağlayabilir."},
TIP_35 ={"Panels are rare and powerful items that give you advantages during matches.","Painéis são itens raros e poderosos que te concedem vantagens durante as partidas.","","","","","","A panelek ritka és erőteljes tárgyak, amelyek előnyt nyújtanak számodra a játékok közben.",""},
TIP_36 ={"Some chairs for sale in the store can be acquired for free by completing specific missions. See them in the inventory!","Algumas cadeiras à venda na loja podem ser adquiridas gratuitamente completando missões específicas. Veja no inventário!","","","","","","Néhány trónt, amelyet a boltban megtalálsz, feloldhatsz ingyen is, bizonyos küldetések teljesítésével. Nézd meg őket a Leltárban!",""},
