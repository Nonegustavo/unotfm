...
LANG = { --ENBRFRESRUCNPLHUTR
MENU ={"Menu","","","Menú","Меню","菜單","","Menü","Menü"},
INVENTORY ={"Inventory","Inventário","Inventaire","Inventario","Инвентарь","物品庫","Inwentarz","Leltár","Envanter"},
NEWS ={"News","Novidades","Nouveautés","Novedades","Новости","更新快報","Wiadomości","Hírek","Haberler"},
RULES ={"Main Rules","Regras Principais","Règles principales","Reglas","Основные правила","主要規則","Główne zasady","Alapszabályok","Kurallar"},
HOUSE_RULES ={"House Rules","Regras da Casa","Règles de la maison","Reglas de la Casa","Домашние правила","自訂規矩","Domowe zasady","Házszabályok","Oda Kuralları"},
CHAIRS ={"Chairs","Cadeiras","Chaises","Sillas","Кресла","椅子","Krzesła","Székek","Koltuklar"},
POWERUPS ={"Powerups","Poderes","Bonus","Poderes","Улучшения","額外功能","Dopalacze ","Felerősítések","Güçlendirici"},
PANELS ={"Panels","Painéis","Panneaux","Paneles","Панели","名稱版面","Panele","Panelek","Paneller"},
LEADERBOARD ={"Leaderboard","Ranking","Classement","Ranking","Лидеры","排行榜","Ranking","Ranglista","Skor Tablosu"},
SPOTLIGHTS ={"Spotlights","Holofotes","","","","","Reflektorfény","Sahne ışıkları"},
MAPS ={"Maps","Mapas","","","","","","Pályák","Haritalar"},
SETTINGS ={"Settings","Opções","Paramètres","Ajustes","Настройки","設定","Ustawienia","Beállítások","Ayarlar"},
ITEMS ={"Items","Itens","Objets","Artículos","Предметы","物品","Przedmioty","Tárgyak","Eşyalar"},
PROFILE ={"Profile","Perfil","Profil","Perfil","Профиль","個人資料","Profil","Profil","Profil"},
CLOSE ={"Close","Fechar","Fermer","Cerrar","Закрыть","關閉","Zamknij","Bezárás","Kapat"},
NEXT ={"Next","Próximo","Suivant","Siguiente","Следующий","下一個","Dalej","Következő","İleri"},
BACK ={"Back","Voltar","Retour","Volver","Назад","返回","Z powrotem","Vissza","Geri"},
PREVIOUS ={"Previous","Anterior","Précédent","Anterior","Предыдущий","上一個","Wstecz","Előző","Önceki"},
...
VICTORY ={"Victories","Vitórias","Victoires","Victorias","Победы","勝利次數","Zwycięstwa","Győzelmek","Galibiyetler"},
TEAM_VICTORY ={"Team victories","Vitórias em dupla","Victoires de l'équipe","Victorias en Equipo","Командные победы","團隊勝利次數","Zwycięstwa drużynowe","Csapat győzelmek","Takım Galibiyetleri"},
ROUND_PLAYED ={"Rounds played","Partidas jogadas","Tours joués","Rondas jugadas","Раундов сыграно","玩過的回合數","Zagrane rundy","Játszott körök","Oynanılan Oyun"},
ROUND_WATCHED ={"Rounds watched","Partidas assistidas","Tours regardés","Rondas espectadas","Раундов просмотрено","旁觀場數","Obejrzane rundy","Megfigyelt körök","İzlenilen oyun"},
CHAIRS_UNLOCKED ={"Chairs unlocked","Cadeiras desbloqueadas","Chaises débloquées","Sillas desbloqueadas","Разблокированные кресла","解鎖了的椅子數量","Odblokowane krzesła","Feloldott székek","Açılan Koltuklar"},
FAVORITE ={"Current chair","Cadeira atual","Chaise actuelle","Silla actual","Текущее кресло","使用中的椅子","Obecne krzesło","Aktuális szék","Kullanılan Koltuk"},
CHANGE ={"Change","Trocar","Changer","Cambio","Сменить","更換","Zmień","Változtat","Değiştir"},
SET_COLORBLIND ={"Colorblind Mode (may cause lag)","Modo daltônico (pode causar lag)","Mode daltonien (peut causer des lags)","Modo Daltónico (Puede causar lag)","Режим дальтоника (может вызвать задержку)","色弱協助模式 (有機會導致延遲)","Tryb Kolorystyczny (może powodować lagi)","Színvak Mód (laggot okozhat)","Renk Körü Modu (Lag yapabilir)"},
SET_BELL ={"Ring the bell when it's your turn (active Transformice sounds)","Tocar sino na sua vez (ative os sons do Transformice)","Sonnez la cloche quand c'est votre tour (active les sons de Transformice)","Sonar la campana en turno (activar sonidos en Transformice)","Звенит звонок когда твоя очередь (звуки Transformice)","啟用回合提醒聲音 (啟用 Transformice 音效)","Dźwięk dzwonka w twojej turze (aktywuje dźwięki Transformice)","Szóljon harang, amikor te következel (aktiváld a Transformice hangjait)","Sıra sana geldiğinde çanı etkinleştir (Transformice seslerini aktif et)"},
SET_SHADOW ={"Card shadows (may cause lag)","Escurecimento das cartas (pode causar lag)","Ombres de cartes (peut causer des lags)","Sombras de Carta (Pueden causar lag)","Карта с тенями (может вызвать задержку)","卡牌陰影效果 (有機會導致延遲)","Cienie kart (może powodować lagi)","Kártya árnyékok (laggot okozhat)","Kart Gölgesi (Lag yapabilir)"},
SET_CHALLENGE ={"Ask for confirmation before challenging a +4 card","Confirmar ao desafiar +4","Demandez confirmation avant de défier une carte +4","Confirmar antes de cambiar +4","Спросите подтверждения, прежде чем бросите карту +4","在質疑 +4 卡牌的時候彈出確認視窗","Potwierdź przed Wyzwaniem +4","Kérjen megerősítést, mielőtt a +4 kártyát kihívja"," +4'e meydan okumadan önce onay isteyin"},
SET_COMMUNITY ={"Community","Comunidade","Communauté","Comunidad","Сообщество","社區","Społeczność","Közösség","Topluluk"},
CREDITS ={"Credits","Créditos","Crédits","Créditos","Благодарность","鳴謝","Zasługi","Köszönetnyilvánítás","Bilgilendirme"},
CREDIT_TXT ={"This minigame was developed by Ninguem#0095. Suggestions, bugs, praise or a +4 can be sent via private message on Atelier 801's forum.","Este minigame foi desenvolvido pelo Ninguem#0095. Sugestões, bugs, elogios ou um +4 podem ser enviados por mensagem privada através do fórum da Atelier 801.","Ce mini-jeu a été développé par Ninguem#0095. Suggestions, bugs, éloges ou une carte +4 peuvent être envoyés par message privé sur le forum de l'Atelier 801.","Este minijuego fue desarrollado por Ninguem#0095. Sugerencias, errores, felicitaciones o un +4 pueden ser enviados por mensaje privado a través del foro.","Эта мини-игра была разработана Ninguem#0095. Предложения, ошибки, благодарность или +4 можно отправить личным сообщением на форуме Atelier 801.","這個小遊戲是由 Ninguem#0095 創作。 如果有任何建議, 發現漏洞, 想稱讚或是有做不好的地方, 可以透過 Atelier 801 的論壇發信息聯絡。","Minigra została zaprogramowana przez Ninguem#0095. Sugestie, błędy, pochwały lub +4 można wysłać przez prywatną wiadomość na forum Atelier801.","Ezt a minijátékot Ninguem#0095 fejlesztette. Javaslatokat, hibákat, dicséretet küldhetsz privát üzenetben az Atelier801 fórum oldalán.","Bu mini oyun Ninguem#0095 tarafından geliştirilmiştir. Öneriler, hatalar, övgü veya +4, Atelier 801'in forumundaki özel mesajla gönderilebilir."},
...
THANKS ={"Thanks","Agradecimentos","Remerciements","Agradecimientos","Спасибо","感謝","Podziękowania","Köszönet","Teşekkürler"},
THANKS_TRANSLATE ={"translate to %s","tradução para %s","traduction en %s","traducido por %s","перевёл на %s","%s 翻譯","przetłumaczenie na %s","fordítás %s régióra","çeviri yapanlara"},
THANKS_CARDS ={"cards design","design das cartas","apparence des cartes","diseño de cartas","дизайн карт","卡牌設計","projektowanie kart","kártyák tervezése","kartları tasarlayanlara"},
THANKS_POPUPS ={"pop-up design","design das pop-ups","apparence des fenêtes","diseño de pop-ups","дизайн","彈出動畫設計","zaprojektowanie okien","felugró üzenetek tervezése","pop-up tasarımı"},
THANKS_MAPS ={"creating maps","criação de mapas","création de cartes","creación de mapas","создание карт","地圖製作","tworzenie map","pályák készítése","haritayı tasarlayanlara"},
THANKS_CHAIRS ={"chair design","design de cadeiras","apparence des chaises","diseño de sillas","дизайн кресел","椅子設計","zaprojektowanie krzeseł","székek tervezése","koltukları tasarlayanlara"},
WARN_AUTOSTART ={"Type !start to start the game manually.","Digite !start para iniciar o jogo manualmente.","Tapez !start pour démarrer manuellement le jeu.","Escribe !start para iniciar el juego manualmente.","Напишите !start, чтобы запустить игру вручную.","輸入 !start 開始遊戲","Typ !start do rozpoczęcia gry manualnie.","Írd be a !start parancsot a játék manuális indításához.","Oyunu manuel olarak başlatmak için !start yazın."},
START_TIP ={"Press space or duck to have a seat.","Pressione espaço ou abaixe-se para pegar uma cadeira.","Appuyez sur espace ou baissez-vous pour vous asseoir.","Presiona espacio o bájate para tener una silla.","Нажмите пробел или стрелку вниз, чтобы сесть.","蹲下或按空格鍵來加入遊戲位置","Kliknij spację lub kucnij aby zająć fotel.","Nyomd meg a szóközt vagy a lefele gombot, hogy leülj.","Oturmak için boşluk veya ördek tuşuna basın."},
SPACE ={"space","espaço","espace","Espacio","пробел","空格鍵","spacja","szóköz","space"},
PASS ={"Pass turn","Passar a vez","Passer le tour","Pasar turno","Пропустить","結束回合","Przeczekaj rundę.","Kör Átadása",""},
CHALLENGE ={"Challenge","Desafiar","Défi","Desafiar","Вызов","質疑","Wyzwij","Kihívás","Meydan okuma"},
DRAW ={"Draw","Comprar","Tirer","Tomar","Взять","抽取卡牌","Wyciągnij","Húzás","Çizme"},
CHANGE_HAND ={"Change cards","Trocar cartas","Changer les cartes","Cambiar Cartas","Сменить карты","更換卡牌","Zmiana kart","Kártyák kicserélése","Kartları değiştirin"},
CHAIR_ALLERT ={"Back to your chair!","Volte para sua cadeira!","Retournez a votre chaise!","¡Vuelve a tu silla!","Вернитесь к своему креслу!","返回你的座位!","Wróć na swój fotel!","Menj vissza a székedhez!","Sandalyenize geri dönün!"},
PROCESSING ={"Processing...","Processando...","","","","","","Processing...","İşleme..."},
PLAYER_WON ={"%s won the game!","%s venceu o jogo!","%s a gagné la partie!","¡%s gana el juego!","%s выиграл игру!","%s 勝出了遊戲!","%s wygrał grę!","%s megnyerte a játékot!","%s oyunu kazandı!"},
PLAYER_LOST ={"Everyone lost!","Todos perderam!","Tout le monde a perdu!","¡Todos han perdido!","Все проиграли!","所有人都輸了!","Wszyscy zgubieni!","Mindenki veszített!","Herkes kaybetti!"},
TEAM_WON ={"%s and %s won!","%s e %s venceram!","%s et %s ont gagné!","¡%s y %s han ganado!","%s и %s выиграли!","%s 和 %s 勝出了!","%s i %s wygrali!","%s és %s nyert!","%s ve %s kazandı!"},
PLAYER_TIED ={"Tie!","Empate!","Égalité!","¡Córbata!","Привязан!","和局!","Remis!","Döntetlen!","Kravat!"},
TEAM_SHOW_CARD ={"Click on a card to show it to your partner.","Clique em uma carta para mostrá-la ao seu parceiro!","Cliquez sur une carte pour la montrer à votre coéquipier.","Clic en una carta para mostrársela a tu compañero.","Нажмите на карту, чтобы показать её своему партнеру.","點擊卡牌來向隊友展示它。","Kliknij na kartę, aby pokazać ją swojemu partnerowi.","Kattints egy kártyára, hogy megmutasd a partnerednek.","Partnerinize göstermek için bir kartı tıklayın."},
TEAM_DESCRIPTION ={"This is your partner. Work as a team to win this match.","Este é o seu parceiro. Trabalhe em equipe para vencer esta partida.","C'est votre coéquipier. Jouez ensemble pour gagner cette partie.","Éste es tu compañero. Trabajen en equipo para ganar esta partida.","Это твой партнёр. Работайте в команде, чтобы выиграть.","他是你的隊友。以團隊形式贏得這回合吧!","To jest twój partner. Pracujcie jako drużyna, aby wygrać rundę.","Ez a partnered. Dolgozzatok csapatban, hogy megnyerjétek a mérkőzést.","Bu partneriniz. Bu maçı kazanmak için takım olarak çalışın."},
CHALENGE_COLOR ={"Do you think %s has a card with this color?","Você acha que %s tem uma carta dessa cor?","","","","","","",""},
KILL_PAWN ={"Killed the Pawn!","Matou o Peão!","Pion tué!","¡Mató al Peón!","Пешка убита!","士兵被殺掉了!","Zabito Pionka!","A Gyalog elesett!","Piyonu öldürdü!"},
KILL_BISHOP ={"Killed the Bishop!","Matou o Bispo!","Fou tué!","¡Mató al Obispo!","Офицер убит!","主教被殺掉了!","Zabito Gońca!","A Futó elesett!","Piskopos öldürdü!"},
KILL_KNIGHT ={"Killed the Knight!","Matou o Cavalo!","Chevalier tué!","¡Mató al Caballero!","Конь убит!","騎士被殺掉了!","Zabito Skoczka!","A Lovag elesett!","Şövalyeyi Öldürdü!"},
KILL_ROOK ={"Killed the Rook!","Matou a Torre!","Tour tuée!","¡Mató a la Torre!","Ладья убита!","城堡被殺掉了!","Zabito Wieżę!","A Bástya elesett!","Kaleyi Öldürdü!"},
KILL_QUEEN ={"Killed the Queen!","Matou a Rainha!","Reine tuée!","¡Mató a la Reina!","Королева убита!","王后被殺掉了!","Zabito Królową!","A Királynő elesett!","Kraliçeyi öldürdü!"},
KILL_KING ={"Killed the King!","Matou o Rei!","Roi tué!","¡Mató al Rey!","Король убит!","國王被殺掉了!","Zabito Króla!","A Király elesett!","Kralı öldürdü!"},
...
MISSION5 ={"Draw, friend, draw!","Compre, amigo. Compre!","","","","","","","Çiz, arkadaş, çiz!"},
MISSION5_DESC ={"Play %s +2 cards.","Jogue %s cartas +2.","","","","","","","%s +2 kart oynayın."},
MISSION6 ={"Turning the Game","Vai e Vem.","","","","","","",""},
...
MISSION10 ={"Victorious","Vitorioso","","","","","","","Muzaffer"},
MISSION10_DESC ={"Win %s rounds.","Vença %s partidas.","","","","","","","%s tur kazanın."},
MISSION11 ={"UNO!","","","","","","","",""},
MISSION11_DESC ={"Say UNO %s times.","Diga UNO %s vezes.","","","","","","","UNO %s kere söyle."},
MISSION12 ={"Supply","Abastecimento","","","","","","",""},
...
MISSION13 ={"Passing","Passando","","","","","","",""},
MISSION13_DESC ={"Block +2 or +4 %s times.","Bloqueie +2 ou +4 %s vezes.","","","","","","",""},
MISSION14 ={"Team Win","Vitória em Dupla","","","","","","",""},
MISSION14_DESC ={"Win a Team Match round.","Vença uma Partida em Duplas.","","","","","","",""},
MISSION15 ={"Red Win","Vitória Vermelha","","","","","","",""},
MISSION15_DESC ={"Win a round using a red card.","Vença uma partida usando uma carta vermelha.","","","","","","",""},
MISSION16 ={"Blue Win","Vitória Azul","","","","","","",""},
MISSION16_DESC ={"Win a round using a blue card.","Vença uma partida usando uma carta azul.","","","","","","",""},
MISSION17 ={"Yellow Win","Vitória Amarela","","","","","","",""},
MISSION17_DESC ={"Win a round using a yellow card.","Vença uma partida usando uma carta amarela.","","","","","","",""},
MISSION18 ={"Green Win","Vitória Verde","","","","","","",""},
MISSION18_DESC ={"Win a round using a green card.","Vença uma partida usando uma carta verde.","","","","","","",""},
MISSION19 ={"Attentive Player","Jogador Atento","","","","","","",""},
MISSION19_DESC ={"Win a round without the timer appearing during your turn.","Vença uma partida sem deixar o cronômetro aparecer na sua vez.","","","","","","",""},
MISSION20 ={"Chaotic Win","Vitória Caótica","","","","","","",""},
MISSION20_DESC ={"Win a round with the Mess rule.","Vença uma partida com a regra Bagunça.","","","","","","",""},
MISSION21 ={"Double Trouble!","Encrenca em Dobro!","","","","","","",""},
MISSION21_DESC ={"Play %s Team Match rounds.","Jogue %s Partidas em Duplas.","","","","","","","%s Takım Maçı turlarını oynayın."},
MISSION22 ={"Chaos is Fun!","Caos é Divertido!","","","","","","","Kaos Eğlencelidir!"},
MISSION22_DESC ={"Play %s rounds with the Mess rule.","Jogue %s partidas com a regra Bagunça.","","","","","","","Mess kuralıyla %s tur oynayın."},
MISSION23 ={"Action Win","Vitória com Ação","","","","","","",""},
...
MISSION25 ={"Ace in the Hole","Carta na Manga","","","","","","",""},
MISSION25_DESC ={"Win a round using a Wild card.","Vença uma partida usando uma carta curinga.","","","","","","",""},
CONSUMABLES ={"Consumables","Consumíveis","","","","","","","Sarf"},
USE ={"Use","Usar","","","","","","","Kullan"},
...
ITEM_UNO_DESC ={"Say UNO for you in case you forget. Spend 1 unit per use.","Fala UNO por você caso você esqueça. Gasta 1 unidade por uso.","","","","","","","Unursanız UNO deyin. Her kullanım için 1 birim harcayın."},
ITEM_LIGHT ={"Highlight Cards","Destacar Cartas","","","","","","","Vurgu Kartları"},
ITEM_LIGHT_DESC ={"Highlights your playable cards. Spend 1 unit per match.","Destaca as suas cartas jogáveis. Gasta 1 unidade por partida.","","","","","","","Oynatılabilir kartlarınızı vurgular. Maç başına 1 birim harcayın."},
...
FLAG_CLOUD_DESC ={"When playing a blue 0, a random player draws 1 to 2 cards.","Ao jogar um 0 azul, um jogador aleatório compra de 1 a 2 cartas.","En jouant un 0 bleu, un joueur aléatoire tire de 1 à 2 cartes.","Cuando juegues una azul 0, un jugador aleatorio sorteará de 1 a 2 cartas.","Играя синей 0, случайный игрок берёт 1-2 карты.","當你發出藍色 0 號牌, 隨機一個玩家罰抽 1 到 2 張卡牌。","Kiedy zagrasz niebieskim 0, losowy gracz dobierze od 1 do 2 kart.","Amikor kék 0-t játszol, egy véletlenszerű játékos 1-2 kártyát húz.","Mavi 0 çalarken rastgele bir oyuncu 1-2 kart çeker."},
FLAG_STAR ={"Paper","Papel","Papier","Cuando juegues una amarilla 0, usa una carta comodín.","Бумага","宣紙","Papier","Papír","Kağıt"},
FLAG_STAR_DESC ={"When playing a yellow 0, add a Wild card to your hand.","Ao jogar um 0 amarelo, adicione uma carta curinga à sua mão.","En jouant un 0 bleu, une carte noire s'ajoute à votre jeu.","Tapiz","Играя жёлтой 0, добавьте в свою руку чёрную карту.","當你發出黃色 0 號牌,  將會增加一張 換色卡牌 到你持有的卡牌中。","Kiedy zagrasz żółtym 0, otrzymasz kartę Wild do twojej ręki.","Amikor sárga 0-t játszol, egy Színválasztó kártyát ad hozzá a kezedhez.","Sarı bir 0 oynarken, elinize bir Wild kartı ekleyin."},
FLAG_LEAF ={"Carpet","Tapete","Tapis","Cuando juegues una verde 0, descarta una carta numérica y sortea una carta para reiniciar.","Ковер","草地毯","Dywan","Szőnyeg","Halı"},
FLAG_LEAF_DESC ={"When playing a green 0, discard a numerical card and draw 1 card to reset.","Ao jogar um 0 verde, descarte um número e compre 1 carta para repor.","Lorsque vous jouez un 0 vert, vous défaussez une carte numérique et tirez une carte pour la réinitialiser.","Disco","Играя зелёной 0, выбросьте цифровую карту и возьмите 1 карту для сброса.","當你發出綠色 0 號牌, 可以丟棄一張數字卡並抽取另一張卡代替。","Kiedy zagrasz zielonym 0, odrzuć kartę z numerem  i dobierz jedną kartę by zresetować.","Amikor zöld 0-t játszol, dobj el egy számkártyát, majd húzz 1 újat.","Yeşil 0 oynatırken, sayısal bir kartı atın ve sıfırlamak için 1 kart çekin."},
FLAG_DISCO ={"Disco","Discoteca","","","Диско","迪斯可","Dyskoteka","Diszkó","Disko"},
FLAG_DISCO_DESC ={"When an opponent plays a Wild card, your zeros have a 25% chance of becoming the color chosen by them.","Quando um adversário jogar um curinga, seus zeros tem 25% de chance de ficarem da cor escolhida por ele.","","","","當對手發出換色卡牌, 你手中的0號卡牌有25%機會變成對手選擇的顏色。","","Amikor egy ellenfeled Színválasztó kártyát játszik, a nulláidnak 25% esélye van arra, hogy az általuk választott színre változzanak.","Bir rakip Wild kartı oynadığında, sıfırlarınızın %25'i tarafından seçilen renk olma şansı vardır."},
...
FLAG_CLOUD2_MISSION ={"Unlocked by winning %s times with the Mess rule.","Desbloqueado ao vencer %s partidas com a regra Bagunça.","","","","在大混亂模式中勝出50次。","","A feloldáshoz nyerj 50 alkalommal a Zűrzavar szabállyal.","Mess kuralı ile 50 kez kazanarak kilidi açıldı."},
...
SKIN_ROUND_MISSION ={"Unlocked after playing %s games.","Desbloqueado ao jogar %s partidas","Débloqué en jouant %s parties.","Desbloqueado después de jugar %s partidas","Разблокируется после %s сыгранных игр.","玩過 %s 場遊戲後解鎖。","Odblokuje się po zagraniu %s gier","A feloldáshoz játssz %s alkalommal.","%s oyun oynadıktan sonra kilidi açılır."},
SKIN_STONE ={"Stone Bench","Banco de Pedra","Banc en pierre","Banco de piedra","Каменное Кресло","石頭長椅","Kamienna ława","Kőpad","Taş Bank"},
SKIN_GOLD ={"Golden Throne","Trono de Ouro","Trône en or","Trono Dorado","Золотое Кресло","黃金寶座","Złoty Tron","Arany Trón","Altın Taht"},
SKIN_WIN_MISSION ={"Unlocked by winning %s times.","Desbloqueado ao vencer %s vezes","Débloqué en gagnant %s fois.","Desbloqueado después de ganar %s veces","Разблокируется, выиграв %s раз.","勝出 %s 場遊戲後解鎖。","Odblokuj go wygrywając %s razy","A feloldáshoz nyerj %s alkalommal.","%s kez kazanarak kilidi açıldı."},
SKIN_DIAMOND ={"Diamond Throne","Trono de Diamante","Trône en diamant","Trono de Diamante","Алмазный Трон","鑽石寶座","Diamentowy Tron","Gyémánt Trón","Elmas Tahtı"},
SKIN_RED ={"Red Armchair","Poltrona Vermelha","Fauteuil rouge","Sillón Rojo","Красное Кресло","紅色扶手椅子","Czerwony Fotel","Piros Fotel","Kırmızı Koltuk"},
SKIN_RED_MISSION ={"Unlocked by winning with a red card.","Desbloqueado ao vencer com uma carta vermelha","Débloqué en gagnant avec une carte rouge.","Desbloqueado por ganar con una carta roja","Разблокируется, выиграв с красной картой.","最後發出紅色卡牌而勝出後解鎖。","Odblokuj go wygrywając czerwoną kartą.","A feloldáshoz nyerj piros kártyával.","Kırmızı kart ile kazanarak kilidi açılır."},
SKIN_BLUE ={"Blue Armchair","Poltrona Azul","Fauteuil bleu","Sillón Azul","Синее Кресло","藍色扶手椅子","Niebieski Fotel","Kék Fotel","Mavi Koltuk"},
SKIN_BLUE_MISSION ={"Unlocked by winning with a blue card.","Desbloqueado ao vencer com uma carta azul","Débloqué en gagnant avec une carte bleue.","Desbloqueado por ganar con una carta azul","Разблокируется, выиграв с синей картой.","最後發出藍色卡牌而勝出後解鎖。","Odblokuj wygrywając niebieską kartą.","A feloldáshoz nyerj kék kártyával.","Mavi kart ile kazanarak kilidi açıldı."},
SKIN_YELLOW ={"Yellow Armchair","Poltrona Amarela","Fauteuil jaune","Sillón Amarillo","Жёлтое Кресло","黃色扶手椅子","Żółty Fotel","Sárga Fotel","Sarı Koltuk"},
SKIN_YELLOW_MISSION ={"Unlocked by winning with a yellow card.","Desbloqueado ao vencer com uma carta amarela","Débloqué en gagnant avec une carte jaune.","Desbloqueado por ganar con una carta amarilla","Разблокируется, выиграв с жёлтой картой.","最後發出黃色卡牌而勝出後解鎖。","Odblokuj go wygrywając żółtą kartą.","A feloldáshoz nyerj sárga kártyával.","Sarı kart ile kazanarak kilidi açılır."},
SKIN_GREEN ={"Green Armchair","Poltrona Verde","Fauteuil vert","Sillón Verde","Зелёное Кресло","綠色扶手椅子","Zielony Fotel","Zöld Fotel","Yeşil Koltuk"},
SKIN_GREEN_MISSION ={"Unlocked by winning with a green card.","Desbloqueado ao vencer com uma carta verde","Débloqué en gagnant avec une carte verte.","Desbloqueado por ganar con una carta verde","Разблокируется, выиграв с зелёной картой.","最後發出綠色卡牌而勝出後解鎖。","Odblokuj go wygrywając zieloną kartą.","A feloldáshoz nyerj zöld kártyával.","Yeşil kartla kazanarak kilidi açılır."},
SKIN_WHITE ={"White Armchair","Poltrona Branca","Fauteuil blanc","Sillón Blanco","Белое Кресло","白色扶手椅子","Biały Fotel","Fehér Fotel","Beyaz Koltuk"},
SKIN_WHITE_MISSION ={"Unlocked by winning with a wild card.","Desbloqueado ao vencer com um curinga","Débloqué en gagnant avec une carte noire.","Desbloqueado por ganar con una carta comodín","Разблокируется, выиграв с чёрной картой.","最後發出換色卡牌而勝出後解鎖。","Odblokuj go wygrywając kartą wild.","A feloldáshoz nyerj Színválasztó kártyával.","Joker ile kazanarak kilidi açılır."},
SKIN_FIRE ={"Fire Throne","Trono do Fogo","Trône de feu","Trono de Fuego","Огненный Трон","烈焰寶座","Ognisty Tron","Tűz Trón","Yangın Tahtı"},
RED_MISSION ={"Unlocked by winning %s times with a red card.","Desbloqueado ao vencer %s vezes com uma carta vermelha","Débloqué en gagnant %s fois avec une carte rouge.","Desbloqueado por ganar %s veces con una carta roja","Разблокируется, выиграв %s раз с красной картой.","最後發出紅色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy czerwoną kartą","A feloldáshoz nyerj %s alkalommal piros kártyával.","Kırmızı kart ile %s kez kazanarak kilidi açılır."},
SKIN_WATER ={"Water Throne","Trono da Água","Trône d'eau","Trono de Agua","Водный Трон","水流寶座","Wodny Tron","Víz Trón","Su Tahtı"},
BLUE_MISSION ={"Unlocked by winning %s times with a blue card.","Desbloqueado ao vencer %s vezes com uma carta azul","Débloqué en gagnant %s fois avec une carte bleue.","Desbloqueado por ganar %s veces con una carta azul","Разблокируется, выиграв %s раз с синей картой.","最後發出藍色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy niebieską kartą","A feloldáshoz nyerj %s alkalommal kék kártyával.","Mavi kart ile %s kez kazanarak kilidi açıldı."},
SKIN_EARTH ={"Earth Throne","Trono da Terra","Trône de terre","Trono de Tierra","Земной Трон","土壤寶座","Ziemny Tron","Föld Trón","Dünya Tahtı"},
YELLOW_MISSION ={"Unlocked by winning %s times with a yellow card.","Desbloqueado ao vencer %s vezes com uma carta amarela","Débloqué en gagnant %s fois avec une carte jaune.","Desbloqueado por ganar %s veces con una carta amarilla","Разблокируется, выиграв %s раз с жёлтой картой.","最後發出黃色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy żółtą kartą","A feloldáshoz nyerj %s alkalommal sárga kártyával.","%s kez sarı kart ile kazanılır."},
SKIN_AIR ={"Air Throne","Trono do Ar","Trône d'air","Trono de Aire","Воздушный Трон","氣團寶座","Powietrzny Tron","Levegő Trón","Hava Tahtı"},
GREEN_MISSION ={"Unlocked by winning %s times with a green card.","Desbloqueado ao vencer %s vezes com uma carta verde","Débloqué en gagnant %s fois avec une carte verte.","Desbloqueado por ganar %s veces con una carta verde","Разблокируется, выиграв %s раз с зелёной картой.","最後發出綠色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy zieloną kartą","A feloldáshoz nyerj %s alkalommal zöld kártyával.","Yeşil kart ile %s kez kazanarak kilidi açılır."},
SKIN_RAINBOW ={"Rainbow Throne","Trono Arco-Íris","Trône arc-en-ciel","Trono Arcoiris","Радужный Трон","彩虹寶座","Tęczowy Tron","Szivárvány Trón","Gökkuşağı tahtı"},
WILD_MISSION ={"Unlocked by winning %s times with a wild card.","Desbloqueado ao vencer %s vezes com um curinga","Débloqué en gagnant %s fois avec une carte noire.","Desbloqueado por ganar %s veces con un comodín","Разблокируется, выиграв %s раз с чёрной картой.","最後發出換色卡牌而勝出 %s 次後解鎖。","Odblokuj go wygrywając %s razy kartą wild.","A feloldáshoz nyerj %s alkalommal színválasztó kártyával.","Bir jokerle %s kez kazanarak kilidi açıldı."},
SKIN_KING ={"King Throne","Trono do Rei","Trône du roi","Trono Real","Королевский Трон","國王寶座","Królewski Tron","Király Trón","Kral Tahtı"},
SKIN_KING_MISSION ={"Unlocked by winning blocking a +2 or +4.","Desbloqueado ao vencer bloqueando um +2 ou +4","Débloqué en gagnant en bloquant un +2 ou un +4.","Desbloqueado por ganar bloqueando una carta +2 o una +4","Разблокируется победой, блокируя +2 или +4.","在上一個玩家發出 +2 或 +4 卡牌之後繼續發出 +2 或 +4 卡牌而獲勝後解鎖。","Odblokuj go wygrywając blokowanie +2 lub +4","A feloldáshoz nyerj azzal, hogy kivédesz egy +2-es vagy +4-es kártyát.",""},
SKIN_LUCK ={"Lucky Throne","Trono da Sorte","Trône de la chance","Trono de la Suerte","Удачливый Трон","幸運寶座","Szczęśliwy Tron","Szerencsés Trón","Şanslı taht"},
SKIN_LUCK_MISSION ={"Unlocked by winning without drawing any cards.","Desbloqueado ao vencer sem comprar cartas","Débloqué en gagnant sans tirer aucune carte.","Desbloqueado ganando sin sortear cartas.","Разблокируется победой без вытягивания карт.","不被罰抽任何卡牌而勝出後解鎖。","Odblokuj go wygrywając bez dobierania kart.","A feloldáshoz nyerj kártyahúzás nélkül.","Herhangi bir kart çekmeden kazanarak kilidi açılır."},
SKIN_ANGEL ={"Angelic Throne","Trono Angelical","Trône angélique","Trono Angelical","Ангельский Трон","天使寶座","Anielski Tron","Angyali Trón","Melek Taht"},
SKIN_ANGEL_MISSION ={"Unlocked by winning without the timer appearing during your turn.","Desbloqueado ao vencer sem deixar o cronômetro aparecer na sua vez","Débloqué en gagnant sans que le minuteur apparaisse pendant votre tour.","Desbloqueado por ganar sin que el temporizador aparezca en tu turno","Разблокируется победой без таймера, появляющегося во время вашего хода.","在你所有的發卡回合中, 別讓限時器彈出而得到勝利。","Odblokuj go wygrywając rundę bez pokazywania stopera wyznaczającego kolejkę.","A feloldáshoz nyerj anélkül, hogy az időmérő megjelenne.","Sıranız sırasında zamanlayıcı görünmeden kazanarak kilidi açılır."},
SKIN_JUNKY ={"Junk Throne","Trono de Sucata","Trône d'ordures","Trono de Basura","Хламный Трон","廢棄物寶座","Tron Rupieć","Kacat Trón","Önemsiz Taht"},
SKIN_JUNKY_MISSION ={"Unlocked by winning after accumulating 15+ cards in your hand.","Desbloqueado ao vencer depois de acumular 15 ou mais cartas na mão","Débloqué en gagnant après avoir accumulé plus de 15 cartes dans votre jeu.","Desbloqueado ganando después de haber acumulado +15 cartas en tu baraja.","Разблокируется победой после накопления 15+ карт в вашей руке.","手中的卡牌曾經在遊戲中多於 15 張而最後得到勝利後解鎖。","Odblokuj go kumulując 15 kart w twoich rękach.","A feloldáshoz nyerj úgy, hogy előtte 15 vagy több kártyát felhalmoztál a kezedben.","Elinizde 15+ kart biriktirdikten sonra kazanarak kilidi açılır."},
SKIN_SHAMAN ={"Shaman Throne","Trono do Shaman","Trône du chamane","Trono del Chamán","Шаманский Трон","薩滿寶座","Szamański Tron","Sámán Trón","Şaman Tahtı"},
SKIN_SHAMAN_MISSION ={"Unlocked by accumulating %s points in a room.","Desbloqueado ao acumular mais de %s pontos em uma sala","Débloqué en accumulant %s points dans un salon.","Desbloqueado por acumular %s puntos en una sala","Разблокируется, накапливая %s очков в комнате.","在房間累積達到 %s 分數後解鎖。","Odblokuj kumulując %s punktów w pokoju","A feloldáshoz gyűjts össze %s pontot egy szobában.","Bir odada %s puan toplayarak kilidi açılır."},
SKIN_BEACH ={"Beach Chair","Cadeira de Praia","Chaise de plage","Silla de Playa","Пляжное Кресло","沙灘椅子","Leżak","Strand Szék",""},
SKIN_WATCH_MISSION ={"Unlocked by watching %s games.","Desbloqueado ao assistir %s partidas","Débloqué en regardant %s parties.","Desbloqueado después de espectar %s partidas.","Разблокируется после %s просмотренных игр.","旁觀 %s 場遊戲後解鎖。","Odblokuj go obserwując %s gier","A feloldáshoz figyelj meg egy játékot %s alkalommal.","%s oyun izleyerek kilidi açılır."},
SKIN_CINE ={"Cinema Chair","Cadeira de Cinema","Cinema Chair","Silla de Cine","Кресло-Кино","影院椅子","Kinowy Fotel","Mozi Szék","Sinema Koltuğu"},
SKIN_HELL ={"Hell Throne","Trono Infernal","Trône de l'enfer","Trono Infernal","Адский Трон","地獄椅子","Piekielny Tron","Pokol Trón","Cehennem Tahtı"},
SKIN_HELL_MISSION ={"Unlocked by making someone draw 16 cards at once.","Desbloqueado ao fazer alguém comprar 16 cartas de uma vez","Débloqué en faisant tirer une personne 16 cartes d'un coup.","Desbloqueado por hacer sortear a algún jugador 16 cartas a la vez ","Разблокируется, заставляя кого-то взять 16 карт одновременно.","在一次發卡中令別人罰抽 16 張卡牌。","Aby go odblokować spraw by ktoś dobrał 16 kart za jednym razem","A feloldáshoz húzass valakivel 16 kártyát egyszerre.","Birine aynı anda 16 kart çekerek kilidi açılır."},
SKIN_CARDS ={"Cards Throne","Trono de Cartas","Trône de cartes","Trono de Cartas","Карточный Трон","卡牌寶座","Karciany Tron","Kártya Trón","Taht Oyunları"},
SKIN_CARDS_MISSION ={"Unlocked after drawing 16 cards at once.","Desbloqueado ao comprar 16 cartas de uma vez","Débloqué en tirant 16 cartes d'un coup.","Desbloqueado sorteando 16 cartas a la vez","Разблокируется после взятия 16 карт одновременно.","在一次罰抽中抽取 16 張卡牌。","Odblokuj go dobierając 16 kart za jednym razem","A feloldáshoz húzz fel egyszerre 16 kártyát.","Bir kerede 16 kart çekildikten sonra kilidi açılır."},
SKIN_CANDY ={"Candy Throne","Trono de Doces","Trône bonbon","Trono Acaramelado","Конфетный Трон","糖果寶座","Cukierkowy Tron","Cukorka Trón","Şeker Tahtı"},
SKIN_CANDY_MISSION ={"Unlocked by unlocking all house rules.","Desbloqueado ao liberar todas as regras da casa","Débloqué en débloquant toutes les règles de la maison.","Desbloqueado por conseguir todas las reglas de la casa","Разблокируется разблокировкой всех домашних правил.","解鎖所有自訂規矩後解鎖。","Aby go odblokować odblokuj wszystkie domowe zasady","A feloldáshoz oldd fel az összes házszabályt.","Tüm ev kurallarının kilidini açarak kilidi açılır."},
SKIN_FRAISE ={"Fraise Throne","Trono de Morango","Trône fraise","Trono de Fresas","Клубничный Трон","草莓寶座","Truskawkowy Tron","Eper Trón",""},
SKIN_FRAISE_MISSION ={"Unlocked by winning with a fraise.","Desbloqueado ao vencer com um morango","Débloqué en jouant avec une fraise.","Desbloqueado por ganar con una fresa","Разблокируется, выиграв с клубникой.","和商店裡的草莓一起勝利後解鎖。","Odblokuj go wygrywając truskawką","A feloldáshoz nyerj eperrel.","Bir fraise kazanarak kilidi açıldı."},
SKIN_ILLUMINATI ={"Illuminati Throne","Trono Illuminati","Trône Illuminati","Trono Illuminati","Трон-Иллюминати","光照派寶座","Tron Illuminati","Illuminati Trón",""},
SKIN_ILLUMINATI_MISSION ={"Have all four +4 cards in your hand to unlock it.","Tenha os quatro +4 na mão para liberar","Débloqué en ayant toutes les cartes +4 de la partie dans votre jeu.","Tener todas las cartas +4 en la baraja para desbloquearlo","Держите в руке все четыре карты +4, чтобы разблокировать его.","手中集齊 4 張 +4 卡牌後解鎖。","Odblokuj go posiadając wyszstkie +4 w twojej ręce.","A feloldáshoz mind a négy +4-es kártya legyen a kezedben.","Kilidini açmak için dört +4 kartın hepsini elinizde bulundurun."},
SKIN_GIFT ={"Gift Throne","Trono de Presentes","Trône cadeau","Trono de Regalos","Подарочный Трон","禮物寶座","Prezentowy Tron","Ajándék Trón","Hediye Tahtı"},
SKIN_GIFT_MISSION ={"Unlocked by winning donating a card from your hand.","Desbloqueado ao vencer doando uma carta sua para alguém.","Débloqué en gagnant en donnant une carte de votre jeu.","Desbloqueado por ganar donando una carta de la baraja.","Разблокируется, выиграв пожертвованием карты из вашей руки.","把你的一張卡牌捐出而獲勝後解鎖。","Odblokuj go wygrywając darowaną kartą z twojej ręki.","A feloldáshoz nyerj azzal, hogy eladományozol egy kártyát a kezedből.","Elinden bir kart bağışlayarak kilidi açıldı."},
SKIN_BOG ={"Bog","Privada","","Ciénaga","Сортир","坐廁","Klozet","Mocsár","Bataklık"},
SKIN_BOG_MISSION ={"Unlocked by finishing a match without having the opportunity to play.","Desbloqueado ao terminar uma partida sem ter a oportunidade de jogar.","Débloqué en finissant un jeu sans avoir joué.","Unlocked by finishing a match without having the opportunity to play.","Разблокируется по окончании матча без возможности играть.","你沒有得到任何發卡牌的機會而完成一局遊戲後解鎖。","Odblokuj go kończąc rundę bez możliwości gry.","A feloldáshoz úgy kell egy játéknak befejeződnie, hogy nem volt lehetőséged játszani.","Oynama şansına sahip olmadan bir maçı bitirerek kilidi açılır."},
SKIN_IRON_THRONE ={"Iron Throne","Trono de Ferro","Trône de fer","Trono de Hierro","Железный Трон","鋼鐵寶座","Żelazny Tron","Vas Trón","Demir Taht"},
SKIN_IRON_THRONE_MISSION ={"Unlocked by successfuly challenging three +4 cards in a row.","Desbloqueado ao vencer 3 desafios de +4 consecutivos sem perder.","Débloqué en défiant avec succès trois cartes +4 d'afillée.","Desbloqueado por ganar tres retos de +4 en una ronda, sin perder","Разблокируется, успешно бросая вызов три +4 карты подряд.","成功連續質疑 +4 卡牌 3 次後解鎖。","Odblokuj wygrywając 3 razy wyzwanie +4 nie ponosząc przy tym straty.","A feloldáshoz hívj ki egymás után három +4-es kártyát sikeresen.","Arka arkaya üç +4 karta başarıyla meydan okuyarak kilidi açılır."},
SKIN_HAMBURGUER ={"Throne of Gluttony","Trono da Gula","Trône de la gourmandise","Trono de Glotón","Трон Обжорства","貪吃者寶座","Tron Obżarstwa ","A Falánkság Trónja","Oburluk Tahtı"},
SKIN_TEAM_MISSION ={"Unlocked by winning %s Team Matches.","Desbloqueado ao vencer %s Jogos em Duplas.","Débloqué en gagnant %s Parties en Équipe.","Desbloqueado por ganar %s rondas en equipo","Разблокируется после победы в %s командных матчах.","在團隊模式獲得 %s 場勝利。","Odblokuj wygrywajac %s Rund Drużynowych.","A feloldáshoz nyerj %s Csapatmérkőzést.","%s Takım Maçı kazanarak kilidi açıldı."},
SKIN_SKULL ={"Skull Throne","Trono de Caveira","Trône crâne","Trono de Cráneos","Черепной Трон","骷髏寶座","Tron Czaszka","Koponya Trón","Kafatası Taht"},
SKIN_SKULL_MISSION ={"Unlocked by winning by elimination.","Desbloqueado ao vencer por eliminação.","Débloqué en jouant par elimination.","Desbloqueado ganando por eliminación","Разблокируется победой путём исключения.","在淘汰模式中得到勝利後解鎖。","Odblokuj wygrywajac przez eliminację.","A feloldáshoz nyerj azzal, hogy kiejtesz egy játékost a játékból.","Eliminasyon ile kazanarak kilidi açılır."},
SKIN_SHOW ={"Party Throne","Trono Baladeiro","Trône de fête","Trono de Fiesta","Трон-Вечеринка","派對寶座","Imprezowy Tron","Parti Trón","Parti Tahtı"},
SKIN_SHOW_MISSION ={"Unlocked randomly by playing on private rooms.","Desbloqueado aleatoriamente ao jogar em salas privadas.","Débloqué aléatoirement en jouant dans des salons privés.","Desbloqueado aleatoriamente jugando en salas privadas.","Разблокируется случайным образом, играя в частных комнатах.","在私人房間進行遊戲後隨機解鎖。","Odblokowane losowo przez grę w pokojach prywatnych.","Véletlenszerűen feloldható privát szobákban játszva.","Özel odalarda oynayarak rastgele açılır."},
SKIN_TIME_MACHINE ={"Time Throne","Trono do Tempo","Trône du temps","Trono del Tiempo","Часовой Трон","時間寶座","Tron Czasu","Idő Trónja","Zaman Tahtı"},
SKIN_TIME_MACHINE_MISSION ={"Unlocked by winning by time expiration.","Desbloqueado ao vencer por tempo esgotado.","Déverrouillé en gagnant à l'expiration du temps.","Desbloqueado al ganar por tiempo acabado.","Разблокируется победой, когда осталось 60 секунд до окончания матча.","當一局的時限到了然後得到勝利後解鎖。","Odblokuj przez wygraną po upływie czasu.","A feloldáshoz nyerj az idő lejáratával.","Zaman aşımı ile kazanarak kilidi açılır."},
SKIN_CHESS ={"Ivory Throne","Trono de Marfim","Trône d'ivoire","Trono de Marfil","Шахматный Трон","象牙寶座","Tron z Kości Słoniowej","Elefántcsont Trón","Fildişi Taht"},
SKIN_CHESS_MISSION ={"Unlocked by killing %s pieces on Mad Chess rule.","Desbloqueado ao matar %s peças na regra Xadrez Maluco.","Débloqué en tuant %s pièces avec la règle Chequiers Fous.","Desbloqueado por matar %s piezas en reglas de Queso Loco.","Разблокируется убийством %s фигур по правилу «Безумные шахматы».","在瘋狂象棋規矩中殺死 %s 個棋子後解鎖。","Odblokuj zbijając %s figur szachowych w zasadzie Szalone Szachy.","A feloldáshoz üss le %s darabot az Őrült Sakk szabály alatt.","Çılgın Satranç kuralında %s taş öldürerek kilidi açıldı."},
SKIN_PENCIL ={"Pencil Throne","Trono de Lápis","Trône crayon","Trono de Lápizes","Карандашный Трон","鉛筆寶座","Kredkowy Tron","Ceruza Trón","Kalem Tahtı"},
SKIN_PENCIL_MISSION ={"Unlocked by playing a wild card over another %s times.","Desbloqueado ao jogar um curinga sobre outro %s vezes.","Débloqué en jouant une carte noire plus d'une %s fois.","Desbloqueado al jugar una Carta Comodín otras %s veces más.","Разблокируется, выиграв с чёрной картой +4 %s раз.","在換色卡牌上再發出換色卡牌 %s 次後解鎖。","Odblokuj grając Kartą Wild ponad %s razy.","A feloldáshoz játssz egy Színválasztó kártyát egy másikra %s alkalommal.","%s kez daha çılgın bir kart oynayarak kilidi açıldı."},
SKIN_SCHOOL ={"School Chair","Cadeira Escolar","Chaise d'école","Silla de Colegio","Школьное Кресло","學校的椅子","Szkolne Krzesło","Iskolai Szék","Okul Sandalyesi"},
SKIN_SCHOOL_MISSION ={"Unlocked by sitting on the same chair 3 times in a row.","Desbloqueado ao sentar 3 vezes consecutivas na mesma cadeira.","Débloqué en s'asseyant sur la même chaise 3 fois de suite.","Desbloqueada sentándose en la misma silla tres veces seguidas.","Разблокируется, сидя на одном кресле 3 раза подряд.","連續在 3 局遊戲中坐同一個位子後解鎖。","Odblokuj siedząc 3 razy z rzędu na tym samym miejscu.","A feloldáshoz ülj ugyanabban a székben egymás után 3 alkalommal.","Aynı sandalyede üst üste 3 kez oturarak kilidi açılır."},
SKIN_ANVIL ={"Anvil Throne","Trono de Bigornas","Trône enclume","Trono de Yunques","Трон-Наковальня","鐵鉆寶座","Tron Kowadło","Üllő Trón","Örs Tahtı"},
SKIN_GARDEN ={"Garden","Jardim","Jardin","Jardín","Сад","庭院","Ogród","Kert","Bahçe"},
SKIN_CAT ={"Cat's Pouf","Puff de Gato","Panier de chat","Puff del Gato","Кошачий Пуф","貓咪坐墊","Pufa-Kot","Cica Pofi","Kedi Pufu"},
SKIN_FALLS ={"Stream Throne","Trono da Correnteza","","Trono de Corriente","Трон-Ручей","溪流寶座","Tron-Strumień","Vízesés Trón","Akış Tahtı"},
SKIN_FALLS_MISSION ={"Unlocked by winning using the Treasure Card.","Desbloqueado ao vencer com a Carta do Tesouro.","Débloqué en gagnant en utilisant la Carte au Trésor.","Desbloqueado al ganar usando la Carta del Tesoro","Открывается победой с помощью Карты Сокровищ.","最後發出寶箱卡牌而獲得勝利後解鎖。","Odblokuj wygrywając przy użyciu Karty Skarbu.","A feloldáshoz nyerj a Kincskártya használatával.","Hazine Kartı ile kazanarak kilidi açıldı."},
SKIN_CHEESE ={"Cheese Throne","Trono de Queijo","Trône fromage","Trono de Queso","Сырный Трон","奶酪寶座","Serowy Tron","Sajt Trón","Peynir Tahtı"},
SKIN_UNICORN ={"Unicorn Pillow","Almofada de Unicórnio","Coussin licorne","Almohada de Unicornio","Единорог-Подушка","獨角獸枕頭","Poduszka Jednorożca ","Egyszarvú Párna","Unicorn Yastık"},
SKIN_PSYCHO ={"Psychedelic Armchair","Poltrona Psicodélica","Fauteuil psychédélique","Sillón Psicodélico","Психоделическое Кресло","迷幻扶手椅子","Fotel Psychodeliczny","Pszichedelikus Fotel",""},
SKIN_PSYCHO_MISSION ={"Unlocked by winning with the Mess rule.","Desbloqueado ao vencer com a regra Bagunça.","Débloqué en jouant avec la règle Bazar.","Desbloqueado por ganar con la regla de Desorden","Разблокируется победой с правилом Беспорядка.","在大混亂規矩中勝出後解鎖。","Odblokuj wygrywając z zasadą Bałaganu.","A feloldáshoz nyerj egy játékot a Zűrzavar szabállyal.","Mess kuralı ile kazanarak kilidi açıldı."},
SKIN_TV ={"Television","Televisão","Télévision","Televisión","Телевизор","電視","Telewizja","Televízió","Televizyon"},
SKIN_RADIO ={"Radio","Rádio","","Radiofonía","Радио","收音機","","Rádió","Radyo"},
SKIN_NEWSPAPER ={"Newspaper Armchair","Poltrona de Jornal","Fauteuil en journaux","Sillón de Periódicos","Газетное Кресло","報章扶手椅子","Fotel-Gazeta","Újságpapír Fotel","Gazete Koltuğu"},
SKIN_CHAMPION ={"Champion's Throne","Trono do Campeão","Trône du champion","Trono de Campeón","Чемпионский Трон","冠軍寶座","Tron Czempiona","A Bajnok Trónja","Şampiyon Tahtı"},
SKIN_CHAMPION_MISSION ={"Unlocked when placing high in authorized tournaments.","Desbloqueado ao alcançar posições altas em torneios autorizados.","","Se desbloquea al quedar en algún puesto alto dentro de torneos autorizados.","Разблокируется при высоких местах в авторизованных турнирах.","在授權的聯賽中得到較前的排名後解鎖。","Odblokuj przez wysokie umieszczenie w autoryzowanych turniejach. ","A feloldáshoz érj el magas helyezést a rendszeresen megszervezett versenyeken.","Yetkili turnuvalara yüksek yerleştirilirken kilidi açılır."},
SKIN_POTATO ={"Potato Throne","Trono de Batatas","Trône patate","Trono de Papas","Картофельный Трон","土豆寶座","Tron Ziemniak","Burgonya Trón","Patates Tahtı"},
SKIN_POTATO_MISSION ={"Unlocked by winning with the Potato Card.","Desbloqueado ao vencer usando a Carta da Batata.","Débloqué en gagnant avec la carte Patate.","Desbloqueado al ganar con la Carta de Papa","Открывается победой с Картофельной Картой.","最後發出土豆卡牌而勝利後解鎖。","Odblokuj wygrywając Kartą Ziemniaka.","A feloldáshoz nyerj a Burgonya Kártyával.","Patates Kartı ile kazanarak kilidi açıldı."},
SKIN_WONDERLAND ={"Throne of Wonders","Trono das Maravilhas","Trône des merveilles","Trono Maravilla","Трон Чудес","異想天開寶座","Tron Cudów","Csodák Trónja","Taht Harikası"},
SKIN_WONDERLAND_MISSION ={"Unlocked by winning once on each side of the Portal.","Desbloqueado ao vencer dos dois lados do Portal.","Débloqué en gagnant au moins une fois de chaque côté du Portail.","Desbloqueado ganando en ambos lados del Portal.","Разблокируется, выиграв один раз на каждой стороне Портала.","在傳送門的兩組卡牌中各勝一次。.","Odblokuj wygrywając po dwóch stronach Portalu.","A feloldáshoz nyerj a Portál mindegyik oldalán.","Portalın her iki tarafında bir kez kazanarak kilidi açılır."},
SKIN_UNDERTALE ={"Asgore's Throne","Trono de Asgore","Trone d'Asgore","Trono de Asgore","Трон Асгора","Asgore 的寶座","Tron Asgora","Asgore Trónja",""},
SKIN_DAY_MISSION ={"Unlocked by playing daily for %s days.","Desbloqueado ao jogar diariamente por %s dias.","Débloqué en jouant quotidiennement pendant %s jours.","Desbloqueado por jugar diariamente durante %s días.","Разблокируется, играя ежедневно в течение %s дней.","連續 %s 天每天玩 UNO 後解鎖。","Odblokuj, grając codziennie przez %s dni.","A feloldáshoz játssz %s napig minden nap.","%s gün boyunca günlük olarak oynayarak kilidi açılır."},
SKIN_RIP ={"Tombstone","Lápide","Pierre tombale","Lápida","Могила","墓碑","Nagrobek","Sírkő","Mezar taşı"},
SKIN_RIP_MISSION ={"Unlocked by challenging a player who did not say UNO.","Desbloqueado ao desafiar um jogador que não disse UNO.","Débloqué en défiant un joueur qui n'a pas dit UNO.","Desbloqueada al retar a un jugador que no dijo UNO.","Разблокируется, бросив вызов игроку, который не сказал УНО.","成功質疑一個沒說 Uno! 的玩家後解鎖。","Odblokuj wyzywając gracza, który nie powiedział UNO.","A feloldáshoz hívj ki egy olyan játékost, aki nem mondott UNO-t.","UNO demeyen bir oyuncuya meydan okuyarak kilidi açılır."},
SKIN_APPLE ={"Apple Throne","Trono de Maçã","Trône pomme","Trono de Manzanas","Яблочный Трон","蘋果寶座","Jabłkowy Tron","Alma Trón",""},
SKIN_APPLE_MISSION ={"Unlocked when you get eliminated by your own Thunder Card.","Desbloqueado ao ser eliminado atingido pelo próprio raio.","Débloqué lorsque éliminé par votre propre Carte Tonnerre.","Desbloqueado cuando eres eliminado por tu propia Carta Relámpago.","Разблокируется, когда вы уничтожены своей собственной Картой Грома.","當你使用了雷電暴擊卡牌而你被淘汰出局後解鎖。","Odblokuj, kiedy zostaniesz wyeliminowany przez własną Kartę Grzmotu.","A feloldáshoz ejtsd ki magad a játékból a saját Mennydörgés Kártyáddal.",""},
SKIN_HEART ={"Throne of Love","Trono do Amor","Trône d'amour","Trono del Amor","Трон Любви","愛心寶座","Tron Miłości","A Szerelem Trónja",""},
SKIN_HEART_MISSION ={"Unlocked by donating 5 or more cards at once.","Desbloqueado ao doar 5 ou mais cartas de uma só vez.","Débloqué en donnant 5 ou plus, de cartes d'un coup.","Desbloqueado por donar cinco o más cartas seguidas.","Разблокируется, пожертвовав 5 или более карт одновременно.","在一個回合裡捐出 5 張卡牌或以上後解鎖。","Odblokuj przekazując 5 lub więcej kart naraz.","A feloldáshoz adományozz egyszerre 5 vagy több kártyát.",""},
SKIN_ELEMENTAL ={"Elemental Throne","Trono dos Elementos","Trone élémentaire","Trono Elemental","Стихийный Трон","元素寶座","Tron Żywiołowy ","Elemi Trón",""},
SKIN_ELEMENTAL_DESC_MISSION ={"Unlocked by playing all four zeros (one of each color) in the same game.","Desbloqueado ao jogar os quatro zeros (um de cada cor) na mesma partida.","Débloqué en jouant tous les zeros (de chaque couleur) dans la même partie.","Desbloqueado jugando todas las cuatro cartas 0 de cada color en la misma partida.","Разблокируется, играя со всеми 0 (по одному каждого цвета) в одной игре.","在同一局遊戲中發出 4 張 0 號卡牌(每顏色各一張)後解鎖。","Odblokuj, grając wszystkimi czterema zerami (jednym z każdego koloru) w tej samej grze.","A feloldáshoz játsszd ki mind a négy nullás kártyát (mindegyik színből egy) ugyanabban a játékban.",""},
SKIN_TRASH ={"Trash Throne","Trono de Lixeira","Trone en détritus","Trono de Desechos","Мусорный Трон","垃圾桶寶座","Tron Śmieci","Kuka Trón",""},
SKIN_TRASH_MISSION ={"Unlocked by having more than 25 cards in your hand, without intentional draws.","Desbloqueado ao ter mais de 25 cartas na mão, sem compras intencionais.","Débloqué en ayant plus de 25 cartes dans votre jeu, sans tirages intentionnels.","Desbloqueado al tener más de 25 cartas en baraja, sin sortearlas intencionalmente.","Разблокируется, имея в руке более 25 карт, без преднамеренных розыгрышей.","在沒有自願罰抽的卡牌前提下, 手中持有多於 25 張卡牌後解鎖。","Odblokuj mając więcej niż 25 kart, bez celowych losowań.","A feloldáshoz tarts több mint 25 kártyát a kezedben, szándékos felhúzás nélkül.",""},
SKIN_BREAKFAST ={"Breakfast","Café da Manhã","Petit-déjeuner","Desayuno","Завтрак","早餐","Śniadanie","Reggeli",""},
SKIN_COMPUTER ={"Computer","Computador","Ordinateur","Computadora","Компьютер","電腦","Komputer","Számítógép",""},
SKIN_BONES ={"Bone Throne","Trono de Ossos","Trône d'os","Trono de Huesos","Костяной Трон","骨頭寶座","Tron z Kości","Csont Trón",""},
SKIN_BONES_MISSION ={"Unlocked by surviving Limbo rule until the limit is 4 cards.","Desbloqueado ao sobreviver ao Limbo até que o limite seja 4 cartas.","Débloqué en survivant à la règle Limbo jusqu'à ce que la limite soit de 4 cartes.","Desbloqueado al sobrevivir la regla del Limbo hasta que el límite sea de 4 cartas.","Разблокируется выживающим правилом Limbo до тех пор, пока лимит не составит 4 карты.","在林波舞規矩中生存直到持有的卡牌上限是 4 張。","Odblokuj przez przetrwanie z zasadą Otchłań dopóki limit nie wyniesie 4 kart. ","A feloldáshoz éld túl a Limbo szabályt addig, amíg 4 kártya lesz a határ.",""},
SKIN_CHOCOLATE ={"Chocolate Throne","Trono de Chocolate","Trône chocolat","Trono de Chocolate","Шоколадный Трон","巧克力寶座","Czekoladowy Tron","Csokoládé Trón",""},
SKIN_CHOCOLATE_MISSION ={"Unlocked by winning in less than 1 minute.","Desbloqueado ao vencer em menos de 1 minuto.","Débloqué en gagnant en moins d'une minute.","Desbloqueado al ganar en menos de un minuto.","Разблокируется, выиграв менее чем за 1 минуту.","在 1 分鐘內勝出遊戲後解鎖。","Odblokuj wygrywając w mniej niż minutę.","A feloldáshoz nyerj kevesebb, mint 1 perc alatt.",""},
SKIN_MARINE ={"Sea Armchair","Poltrona Marinha","Fauteuil des mers","Sillón de Mar","Морское кресло","海洋扶手椅子","Morski Fotel","Tengeri Fotel",""},
SKIN_MARINE_MISSION ={"Unlocked when Elise wins as your teammate.","Desbloqueado quando Elise vence como sua dupla.","Débloqué lorsque Elise gagne en tant que coéquipière.","Desbloqueado cuando Elise gana como tu compañera.","Разблокируется, когда Elise выигрывает как твой партнёр в команде.","當 Elise是你的搭檔時勝出遊戲後解鎖。","Odblokuj gdy Elise wygra w twojej drużynie.","A feloldáshoz Elise kell hogy nyerjen csapattársadként.",""},
SKIN_ROCKET ={"Rocket Throne","Trono de Foguete","Trône fusée","Trono Cohete","Ракетный Трон","火箭寶座","Tron Rakieta","Rakéta Trón",""},
SKIN_BOOTCAMP ={"Camouflage Armchair","Poltrona Camuflada","Trône camouflage","Sillón de Camuflage","Камуфляжное Кресло","迷彩偽裝扶手椅","Tron Kamuflażu","Álca Fotel",""},
SKIN_BOOTCAMP_MISSION ={"Unlocked by winning a game without saying UNO.","Desbloqueado ao vencer uma partida sem dizer UNO.","Débloqué en gagnant un jeu sans dire UNO.","Desbloqueado al ganar una partida sin decir UNO.","Разблокируется, выиграв игру, не сказав УНО.","不喊 UNO 而勝出一場遊戲。","Odblokuj wygrywając bez wypowiedzenia UNO.","A feloldáshoz nyerj anélkül, hogy kimondod az UNO-t.",""},
SKIN_FOOTBALL ={"Football Throne","Trono do Futebol","Trône Football","Trono de Fútbol","Футбольный Трон","足球寶座","Tron Piłkarski","Foci Trón",""},
SKIN_FOOTBALL_MISSION ={"Unlocked by blocking +2 or +4 %s times.","Desbloqueado ao bloquear +2 ou +4 %s vezes.","Débloqué en bloquant un +2 ou un +4 %s fois.","Desbloqueado por bloquear cartas de +2 o +4 %s veces.","Разблокируется блокировкой +2 или +4 %s раз.","在上一個玩家發出 +2 或 +4 卡牌之後繼續發出 +2 或 +4 卡牌, 達成 %s 次後解鎖。","Odblokuj blokując +2 lub +4 %s razy.","A feloldáshoz védd ki a +2-t vagy a +4-et %s alkalommal.",""},
SKIN_LOOT ={"Pot of Gold","Pote de Ouro","Chaudron d'or","Tarro de Oro","Горшочек с золотом","一壺金","Garniec Złota","Fazék Arany",""},
SKIN_LOOT_MISSION ={"Unlocked when every card in your starting hand has the same color.","Desbloqueado ao iniciar uma partida com todas as cartas da mesma cor.","Débloqué lorsque toutes les cartes de votre jeu sont de la même couleur.","Desbloqueado cuando cada carta en tu baraja inicial tenga el mismo color.","Разблокируется, когда каждая карта в вашей стартовой руке имеет одинаковый цвет.","你起初手中的卡牌都是同一個顏色的時候解鎖。","Odblokuj kiedy każda karta na początku gry ma taki sam kolor.","A feloldáshoz legyen a kezdéskor az összes kártya a kezedben azonos színű.",""},
SKIN_ASTRAL ={"Astral Throne","Trono Astral","Trône astral","Trono Astral","Астральный Трон","星體寶座","Tron Astralny","Csillagászati Trón",""},
SKIN_ASTRAL_MISSION ={"Unlocked when you and every other player have 1 card in hand (minimum 6 players).","Desbloqueado quando você e os outros jogadores têm 1 carta (mínimo 6 jogadores).","Débloqué lorsque vous et tous les autres jours ont une seule carte en main (6 joueurs minimum).","Desbloqueado cuando tú y todos los demás jugadores tienen una carta (mínimo 6 jugadores).","Разблокируется, когда у вас и у каждого другого игрока есть 1 карта в руке (минимум 6 игроков).","當你和其他玩家手中都只剩一張卡牌的時候解鎖 (最少需要 6 個玩家)。","Odblokuj kiedy ty i wszyscy pozostali gracze mają 1 kartę w ręce (minimum 6 graczy).","A feloldáshoz neked és minden más játékosnak 1 kártya kell hogy legyen a kezetekben. (minimum 6 játékos)",""},
SKIN_RANDOM ={"Mysterious Throne","Trono Misterioso","Trône mystérieux","Trono Aleatorio","Таинственный Трон","神秘寶座","Tajemniczy Tron","Titokzatos Trón",""},
SKIN_RANDOM_DESC ={"This turns into a random chair (that you already own).","Isto se transforma em uma cadeira aleatória (das que você tiver).","Il se transforme en une chaise aléatoire (que vous possédez déjà).","Selecciona una silla aleatoria de las que estén disponibles.","Это превращается в случайное кресло (которое у вас уже есть).","這會隨機變成任何一張椅子 (只限你擁有的)。","To zmienia w dowolne krzesło (które już posiadasz).","Ez egy véletlenszerű székké válik. (amit már birtokolsz)",""},
SKIN_FASHION ={"Chic Armchair","Poltrona Chique","Fauteuil chic","Sillón Elegante","Шикарное кресло","時尚扶手椅","Szykowny Tron","Elegáns Fotel",""},
SKIN_FRIEND ={"Friend Armchair","Poltrona Amiga","Fauteuil ami","Sillón Amigo","Дружеское кресло","朋友扶手椅","Przyjacielski Fotel","Barátságos Fotel",""},
SKIN_CHEST ={"Treasure Chest","Baú do Tesouro","Coffre au Trésor","Cofre del Tesoro","Сундук с сокровищами","藏寶箱","Skrzynia Skarbów","Kincsesláda",""},
SKIN_CHEST_MISSION ={"Unlocked by stealing the Treasure Card.","Desbloqueado ao roubar a Carta do Tesouro.","Débloqué en volant la Carte au Trésor.","Desbloqueado al robar la Carta del Tesoro.","Открывается при краже Карты Сокровищ.","偷取寶物卡牌後解鎖。","Odblokuj kradnąc Karte Skarów.","A feloldáshoz lopd el a Kincskártyát.",""},
SKIN_TOTORO ={"Totoro","","","","Тоторо","龍貓","","",""},
SKIN_TOTORO_MISSION ={"Unlocked by wearing an outfit similar to it (there are 2 items).","Desbloqueado ao vestir um visual parecido com ele (são 2 itens).","Débloqué en portant une tenue lui étant similaire (il y a 2 objets).","Desbloqueado al poseer una vestimenta similar a el (son 2 objetos).","Разблокируется ношением одежды, похожей на него (есть 2 предмета).","穿著跟它一樣的 (兩個) 裝扮就會解鎖。","Odblokuj zakładając podobne ubranie do tego (są 2 przedmioty).","A feloldáshoz viselj ehhez hasonló ruhát. (2 elem van)",""},
SKIN_COFFEE ={"Cup of Coffee","Xícara de Café","Tasse de Café","Copa de café","Чашка кофе","咖啡一杯","Kubek Kawy","Egy Csésze Kávé",""},
SKIN_COFFEE_MISSION ={"Unlocked by staying in a room for more than 4 hours.","Desbloqueado ao ficar em uma sala por mais de 4 horas.","Débloqué en restant dans un salon pendant plus de 4 heures.","Desbloqueada por estar más de cuatro horas en una sala.","Разблокируется пребыванием в комнате более 4 часов.","在同一個房間待上 4 個小時或以上之後解鎖。","Odblokuj pozostając w pokoju przez więcej niż 4 godziny.","A feloldáshoz tartózkodj több mint 4 órán keresztül egy szobában.",""},
SKIN_PUMPKIN ={"Pumpkin Throne","Trono de Abóbora","Trône citrouille","Trono de Calabaza","Тыквенный Трон","南瓜寶座","Dyniowy Tron","Sütőtök Trón",""},
SKIN_PUMPKIN_MISSION ={"Unlocked by playing a +4 on a player stuck by a Web Card.","Desbloqueado ao jogar um +4 em um jogador preso pela Carta da Teia.","Débloqué en jouant un +4 sur un joueur coincé par une Carte Toile d'Araignée.","Desbloqueado por jugar una carta +4 sobre un jugador afectado por una Carta Telaraña.","Разблокируется, кинув +4 игроку, застрявшем на Паучьей Карте.","向一個被蜘蛛網卡牌限制了的玩家發出 +4 卡牌。","Odblokuj grając karte +4 na gracza zablokowanego Kartą Sieciową.","A feloldáshoz játssz egy +4-es kártyát egy olyan játékos előtt, aki a Háló Kártya hatása alatt van",""},
SKIN_CIRCUS ={"Circus Throne","Trono do Circo","Trône de cirque","Trono de Circo","Цирковой Трон","馬戲團寶座","Cyrkowy Tron","Cirkusz Trón",""},
SKIN_CIRCUS_MISSION ={"Unlocked by playing a +2 or +4 and ending up drawing the cards yourself.","Desbloqueado ao jogar +2 ou +4 e você mesmo acabar comprando cartas.","Débloqué en jouant un +2 ou un +4 et en finissant par tirer les cartes vous-même.","Desbloqueado al jugar una carta +2 o +4 pero que terminen sortéandose a si mismo.","Разблокируется, играя +2 или +4 и заканчивая розыгрышем карт самостоятельно.","發出 +2 或 +4 卡牌可是最終自己被罰抽後解鎖。","Odblokuj grając +2 lub +4 i kończąc na dobraniu własnych kart.","A feloldáshoz játssz egy +2-es vagy +4-es kártyát, és végül húzd utána te a kártyákat.",""},
SKIN_POPCORN ={"Popcorn Throne","Trono de Pipoca","Trône popcorn","Trono de Popcorn","Трон-Попкорн","爆米花寶座","Popcornowy Tron","Kávészünet?",""},
SKIN_POPCORN_MISSION ={"Unlocked by winning by using the Jump-in rule.","Desbloqueado ao vencer cortando.","Débloqué en gagnant en utilisant la règle Jump-in.","Desbloqueado al ganar usando la regla de Saltar-en.","Разблокируется победой с помощью правила Jump-in.","在跳入模式中最後插隊發牌而勝利後解鎖。","Odblokuj wgrywając przy użyciu zasady Wskocz.","A feloldáshoz nyerj a Beugrás szabály felhasználásával.",""},
SKIN_GOTHIC ={"Gothic Throne","Trono Gótico","Trône gothique","Trono Gótico","Готический Трон","歌德風格寶座","Gotycki Tron","Gótikus Trón",""},
SKIN_GOTHIC_MISSION ={"Unlocked when someone colors your cards black by using the Ink Card.","Desbloqueado quando alguém pinta suas cartas de preto usando a Carta da Tinta.","Débloqué lorsque qu'un joueur colore vos cartes en noir en utilisant une Carte Encre.","Desbloqueado cuando alguien colorea de negro tus cartas usando la Carta de Tinta.","Разблокируется, когда кто-то окрашивает ваши карты в чёрный цвет с помощью Чернильной Карты.","其他玩家用墨汁卡牌把你的卡牌染成黑色後解鎖。","Odblokuj, kiedy ktoś pomaluje twoje karty na czarno używając Karty Atramentu.","A feloldáshoz színezze valaki a Tinta Kártyával feketére a kártyáid.",""},
SKIN_UFO ={"UFO","OVNI","OVNI","OVNI","НЛО","","","",""},
SKIN_UFO_MISSION ={"Unlocked by winning due to a card being banished.","Desbloqueado ao vencer devido a uma carta ter sido banida.","Déverrouillé en gagnant grâce au bannissement d'une carte.","Desbloqueado al ganar debido a que una carta fuese sancionada.","Разблокируется победой благодаря изгнанию карты.","在卡牌被撤走然後勝出的情況下解鎖。","Odblokuj poprzez wygraną, niszcząc swoją ostatnią kartę.","A feloldáshoz nyerj úgy, hogy száműzöl egy kártyát.",""},
SKIN_PINEAPPLE ={"Pineapple Throne","Trono de Abacaxi","Trône ananas","Trono de Piña","Ананасный Трон","鳳梨寶座","Ananasowy Tron","Ananász Trón",""},
SKIN_PINEAPPLE_MISSION ={"Unlocked by winning while your mouse is confused.","Desbloqueado ao vencer enquanto seu rato está confuso.","Débloqué en gagnant alors que votre souris est confuse.","Desbloqueado al ganar mientras tu ratón está confundido.","Разблокируется победой, пока ваша мышь в замешательстве.","當你的老鼠被迷惑然後勝出後解鎖。","Odblokuj wygrywając, kiedy twoja myszka jest zdezorientowana.","A feloldáshoz nyerj úgy, hogy zavarodott az egered.",""},
SKIN_GUITAR ={"Music Throne","Trono da Sonzeira","Trône musical","Trono de Música","Музыкальный Трон","音樂寶座","Tron Muzyczny","Zene Trón",""},
SKIN_GUITAR_MISSION ={"Unlocked when someone uses the Dancing Chairs Card and you remain in the same seat.","Desbloqueado quando alguém usa a Carta da Dança e você se mantém no mesmo lugar.","Débloqué lorsque quelqu'un utilise la Carte Chaises Musicales et vous restez tout le temps assis à la même place.","Desbloqueado cuando alguien usa la Carta de Sillas Danzantes y te quedas en el mismo lugar.","Разблокируется, когда кто-то использует карту «Танцующие стулья», и вы остаетесь на том же месте.","有人使用舞動椅子卡牌可是你最後繼續坐在同一個位置後解鎖。","Odblokuj kiedy ktoś użyje Karty Tańczące Fotele, a ty pozostaniesz w tym samym miejscu.","A feloldáshoz maradjon a széked ugyanazon a helyen miután valaki a Táncoló Székek Kártyát használja.",""},
SKIN_MERMAID ={"Mermaid's Throne","Trono da Sereia","Trône sirène","Trono de Sirena","Трон Русалки","人魚寶座","Tron Syreny","Sellő Trónja",""},
SKIN_MERMAID_MISSION ={"Unlocked by winning with your name colored green.","Desbloqueado ao vencer com seu nome pintado de verde.","Débloqué en gagnant avec votre nom coloré en vert.","Desbloqueado a la victoria con el nombre coloreado en verde.","Разблокируется, выиграв с зелёным цветом вашего имени.","在你名字是綠色的時候勝出後解鎖。","Odblokuj wygrywając z twoją nazwą w kolorze zielonym.","A feloldáshoz nyerj úgy, hogy zöld a neved.",""},
SKIN_GAGA ={"Lady's Throne","Trono da Lady","Trône de la dame","Trono de Dama","Трон Леди","手指寶座","Tron Damy","Hölgy Trónja",""},
SKIN_GAGA_MISSION ={"Unlocked by stealing two +4 in the same game using the Robbery Card.","Desbloqueado ao roubar dois +4 na mesma partida usando a Carta do Roubo.","Débloqué en volant deux +4 dans la même partie en utilisant la Carte Vol.","Desbloqueado robando dos cartas +4 en la misma partida usando la Carta de Robo","Разблокируется путём кражи двух +4 в одной игре с использованием Карты Ограбления.","在同一場遊戲裡使用怪盜卡牌偷取兩張 +4 卡牌後解鎖。","Odblokuj kradnąc 2 karty +4 w tej samej grze, używając Karty Rabunku.","A feloldáshoz lopj el a Rablás Kártya segítségével egy játék alatt kétszer +4-es kártyát.",""},
SKIN_CUPHEAD ={"Cuphead","","","Diván","Чашкоголовый","茶杯頭","Fotel Kubek","",""},
SKIN_CUPHEAD_MISSION ={"Unlocked by having 1 card left on both sides of the Portal.","Desbloqueado ao ficar com 1 carta dos dois lados do Portal.","Débloqué en ayant 1 carte restante, des deux côtés du Portail.","Desbloqueado al tener una carta restante en ambos lados del Portal.","Разблокируется, если по обе стороны Портала оставить одну карту.","在傳送門兩組卡牌中都各剩下一張卡牌後解鎖。","Odblokuj przez pozostawienie jednej karty po dwóch stronach Portalu.","A feloldáshoz maradjon a Portál mindkét oldalán egy-egy kártya a kezedben.",""},
SKIN_MECATOPUS ={"Mecatopus","","","Meccatopus","","金屬八爪魚","","",""},
SKIN_MECATOPUS_MISSION ={"Unlocked by discarding 5 or more cards using the Magnet Card.","Desbloqueado ao descartar 5 ou mais cartas usando a Carta do Imã.","Débloqué en défaussant 5 cartes ou plus à l'aide de la Carte Magnétique.","Desbloqueado al descartar cinco o más cartas usando la Carta Magnética.","Разблокируется сбросом 5 или более карт с помощью Магнитной Карты.","使用磁力卡牌丟棄 5 張或以上的卡牌後解鎖。","Odblokuj przez odrzucenie 5 lub więcej kart przy użyciu Karty Magnetycznej.","A feloldáshoz dobj el a Mágnes Kártyával 5 vagy több kártyát.",""},
SKIN_VANGOGH ={"Van Gogh","","","","Ван Гог","梵高","","",""},
SKIN_VANGOGH_MISSION ={"Unlocked when all players are using the same throne (minimun 8 players).","Desbloqueado quando todos os jogadores estão usando o mesmo trono (mínimo 8 jogadores).","Débloqué lorsque tous les joueurs utilisent le même trône.","Desbloqueado cuando todos los jugadores usan el mismo trono (mínimo 8 jugadores).","Разблокируется, когда все игроки используют один и тот же трон (минимум 8 игроков).","當所有玩家都在用同一張椅子的時候解鎖。 (需要最少8人)","Odblokuj, gdy wszyscy gracze używają tego samego tronu (minimun 8 graczy).","A feloldáshoz használja minden játékos ugyanazt a trónt (legalább 8 játékos).",""},
SKIN_SPACE ={"Space Throne","Trono Espacial","Trône spatial","Trono Espacial","Космический Трон","太空寶座","Kosmiczny Tron","Űr Trón",""},
SKIN_SPACE_MISSION ={"Unlocked by playing 4 or more cards in the same turn.","Desbloqueado ao jogar 4 cartas ou mais no mesmo turno.","Débloqué en jouant 4 cartes ou plus en un tour.","Desbloqueado al jugar cuatro o más cartas en el mismo turno.","Разблокируется, выбросив 4 или более карт в одном ходу.","在同一個回合裡發出 4 張或以上的卡牌後解鎖。","Odblokuj grając 4 lub większą ilością kart w tej samej turze.","A feloldáshoz játssz 4 vagy több kártyát egy kör alatt.",""},
SKIN_QUARTZ ={"Rose Quartz","","Quartz rose","Rose Cuarzo","Розовый Кварц","玫瑰石英","Różowy Kwarc","Rózsakvarc",""},
SKIN_QUARTZ_MISSION ={"Unlocked by playing %s action cards.","Desbloqueado ao jogar %s cartas de ação.","Débloqué en jouant %s cartes action.","Desbloqueado por jugar %s cartas de acción.","Разблокируется, играя %s раз с картами действий.","發出 %s 張行動卡牌後解鎖。","Odblokuj grając %s kart akcji.","A feloldáshoz játssz %s akciókártyát.",""},
SKIN_TRUE_LOVE ={"True Love","Amor verdadeiro","","","","真愛","","Igaz Szerelem",""},
SKIN_TRUE_LOVE_MISSION ={"Unlocked when you and another player reverse the game 4 times in a row.","Desbloqueado quando você e outro jogador revertem o jogo 4 vezes seguidas.","Débloqué lorsque vous et un autre joueur inversez le jeu 4 fois de suite.","Se desbloquea cuando tú y otro jugador usan la carta de reverso cuatro veces seguidas.","Разблокируется, когда вы и другой игрок переворачиваете игру 4 раза подряд.","當你和另一個玩家連續順逆遊戲方向 4 次之後解鎖。","Odblokuj kiedy ty i inny gracz odwrócicie grę 4 razy z rzędu.","A feloldáshoz fordítsd meg a kör irányát egy másik játékossal egymás után négyszer.",""},
SKIN_CROISSANT ={"Hot Chocolate","Chocolate Quente","Chocolat chaud","Chocolate Caliente","Горячий Шоколад","熱可可","Gorąca Czekolada","Forró Csokoládé",""},
SKIN_AQUARIUM ={"Aquarium","Aquário","","Acuario","Аквариум","水族箱","Akwarium","Akvárium",""},
SKIN_AQUARIUM_MISSION ={"Unlocked by winning while having a fish whispering advice in your ear.","Desbloqueado ao vencer enquanto tem um peixe te dando dicas na orelha.","Débloqué en gagnant en ayant un poisson vous donnant des indices en vous chuchotant à l'oreille.","Desbloqueado al ganar mientras se tiene a un pescado dando consejos al oído.","Разблокируется победой с рыбой-советчиком на ушке.","當有魚在耳邊提示你而勝出後解鎖。","Odblokuj wygrywając podczas gdy masz rybę szepczącą ci radę do ucha.","A feloldáshoz hagyd, hogy egy hal tanácsot súgjon a füledbe.",""},
SKIN_HELP ={"Lifeboat","Trono Salva-Vidas","Bateau de sauvetage","Salvavidas","Спасательная лодка","救生艇","Łódź Ratunkowa","Mentőcsónak",""},
SKIN_HELP_MISSION ={"Unlocked by winning normally while Sudden Death is activated.","Desbloqueado ao vencer normalmente enquanto a Morte Súbita está ativada.","Débloqué en jouant normalement lorsque la Mort Subite est activée.","Desboqueado por ganar de forma normal mientras la Muerte Súbita está activada.","Разблокируется победой в обычном режиме, когда активна Внезапная Смерть.","在突然死亡模式中以正常方式勝出遊戲後解鎖。","Odblokuj wygrywając normalnie podczas gdy Karta Nagłej Śmierci została aktywowana.","A feloldáshoz nyerj normális módon nyersz miközben a Hirtelen Halál érvényben van.",""},
SKIN_FONT ={"Fountain","Chafariz","Fontaine","Fuente de Agua","Фонтан","噴泉","Fontanna","Kút",""},
SKIN_FONT_MISSION ={"Unlocked by sacrificing a wild card to the Wish Card.","Desbloqueando ao entregar uma carta curinga para a Carta do Desejo.","Débloqué en sacrifiant une carte noire à la Carte Vœux.","Desbloqueado al sacrificar una carta comodín a una Carta del Deseo.","Разблокируется, пожертвовав чёрной картой +4 на Карте Желаний","在願望卡牌規矩中犧牲一張轉顏色卡牌後解鎖。","Odblokuj poświęcając kartę wild na Kartę Życzeń.","A feloldáshoz áldozz fel egy Színválasztó kártyát a Kívánság Kártyának.",""},
SKIN_CISNE ={"Swans","Cisnes","Cygne","Cisnes","Лебеди","天鵝","Łabędzie","Hattyúk",""},
SKIN_CISNE_MISSION ={"Unlocked by winning a Team Match with your soul mate.","Desbloqueado ao vencer uma partida em dupla com sua alma-gêmea.","Débloqué en gagnant une Partie en Équipe avec votre âme sœur.","Desbleado al ganar una partida en equipo con tu alma gemela.","Разблокируется, выиграв командный матч со своей второй половинкой.","在團隊模式中與你的伴侶一起勝出後解鎖。","Odblokuj wygrywając Rundę Drużynową ze swoją drugą połówką.","A feloldáshoz nyerj egy Csapatmérkőzést a lélektársaddal.",""},
SKIN_SNOWMAN ={"Snowman","Boneco de Neve","Bonhomme de neige","Hombre de Nieve","Снеговик","雪人","Bałwan","Hóember",""},
SKIN_SNOWMAN_MISSION ={"Unlocked by having someone eliminated by donating a card to them.","Desbloqueado ao fazer alguém ser eliminado doando uma carta para ele.","Débloqué lorsque quelqu'un est éliminé en leur donnant une carte.","Desbloqueado al eliminar a alguien por haberle donado una carta.","Разблокируется тем, что кого-то исключают, жертвуя им карточку.","向別人捐卡而令他被淘汰後解鎖。","Odblokuj eliminując kogoś przez podarowanie mu karty.","A feloldáshoz távolíts el valakit a játékból azzal, hogy kártyát adományozol neki.",""},
SKIN_COCA ={"Refreshing Throne","Trono Refrescante","Trône rafraichissant","Trono Refrescante","Освежающий Трон","清爽寶座","Tron Orzeźwienia","Felfrissítő Trón",""},
SKIN_COCA_MISSION ={"Unlocked by donating a +4 to someone.","Desbloqueado ao doar um +4 para alguém.","Débloqué en donnant un +4 a quelqu'un.","Se desbloquea al donar una carta +4 a otro jugador.","Разблокируется, пожертвовав +4 кому-то.","捐出一張 +4 卡牌給別人後解鎖。","Odblokuj podarowywując komuś +4.","A feloldáshoz adományozz egy +4-es kártyát valakinek.",""},
SKIN_PHONE ={"Phone Booth","Cabine Telefônica","Cabine téléphonique","Cabina Telefónica","Телефонная будка","電話亭","Budka Telefoniczna","Telefonfülke",""},
SKIN_PHONE_MISSION ={"Unlocked by setting a 6-color sequence in Simon's Card.","Desbloqueado ao acertar uma sequência de 6 cores na Carta da Memorização.","","Desbloqueado por poner una secuencia de seis colores en la Carta de Simón.","Разблокируется установкой 6-цветовой последовательности Карты Симона.","在西蒙卡組中成功設置6個顏色的排列後解鎖。","Odblokuj ustawiając 6 kolor sekwencji w Karcie Simona.","A feloldáshoz állíts fel egy hat színből álló sorozatot Simon Kártyájával.",""},
SKIN_MOON ={"Shadow Armchair","Poltrona Sombria","Fauteuil des ombres","Banco de las Sombras","Теневое Кресло","影子扶手椅","Krzesło Cieni","Árnyék Fotel",""},
SKIN_MOON_MISSION ={"Unlocked by winning a match during a full moon.","Desbloqueado ao vencer uma partida em temporada de lua cheia.","Débloqué en gagnant une partie durant la pleine lune.","Se desbloquea por ganar un encuentro durante luna llena.","Разблокируется победой в полнолуние.","在滿月的時候勝出一場遊戲後解鎖。","Odblokuj wygrywając rundę podczas pełni księżyca.","A feloldáshoz nyerj egy játékot telihold idején.",""},
SKIN_HONEY ={"Honey Throne","Trono do Mel","Trône miel","Trono de Miel","Медовый Трон","蜜糖寶座","Tron Miodu","Mézes Trón",""},
SKIN_HONEY_MISSION ={"Unlocked by playing side by side with your teammate in a Team Match.","Desbloqueado quando você jogar lado a lado com a sua dupla.","Débloqué en jouant côte à côte avec votre coéquipier dans une Partie en Équipe.","Se desbloquea al jugar lado a lado con tu compañero en una ronda en equipo.","Разблокируется, играя бок о бок с товарищем по команде в командном матче.","在團隊模式中, 你的搭檔坐在你旁邊後解鎖。","Odblokuj grając u boku ze swoim członkiem drużyny w Rundzie Drużynowej.","A feloldáshoz kerülj a csapattársad mellé egy Csapatmérkőzésben.",""},
SKIN_OLD ={"Old Armchair","Poltrona Antiga","Vieux fauteuil","Viejo Sillón","Старое Кресло","老舊扶手椅","Stary Fotel","Régi Fotel",""},
SKIN_OLD_MISSION ={"Unlocked by winning a game without house rules.","Desbloqueado ao vencer uma partida sem regras.","Débloqué en gagnant une partie sans règles de la maison.","Se consigue al ganar un juego sin reglas de la casa.","Разблокируется, выиграв игру без домашних правил.","在沒有自訂規矩中勝出一場遊戲後解鎖。","Odblokuj wygrywając grę bez domowych zasad.","A feloldáshoz nyerj meg egy játékot házszabályok nélkül.",""},
SKIN_CHIMNEY ={"Chimney","Chaminé","Cheminée","Chimenea","Дымоход","煙囪","Komin","Kémény",""},
SKIN_CHIMNEY_MISSION ={"Unlocked by winning dressed as a pine tree.","Desbloqueado ao vencer uma partida fantasiado de pinheiro.","Débloqué en gagnant en étant habillé en sapin.","Desbloqueado ganando vestido como un árbol.","Разблокируется победой, одетым, как сосна.","穿著聖誕杉樹的裝扮勝出遊戲後解鎖。","Odblokuj wygrywając ubranym jako choinkę.","A feloldáshoz nyerj meg egy játékot fenyőfának öltözve.",""},
SKIN_CHEESE_CLASSIC ={"Classic Cheese Throne","Trono de Queijo Clássico","Trône de fromage classique","Trono Clásico de Queso","Классический Сырный Трон","古典奶酪寶座","Klasyczny Serowy Tron","Klasszikus Sajt Trón",""},
SKIN_SACK ={"Sack of Potatoes","Saco de Batatas","Sac de pommes de terre","Saco de Papas","Мешок с картошкой","一大包土豆","Worek Ziemniaków","Egy Zsák Burgonya",""},
SKIN_SACK_MISSION ={"Unlocked by playing the Potato Card twice in the same game.","Desbloqueado ao jogar a Carta da Batata 2 vezes na mesma partida.","Débloqué en jouant la Carte Patate deux fois dans la même partie.","Se desbloquea por jugar la Carta de Papa dos veces en la misma partida.","Разблокируется, если дважды сыграть с Картофельной Картой в одной и той же игре.","在同一場遊戲裡發出兩次土豆卡牌後解鎖。","Odblokuj grając dwukrotnie Kartą Ziemniaka w tej samej grze.","A feloldáshoz játszd ki a Burgona Kártyát egy játék alatt kétszer.",""},
SKIN_SMARTPHONE ={"Smartphone","","","Tecnológico","Смартфон","智能電話","Smartfon","Okostelefon",""},
SKIN_SMARTPHONE_MISSION ={"Unlocked randomly by watching matches in a private room.","Desbloqueado aleatoriamente ao assistir partidas em sala privada.","Débloqué aléatoirement en regardant des parties dans un salon privé.","Se desbloquea aleatoriamente al mirar partidas en salas privadas.","Разблокируется случайным образом путём просмотра матчей в отдельной комнате.","在私人房間旁觀後隨機解鎖。","Odblokuj losowo, oglądając rundy w prywatnym pokoju.","Véletlenszerűen feloldható privát játékok megfigyelése közben.",""},
SKIN_HORN ={"Unicorn","Unicórnio","Licorne","Unicornio","Единорог","獨角獸","Jednorożec","Egyszarvú",""},
SKIN_HORN_MISSION ={"Unlocked by tying.","Desbloqueado ao empatar.","Débloqué en finissant par une égalité.","Se desbloquea por atadura.","Разблокировано связыванием.","和局之後解鎖。","Odblokuj przez wiązanie.","A feloldáshoz érj el egy döntetlen eredményt.",""},
SKIN_FLAMINGO ={"Flamingo","","Flamand rose","Flamenco","Фламинго","火烈鳥","Flaming","Flamingó",""},
SKIN_FLAMINGO_MISSION ={"Unlocked by winning a game with 5 or more rules.","Desbloqueado ao vencer uma partida com 5 ou mais regras.","Débloqué en gagnant une partie avec 5 règles ou plus.","Se desbloquea ganando un juego con cinco o más reglas.","Разблокируется, выиграв игру с 5 или более правилами.","在一場自訂規矩有 5 個或以上的遊戲勝出後解鎖。","Odblokuj wygrywając grę z 5 lub więcej zasadami.","A feloldáshoz nyerj meg egy játékot, amelyben legalább 5 házszabály van.",""},
SKIN_BILL ={"Bill's Statue","Estátua do Bill","Statue de Bill","Estatua de Bill","Статуя Билла","比爾的雕像","Statua Billa","Bill Szobra",""},
SKIN_BILL_MISSION ={"Unlocked by winning due to the Imitation Card effect.","Desbloqueado ao vencer devido ao efeito da Carta da Imitação.","Débloqué en gagnant grâce à l'effet de la Carte Imitation.","Se desbloquea ganando debido al efecto de la Carta de Imitación.","Разблокируется победой благодаря эффекту Имитационной Карты.","透過仿製卡效果而勝出遊戲後解鎖。","Odblokuj wygrywając dzięki efektowi Karty Imitacji.","A feloldáshoz nyerj az Utánzó Kártya képességével.",""},
SKIN_MAX ={"Throne Max 3000","Trono Max 3000","Trône Max 3000","Trono Futuritástico","Трон Макс 3000","天皇寶座 3000","Tron Max 3000","",""},
SKIN_MAX_MISSION ={"Unlocked by defeating 9 bots at once in a private room.","Desbloqueado ao derrotar 9 bots de uma só vez em sala privada.","Débloqué en battant 9 robots à la fois dans un salon privé.","Se desbloquea al vencer a nueve bots en una sala privada.","Разблокируется, победив 9 ботов одновременно в отдельной комнате.","在私人房間一次打敗 9 個機器人後解鎖。","Odblokuj przez pokonanie 9 botów naraz w prywatnym pokoju.","A feloldáshoz győzz le 9 robotot egy privát szobában.",""},
SKIN_VAMPIRE ={"Throne of the Plague","Trono da Peste","","","","瘟疫寶座","","A Pestis Trónja",""},
SKIN_VAMPIRE_MISSION ={"Unlocked by playing a match next to a player who is using this throne.","Desbloqueado ao jogar uma partida ao lado de alguém que estiver usando este trono.","","","","在使用這個座椅的玩家旁邊玩一局遊戲來解鎖。","","A feloldáshoz játssz egy játékot olyasvalaki mellett, aki ezt a trónt használja.",""},
SKIN_PIKACHU ={"Pikachu's Armchair","Poltrona do Pikachu","","","","皮卡丘扶手椅","","Pikachu Fotele",""},
SKIN_PIKACHU_MISSION ={"Unlocked by winning with a Thunder Card.","Desbloqueado ao vencer com a Carta do Trovão.","","","","迅雷。使用雷電卡牌獲勝後解鎖。","","A feloldáshoz nyerj a Mennydörgés Kártyával.",""},
SKIN_TOAST ={"Eggs and Toast","Torrada e Ovos","","","","雞蛋吐司","","Tojás és Pirítós",""},
SKIN_PIZZA ={"Pizza Box","Caixa de Pizza","","","","披薩盒子","","Pizzásdoboz",""},
SKIN_SIMPSONS ={"Simpsons' Sofa","Sofá dos Simpsons","","","","Simpsons 的沙發","","A Simpson Kanapé",""},
SKIN_SIMPSONS_MISSION ={"Unlocked by winning with your mouse naked.","Desbloqueado ao vencer uma partida com o rato nu.","","","","裸鼠裝扮勝出後解鎖。","","A feloldáshoz nyerj úgy, hogy az egered meztelen.",""},
SKIN_KISS ={"Kiss Armchair","Poltrona do Beijo","","","","親親扶手椅","","Csók Fotel",""},
SKIN_KISS_MISSION ={"Unlocked by donating to a player that donated to you.","Desbloqueado ao retribuir uma Doação que um jogador fez a você.","","","","把另一個玩家捐贈給你的卡牌給回他後解鎖。","","A feloldáshoz adj vissza egy adományt, amit más játékos adományozott neked.",""},
SKIN_FOREST ={"Enchanted Forest","Bosque Encantado","","","","迷人之森","","Elvarázsolt Erdő",""},
SKIN_FOREST_MISSION ={"Unlocked by winning with a pink Portal Card.","Desbloqueado ao vencer com um Carta do Portal rosa.","","","","使用粉紅色傳送門卡牌獲勝後解鎖。","","A feloldáshoz nyerj egy rózsaszín Portál Kártyával.",""},
SKIN_MONTAIN ={"Mountain","Montanha","","","","群山","","Hegy",""},
SKIN_MONTAIN_MISSION ={"Unlocked by winning using the Tornado Card during Sudden Death.","Desbloqueado ao vencer usando a Carta do Tornado durante a Morte Súbita.","","","","在暴斃模式中使用龍捲風卡牌獲勝後解鎖。","","A feloldáshoz nyerj egy Forgószél Kártyával miközben a Hirtelen Halál aktív.",""},
SKIN_SAMSON ={"Samson","Sansão","","","","","","Sámson",""},
SKIN_SAMSON_MISSION ={"Unlocked by locking every card of every opponent.","Desbloqueado ao trancar todas as cartas de todos os adversários.","","","","把所有對手的所有卡都鎖起來後解鎖。","","A feloldáshoz zárd el minden ellenfeled minden kártyáját.",""},
SKIN_CIAN ={"Cyan Armchair","Poltrona Verde-água","","","","碧綠扶手椅","","Cián Fotel",""},
SKIN_CIAN_MISSION ={"Unlocked by winning with a cyan card.","Desbloqueado ao vencer com uma carta verde-água.","","","","使用墨綠色卡牌獲勝後解鎖。","","A feloldáshoz nyerj cián kártyával.",""},
SKIN_ORANGE ={"Orange Armchair","Poltrona Laranja","","","","橘色扶手椅","","Narancsságra Fotel",""},
SKIN_ORANGE_MISSION ={"Unlocked by winning with an orange card.","Desbloqueado ao vencer com uma carta laranja.","","","","使用橘色卡牌獲勝後解鎖。","","A feloldáshoz nyerj narancssárga kártyával.",""},
SKIN_PINK ={"Pink Armchair","Poltrona Rosa","","","","粉紅扶手椅","","Rózsaszín Fotel",""},
SKIN_PINK_MISSION ={"Unlocked by winning with a pink card.","Desbloqueado ao vencer com uma carta rosa.","","","","使用粉紅色卡牌獲勝後解鎖。","","A feloldáshoz nyerj rózsaszín kártyával.",""},
SKIN_PURPLE ={"Purple Armchair","Poltrona Roxa","","","","紫色扶手椅","","Lila Fotel",""},
SKIN_PURPLE_MISSION ={"Unlocked by winning with a purple card.","Desbloqueado ao vencer com uma carta roxa.","","","","使用紫色卡牌獲勝後解鎖。","","A feloldáshoz nyerj lila kártyával.",""},
SKIN_BLACK ={"Black Armchair","Poltrona Preta","","","","黑色扶手椅","","Fekete Fotel",""},
SKIN_BLACK_MISSION ={"Unlocked by winning with a white card.","Desbloqueado ao vencer com uma carta branca.","","","","使用白色卡牌獲勝後解鎖。","","A feloldáshoz nyerj fehér kártyával.",""},
SKIN_TOXIC ={"Toxicity Throne","Trono da Toxicidade","","","","毒性寶座","","Mérgező Trón",""},
CYAN_MISSION ={"Unlocked by winning %s times with a cyan card.","Desbloqueado ao vencer %s vezes com uma carta verde-água.","","","","使用墨綠色卡牌獲勝 %s 次後解鎖。","","A feloldáshoz nyerj cián kártyával %s alkalommal.",""},
SKIN_THUNDER ={"Thunder Throne","Trono do Trovão","","","","雷電寶座","","Mennydörgés Trón",""},
ORANGE_MISSION ={"Unlocked by winning %s times with an orange card.","Desbloqueado ao vencer %s vezes com uma carta laranja.","","","","使用橘色卡牌獲勝 %s 次後解鎖。","","A feloldáshoz nyerj narancssárga kártyával %s alkalommal.",""},
SKIN_CRYSTAL ={"Crystal Throne","Trono do Cristal","","","","晶石寶座","","Kristrály Trón",""},
PINK_MISSION ={"Unlocked by winning %s times with a pink card.","Desbloqueado ao vencer %s vezes com uma carta rosa.","","","","使用粉紅色卡牌獲勝 %s 次後解鎖。","","A feloldáshoz nyerj rózsaszín kártyával %s alkalommal.",""},
SKIN_DARK ={"Darkness Throne","Trono da Escuridão","","","","暗黑寶座","","Sötétség Trónja",""},
PURPLE_MISSION ={"Unlocked by winning %s times with a purple card.","Desbloqueado ao vencer %s vezes com uma carta roxa.","","","","使用紫色卡牌獲勝 %s 次後解鎖。","","A feloldáshoz nyerj lila kártyával %s alkalommal.",""},
SKIN_LIGHT ={"Light Throne","Trono da Luz","","","","光明寶座","","Fényesség Trónja",""},
WHITE_MISSION ={"Unlocked by winning %s times with a white card.","Desbloqueado ao vencer %s vezes com uma carta branca.","","","","使用白色卡牌獲勝 %s 次後解鎖。","","A feloldáshoz nyerj fehér kártyával %s alkalommal.",""},
SKIN_ECLIPSE ={"Eclipse Throne","Trono do Eclipse","","","","日蝕寶座","","Napfogyatkozás Trón",""},
SKIN_ECLIPSE_MISSION ={"Unlocked by winning a Team Match using a card identical to one of your partner's.","Desbloqueado ao vencer uma partida em duplas usando uma carta idêntica a uma da sua dupla.","","","","在團隊模式中使用跟你同伴同一張的卡牌獲勝後解鎖。","","A feloldáshoz nyerj egy Csapatjátékot ugyanazzal a kártyával ami a partnerednek is van.",""},
SKIN_TOOTHLESS ={"Toothless","Banguela","","","","無牙","","Fogatlan",""},
SKIN_TOOTHLESS_MISSION ={"Unlocked by winning %s games on the dark side of the Portal.","Desbloqueado ao vencer %s partidas do lado escuro do Portal.","","","","在傳送門黑暗那邊勝出 %s 次後解鎖。","","A feloldáshoz nyerj %s alkalommal a Portál sötét oldalán.",""},
SKIN_LIGHTFURY ={"Lightfury","Fúria da Luz","","","","毛茸茸","","Fényfúria",""},
SKIN_LIGHTFURY_MISSION ={"Unlocked by winning %s games on the light side of the Portal.","Desbloqueado ao vencer %s partidas do lado claro do Portal.","","","","在傳送門光明那邊勝出 %s 次後解鎖。","","A feloldáshoz nyerj %s alkalommal a Portál világos oldalán.",""},
SKIN_KRATOS ={"Kratos","","","","","克雷多斯 戰神","","Kratos",""},
SKIN_KRATOS_MISSION ={"Unlocked by playing an action card using the Hell rule.","Desbloqueado ao descartar uma carta fazendo uso da regra Inferno.","","","","在地獄模式中使用行動卡牌後解鎖。","","A feloldáshoz játssz egy akciókártyát a Pokol szabály felhasználásával.",""},
SKIN_SHENLONG ={"Shenlong","","","","","神龍","","Shenlong",""},
SKIN_SHENLONG_MISSION ={"Unlocked when the Wish Card offers you 3 equal options.","Desbloqueado quando a Carta do Desejo te oferecer 3 opções iguais.","","","","當許願卡牌給了你 3 個一樣的選擇時解鎖。","","A feloldáshoz három ugyanolyan opciót kell a Kívánság Kártyától kapnod.",""},
SKIN_SPIDER ={"Spider-Man","Miranha","","","","蜘蛛俠","","Pókember",""},
SKIN_SPIDER_MISSION ={"Unlocked by using the Web Card on the same player twice in a match.","Desbloqueado ao usar a Carta da Teia duas vezes no mesmo jogador em uma partida.","","","","在同一個玩家身上連續使用 2 次蜘蛛網卡牌後解鎖。","","A feloldáshoz használd a Háló Kártyát ugyanazon a játékoson egy játék alatt kétszer.",""},
SKIN_LICH ={"Lich King's Throne","Trono do Lich Rei","","","","巫妖王的寶座","","A Lidérc Király Trónja",""},
SKIN_LICH_MISSION ={"Unlocked by winning a match due to the ice curse.","Desbloqueado ao vencer uma partida devido à maldição de gelo.","","","","在冰凍抽卡的詛咒下勝出後解鎖。","","A feloldáshoz nyerj meg egy játékot a fagyos átoknak köszönhetően,",""},
SKIN_BLACKHOLE ={"Black Hole","Buraco Negro","","","","","","",""},
SKIN_BLACKHOLE_MISSION ={"Unlocked by winning with a card not of this round.","Desbloqueado ao vencer uma partida com uma carta que veio de fora.","","","","","","",""},
SKIN_EVILJEWEL ={"Evil Jewel","Joia Maligna","","","","","","",""},
SKIN_CACTUS ={"Cactus","Cacto","","","","","","",""},
SKIN_SQUID_HOUSE ={"Squidward House","Casa do Lula Molusco","","","","","","",""},
SKIN_VOLCANO ={"Volcano","Vulcão","","","","","","",""},
SKIN_NYAN ={"Nyancat Armchair","Poltrona de Nyancat","","","","","","",""},
SKIN_TOY_CASTLE ={"Toy Castle","Castelo de Brinquedo","","","","","","",""},
SKIN_BOMBERMAN ={"Bomberman","","","","","","","",""},
SKIN_PHOENIX ={"Phoenix","Fênix","","","","","","",""},
SKIN_FIRE_TEMPLE ={"Temple of Fire","Templo de Fogo","","","","","","",""},
SKIN_GHOSTFACE ={"Ghostface","","","","","","","",""},
SKIN_IRONMAN ={"Ironman","Homem de Ferro","","","","","","",""},
SKIN_NINETALES ={"Ninetales","","","","","","","",""},
SKIN_PARABOLIC ={"Satellite Dishes","Antenas Parabólicas","","","","","","",""},
SKIN_TERMINATOR ={"Terminator T-800","Exterminador T-800","","","","","","",""},
...
SKIN_ANGEL_CLASSIC ={"Angelic Throne Classic","Trono Angelical Clássico","","","","","","",""},
SKIN_DIAMOND_CLASSIC ={"Diamond Throne Classic","Trono de Diamante Clássico","","","","","","",""},
SKIN_JUNKY_CLASSIC ={"Junky Throne Classic","Trono de Sucata Clássico","","","","","","",""},
...
SKIN_BUY_MISSION ={"Unlocked by buying it at the shop.","Desbloqueado ao comprar na loja.","","","","","","",""},
EQUIP ={"Equip","Equipar","Equiper","Equipar","Оборудовать","裝備","Załóż","Visel",""},
EQUIPPED ={"Equipped","Equipado","Equipé","Equipada","Оборудованный","已裝備","Założony","Viselve",""},
LOCKED ={"Locked","Bloqueado","Bloqué","Cerrada","Заблокированный","被鎖定","Zablokowane","Zárva","Kilitli"},
CREATED_BY ={"created by","criado por","crée(e) par","creado por","создано","創作人","zrobione przez","készítette:","Tarafından yaratıldı"},
BUY ={"Buy","Comprar","","","","","","",""},
NO_ENOUGH_BLUE ={"You don't have enough blue tickets.","Você não tem tickets azuis suficientes.","","","","","","",""},
NO_ENOUGH_RED ={"You don't have enough red tickets.","Você não tem tickets vermelhos suficientes.","","","","","","",""},
NO_ENOUGH_YELLOW ={"You don't have enough yellow tickets.","Você não tem tickets verdes suficientes.","","","","","","",""},
NO_ENOUGH_GREEN ={"You don't have enough green tickets.","Você não tem tickets amarelos suficientes.","","","","","","",""},
SHOP_INFO ={"The shop offers 10 random items daily. The catalogue will be updated in %s.","Esta loja oferece 10 itens aleatórios para comprar todos dias. O catálogo será atualizado em %s.","","","","","","",""},
SHOP_CHAIRS ={"Chair","Cadeira","","","","","","",""},
SHOP_PANEL ={"Panel","Painel","","","","","","",""},
SHOP_LIGHT ={"Spotlight","Holofote","","","","","","",""},
SHOP_MAP ={"Map","Mapa","","","","","","","Harita"},
SHOP_RULE ={"Rule","Regra","","","","","","",""},
SHOP_CONSUMABLE ={"Consumable","Consumível","","","","","","",""},
RULES_1 ={"When a new game begins, you may sit on an empty chair (by pressing space). The game begins after 15 seconds.\n\nGet rid of all the cards on your hand to win the game. Each player can discard one card per round. The discarded card must have a number, color or symbol equal to the one that's shown on the table.\n\nIf you don't have a suitable card to discard, you must draw one from the deck by clicking on it. If this card is adequate, you can play it or pass your turn.","Quando um novo jogo se iniciar, corra e sente-se em uma cadeira vazia (apertando espaço). O jogo se inicia em 15 segundos.\n\nLivre-se de todas as cartas da sua mão para vencer o jogo. Para isto, cada jogador descarta uma carta nos seus respectivos turnos. A carta descartada deve ter número, símbolo ou cor da carta que estiver na mesa.\n\nCaso você não tenha uma carta para jogar, você deve comprar 1 carta (clicando no baralho). Caso esta carta sirva para jogar, você pode jogá-la ou passar a vez.","Lorsqu'une partie commence, vous devez vous asseoir sur une chaise vide (en appuyant sur espace). La partie commence dans 15 secondes. \n\nDébarassez-vous des cartes de votre main pour gagner le jeu. Chaque joueur peut se défausser d'une carte par tour. La carte défaussée doit avoir un numéro, une couleur ou un symbole égal à celui qui est indiqué sur le tableau. \n\nSi vous n'avez pas de carte à défausser, vous devez en tirer une de la pioche en cliquant dessus. Si cette carte est adéquate, vous pouvez la jouer ou passer votre tour.","Cuando un nuevo juego comienza, debes correr y tomar una silla vacía(presionando espacio o agachandote en ella). El juego comenzará en 15 segundos.\n\n Descarta todas tus cartas para ganar el juego. Cada jugador puede descartar una carta por turno. La carta descartada debe tener el número, color o símbolo igual a la que se muestra en la parte alta de la mesa. \n\n Si no tienes cartas para descartar, deberás tomar una carta del mazo presionando en él, si la carta encaja puedes descartarla o pasar turno.","Когда начинается новая игра, вы можете сесть на пустой кресло (нажав пробел). Игра начинается через 15 секунд.\n\nУбери все карты, которые у тебя есть, чтобы выиграть игру. Каждый игрок может сбросить одну карту за раунд. У сброшенной карты должен быть номер, цвет или символ, совпадающий с тем, который указан на столе.\n\nЕсли у вас нет подходящей карты для сброса, вы должны взять её из колоды, нажав на неё. Если этой карты достаточно, вы можете положить её или пропустить свой ход.","當新一輪遊戲開始的時候, 你可以到空置的座位 (按空格鍵) 坐下。 遊戲將在 15 秒後開始。\n\n只要把手上的牌都出完就勝出遊戲。 每個玩家在每一個回合只可以出一張卡牌。 發出的卡牌都必須跟在桌子上已翻開的卡牌有著相同的數字, 顏色 或符號。\n\n如果你沒有一張符合出牌要求的卡牌, 你需要點擊牌庫來抽取一張卡。 如果抽出的卡剛好符合出牌要求, 你可以選擇馬上出牌或是留待下一回合。","Gdy rozpocznie się nowa gra, możesz zacząć biec aby zająć puste krzesło (wciskając spację). Gra rozpocznie się za 15 sekund.\n\nPozbądź się wszystkich kart z twojej puli aby wygrać grę. Każdy gracz w trakcie jednej kolejki może wyrzucić jedna kartę na stół. Wyrzucona karta musi mieć numer, kolor lub symbol taki sam, jak karta pokazana na stole.\n\nJeśli nie masz odpowiedniej karty do wyrzucenia, musisz wyciągnąć jedną kartę z talii kart klikając na nią. Jeśli karta ta pasuje, możesz wyrzucić ja na stół lub przeczekać kolejkę.","Amikor elkezdődik egy új játék, le tudsz ülni egy üres székre (a szóköz megnyomásával). A játék 15 másodperc múlva kezdődik.\n\nSzabadulj meg az összes kezedben lévő kártyától hogy megnyerd a játékot. Minden játékos ki tud játszani egy kártyát minden körben. A kijátszott kártyán olyan színnek, számnak vagy szimbólumnak kell szerepelnie, mint ami az asztalon lévő kártyán van rajta.\n\nHa nincs olyan kártyád amit kijátszhatnál, húznod kell egyet a pakliból úgy, hogy rákattintasz. Ha olyan kártyát húztál, amit ki tudnál játszani, kijátszhatod vagy átadhatod a kört.",""},
RULES_2 ={"Some special cards can change the game course:\n\n<b>Skip:</b> The next player misses their turn.\n\n<b>Reverse:</b> This card changes the game direction. If there are only two players in the game, it'll have the same effect as the Skip card.\n\n<b>+2:</b> It makes the next player draw two cards and miss their turn. If that player also has a +2 card, they can discard it and pass the accumulated penalty to the next player.\n\n<b>Wild:</b> You can discard it over any card and it gives the power to change the color to any of the four colors.","Algumas cartas especiais mudam o rumo do jogo:\n\n<b>Pular:</b> Faz o próximo jogador perder a vez\n\n<b>Reverter:</b> Inverte o fluxo do jogo. Se for apenas 2 pessoas jogando, essa carta tem o efeito da carta Pular.\n\n<b>+2:</b> Faz o próximo comprar duas cartas e perder a vez, caso ele também tenha um +2, ele pode descartar e passar a penalidade para o próximo, que será acumulada.\n\n<b>Curinga:</b> Pode jogar em cima de qualquer carta, depois escolha uma cor para prosseguir o jogo.","Certaines cartes spéciales peuvent changer le cours du jeu: \n\n<b>Passe:</b> Le prochain joueur passe son tour. \n\n<b>Changement de sens:</b> Cette carte change la direction du jeu. Si il n'y a que deux joueurs dans la partie, cette carte aura le même effet que la carte Passe.\n\n<b>+2:</b> Cette carte fait prendre, au prochain joueur, 2 cartes et lui passer son tour. Si ce joueur a déjà un +2, alors il peut la défausser et passer la pénalité accumulée au prochain joueur.\n\n<b>Carte noire:</b> Vous pouvez défaussez une carte noire sur n'importe quelle autre carte, vous donnant alors le pouvoir de changer la couleur de la carte en l'une des quatre couleurs du jeu.","Algunas cartas especiales pueden cambiar la dirección del juego:\n\n<b>Saltar:</b> El siguiente jugador pierde su turno.\n\n<b>Reversa:</b> Esta carta cambia la dirección. Si es que sólo hay 2 jugadores en la partida, la carta toma el efecto de la carta ''Saltar''.\n\n<b>+2:</b>Esta carta hace que el siguiente jugador tome 2 cartas y perder su turno. Si el jugador tiene un +2, él puede descartarla y saltarse la penalidad.\n\n<b>Wild:</b> Puedes descartarla encima de cualquier carta y le da el poder de cambiar el color al que la descartó.","Некоторые специальные карты могут изменить ход игры:\n\n<b>Пропустить:</b> Следующий игрок пропускает свой ход.\n\n<b>Обратная:</b>  Эта карта меняет направление игры. Если в игре только два игрока, это будет иметь тот же эффект, что и карта пропуска..\n\n<b>+2:</b> Она заставляет следующего игрока взять две карты и пропустить свой ход. Если у этого игрока также есть карта +2, он может сбросить её и передать накопленные карты следующему игроку..\n\n<b>Чёрная:</b> Вы можете поставить её на любую карту, и сможете сменить на один цвет из четырёх.","有一些特別卡牌會改變遊戲進程:\n\n<b>跳過牌:</b> 使用後會跳過下一位玩家的回合。\n\n<b>反轉牌:</b> 改變遊戲進行的方向。 如果只有兩個玩家, 它會變成跟跳過牌一樣的作用。\n\n<b>+2 卡牌:</b> 它會使下一個玩家罰抽 2 張卡牌然後跳過他的回合。 如果那個玩家也有 +2 卡牌, 他可以發出那卡牌然後把罰抽次數累積給再下一個玩家。\n\n<b>換色卡牌:</b> 你可以在你的回合隨時使用它來換掉出牌的顏色, 在四個顏色中選擇你想換成的顏色就行了。","Niektóre specjalne karty mogą zmienić przebieg gry:\n\n<b>Pominięcie:</b> Następny gracz traci swoją kolejkę.\n\n<b>Odwrócenie:</b> Ta karta zmienia kierunek gry. Jeśli tylko dwie osoby biorą udział w rozgrywce będzie ona dawać taki sam efekt jak karta pominięcie.\n\n<b>+2:</b> Sprawia, ze następny gracz dostaje 2 dodatkowe karty i traci kolejkę. Jeśli gracz posiada w swojej puli kartę +2, może wyrzucić ją na stół i przekazać swoją karę następnemu graczowi.\n\n<b>Wild:</b> Możesz położyć ją na każdą inną kartę, daje ona możliwość wyboru koloru dla tego, kto ja wyrzucił.","Néhány különleges kártya megváltoztathatja a játék menetét:\n\n<b>Kimaradsz:</b> A következő játékos kimarad a körből.\n\n<b>Visszafordító:</b> Ez a kártya megfordítja a kör irányát. Ha csak két játékos van, ugyanaz a képessége mint a Kimaradsz kártyának.\n\n<b>+2:</b> A következő játékosnak kettőt kell húznia, majd kimarad a körből. Ha neki is van +2-es kártyája, kijátszhatja és a felhalmozott +2-es kártyák összesített értékével továbbíthatja a következő játékosnak.\n\n<b>Színválasztó:</b> Kijátszhatod bármely kártyára, és utána kiválaszthatod a színét a négy szín bármelyikéből.",""},
RULES_3 ={"<b>Wild +4:</b> It works just like the Wild, but this one also makes the next player draw 4 cards. If the next player has a Wild +4 card, they can discard the card and pass the accumulated penalty to the next player.\n\nYou can only play a Wild +4 card when you have no card matching the color of the top card on the table. The next player can challenge an invalid Wild +4 card. If the challenger is right, the one that will draw four cards will be the one who played it and the challenger won't miss their turn. But if the challenger is wrong, they will draw 6 cards, the initial 4 plus an extra 2 as a penalty.","<b>Curinga +4:</b> Igual ao Curinga comum, mas faz o próximo comprar 4 cartas e perder a vez, se o próximo também tiver um +4, ele pode descartar e passar a penalidade para o próximo, que será acumulada.\n\nÉ permitido jogar um +4 apenas quando você não tiver cartas da cor da mesa.\n\nO próximo jogador pode desafiar um +4 injusto. Se o desafiante estiver certo, quem compra as 4 cartas será quem jogou o +4 e a vez não será perdida. Caso o desafiante perca, ele compra 2 cartas a mais como punição.","","<b>Wild +4:</b> Funciona como un joker común, pero este hace al próximo jugador tomar 4 cartas. Si el próximo jugador tiene un joker +4, el jugador puede descartar la carta y pasar la penitencia al próximo jugador.\n\nSólo puedes jugar el joker +4 cuando no tienes cartas del color jugable. El siguiente jugador puede desafiar el joker +4 injusto. Si el jugador está en la razón, el jugador que descartó el joker +4 será quien reciba las 4 cartas y el que lo iba a recibir no pierde su turno. En caso de que el desafiador esté equivocado tendrá que tomar 2 cartas más aparte de las que iba a recibir como penalización.","<b>Чёрная +4:</b> Она работает так же, как и обычная Чёрная, но эта также заставляет следующего игрока взять 4 карты. Если следующий игрок имеет Чёрную +4, он может сбросить её и передать накопленные карты следующему игроку.\n\nВы можете играть картой Чёрной +4, только если у вас нет карты, соответствующей цвету карты, которая на столе. Следующий игрок может бросить вызов недействительной карте Чёрной +4. Если человек прав, то тот, кто возьмет четыре карты, будет тем, кто их разыграл, и претендент не пропустит свой ход. Но если человек ошибается, он вытянет 6 карт, начальные 4 и 2 дополнительные.","<b>+4 換色卡牌:</b> 它跟換色卡牌一樣, 但是這張卡牌會讓下一個玩家罰抽 4 張卡。 如果下一個玩家也有 +4 換色卡牌, 他可以發出那卡牌然後把罰抽次數累積給再下一個玩家。\n\n你只可以在沒有跟桌面上出牌的顏色一樣的卡牌這個情況下才可以發出 +4 換色卡牌。 下一個玩家有權力質疑你的 +4 換色卡牌有沒有違反這規則。 如果成功質疑, 發出這 +4 換色卡牌的人需要罰抽 4 張卡牌而提出質疑的玩家不會失去自己的回合。 可是如果質疑失敗, 提出質疑的玩家會被罰抽 6 張卡牌, 那是本來的 4 張加上額外 2 張卡牌作為懲罰。","<b>Wild +4:</b> Działa trochę jak znany joker, ale sprawia, że następny gracz musi wyciągnąć 4 karty z talii. Jeśli ma on w swojej puli kartę Wild +4. może położyć ją na stół i przekazać karę następnemu graczowi.\n\nMożesz użyć karty Wild +4 jeśli nie masz żadnej karty w kolorze tej, która znajduje się na stole. Następny gracz może rzucić wyzwanie, jeśli stwierdzi, ze karta +4 została wyrzucona niesprawiedliwie, Jeżeli wyzywający ma racje, osobą która dostanie 4 dodatkowe karty, będzie ten, kto położył kartę Wild +4, a wyzywający nie straci kolejki.\nW przypadku, gdy wyzywający nie ma racji, otrzyma dwie karty więcej jako karę.","<b>Színválasztó +4:</b> Úgy működik mint egy Színválasztó, viszont a következő játékosnak húznia kell négy kártyát. Ha neki is van Színválasztó +4-s kártyája, kijátszhatja és a felhalmozott Színválasztó +4-es kártyák összesített értékével továbbíthatja a következő játékosnak.\n\nCsak akkor játszhatsz egy Színválasztó +4-es kártyát, ha nincs más kártyád, amely megegyezik színben az asztalon lévővel. A következő játékos kihívhat egy érvénytelen Színválasztó +4-es kártyát. Ha a kihívónak van igaza, a kijátszó húz négy kártyát és a kihívó köre nem marad ki. Ha a kihívó tévedett, ő húz 6 kártyát, a kezdeti négyet és még kettőt büntetésből.",""},
RULES_4 ={"Before you discard your penultimate card, you should click the UNO button. If you don't click it in time, the other players can then click the challenge button and you'll automatically draw 2 cards.\n\nThere are additional rules that can appear in some matches. Pay attention to the list of house rules because a new rule can appear! You can click on each rule for further details. Some rules add new cards, while others alter the gameplay in other ways. Have fun!","Antes de você jogar sua penúltima carta, você deve declarar UNO (apertando no botão UNO), caso não faça isso, você deverá comprar duas cartas caso alguém desafie você.\n\nExistem várias outras regras especiais que podem aparecer em algumas partidas. Fique atento no quadro de regras caso apareça uma regra nova.\n\nVocê pode clicar no nome da regra para ver mais detalhes sobre ela. Algumas regras adicionam cartas novas, enquanto outras alteram a forma de jogar. Divirta-se!","","Antes de descartar tu penúltima carta, debes decir UNO (presionando el botón UNO), si no lo presionas deberás tomar 2 cartas en caso de que alguien te de desafio.\n\nExisten reglas especiales que aparecerán en algunas rondas. Puedes informarte sobre las reglas en el muro de reglas (presiona U). Puedes presionar el nombre de una regla para aprender que hace. Algunas reglas añaden nuevas cartas, mientras que otras cambian el modo de juego. ¡Diviértete!","Прежде чем выбросить свою предпоследнюю карту, вам нужно нажать кнопку УНО. Если вы не нажмёте его вовремя, другие игроки могут нажать кнопку за вас, и вы автоматически получите 2 карты..\n\nВ некоторых матчах могут появиться дополнительные правила. Обратите внимание на список домашних правил, потому что может появиться новое правило! Вы можете нажать на каждое правило для получения дополнительной информации. Некоторые правила добавляют новые карты, в то время как другие изменяют игровой процесс другими способами. Веселитесь!","在剩下最後二張卡牌的時候, 你在發牌之前應該先按 UNO 鍵。 如果你在發牌之前沒有按它, 其他的玩家就可以按質疑鍵然後你就會自動被罰兩張卡牌。\n\n在一些遊戲局中也可能會出現額外的規矩。 多點留意左邊的列表因為有機會出現新的自訂規矩哦! 你可以按下每道規矩來查看詳情。 有一些規矩會在牌庫中加入新卡牌, 也有一些會改變遊戲的進程。 總而言之請玩的高興!","Zanim wyrzucisz swoją ostatnią kartę, musisz nacisnąć przycisk UNO, w przypadku kiedy tego nie zrobisz, dostaniesz dwie dodatkowe karty jeśli któryś z graczy cię wyzwie. \n\nSą też specjalne zasady, które mogą pojawić się w niektórych meczach. Bądź czujny i obserwuj tablicę z zasadami. Możesz kliknąć na nazwę zasady żeby zobaczyć więcej szczegółów. Niektóre zasady dodają nowe karty , a inne zmieniają rozgrywkę. Miłej zabawy!","Mielőtt kijátszanád az utolsó előtti kártyád, kattints rá az UNO gombra. Ha nem kattintasz rá időben, a többi játékos rákattinthat a kihívás gombra, és azonnal húzol 2 kártyát.\n\nVannak egyéb szabályok, amelyek megjelenhetnek játékokban. Figyelj oda a házszabályok listájára mert egy új szabály bármikor megjelenhet! Rá tudsz kattintani a szabályokra részletes leírásokért. Néhány szabály új kártyákat ad a játékba, mások különböző módokon változtatják meg a játékot. Jó szórakozást!",""},
HOUSE_CHALLENGE ={"No Challenge","Sem Desafiar","Pas de Défi","Sin desafiar","Нет Вызова","不准質疑","Bez wyzwań","Nincs Kihívás",""},
HOUSE_CHALLENGE_DESC ={"The wild +4 card can't be challenged anymore.","Os +4 não podem mais ser desafiados.","La carte +4 ne peut plus être défiée.","La carta comodín +4 no podrá ser retada.","Чёрная +4 берётся без вызова."," +4 換色卡牌不能夠再被質疑了。","Wild +4 nie może być więcej Challenge.","A Színválasztó +4-es kártyát nem lehet többé kihívni.",""},
HOUSE_NO_COMBO ={"No Combo","Sem Combo","Pas de Combo","Sin combo","Нет Комбо","不可累積","Bez Combo","Nincs Kivédés",""},
HOUSE_NO_COMBO_DESC ={"You can't block drawing cards anymore.","Não é mais possível se defender de cartas de compra.","You can't block drawing cards anymore.","Ya no podrás bloquear cartas sorteadas.","Вы не можете больше блокировать карты +2.","你不能夠再累積罰抽卡牌了。","Nie możesz więcej blokować dobierania kart. ","Nem lehet többé kártyahúzást kivédeni.",""},
HOUSE_SUPER_COMBO ={"Super Combo","","","Supercombo","Супер Комбо","超級累積","","Szuper Kivédés",""},
HOUSE_SUPER_COMBO_DESC ={"You can block drawing cards with any card that has a + on it.","É possível se defender de compras de carta com qualquer carta com um +.","You can block drawing cards with any card that has a + on it.","Podrás bloquear cartas sorteadas con cualquier carta que tenga un + en ella.","Вы можете блокировать карты картами, у которых есть +.","你可以用任何有 + 號的卡牌累積罰抽次數。","Możesz blokować karty wyciągając dowolną kartę z +.","Bármilyen + szimbólumot tartalmazó kártyával kivédheted a kártyahúzást.",""},
HOUSE_HELL ={"Hell","Inferno","Enfer","Infierno","Ад","地獄","Piekło","Pokol",""},
HOUSE_HELL_DESC ={"Action cards can be played over any other action card, of any color.","Cartas de ação podem ser jogadas em cima de outras cartas de ação de qualquer cor.","Les cartes action peuvent être jouées au-dessus de n'importe quelle autre carte action, de n'importe quelle couleur.","Cartas de acción podrán ser jugadas sobre cualquier otra carta de acción, de cualquier color.","Карты действий можно положить поверх любой другой карты действий любого цвета.","所有的行動卡牌都可以在上一張行動卡牌發出之後接著發出, 不管是任何顏色。","Kartę akcji można położyć na inną taką kartę, niezależnie od jej koloru.","Az akciókártyák bármely másik akciókártyára lejátszhatók, bármely más színből is.",""},
HOUSE_JUMP_IN ={"Jump-In","Corte","","En-Salto","Прыжок","跳-入","Wskocz","Beugrás",""},
HOUSE_JUMP_IN_DESC ={"If you have the exact same card that's on the table, you can play it even if it's not your turn.","Se você tiver uma carta idêntica à da mesa, você pode jogá-la mesmo que não seja sua vez!","Si vous avez exactement la même carte que celle sur la table, vous pouvez la jouer même si ce n'est pas votre tour.","Si tienes exactamente la misma carta que está en la tabla, podrás jugarla aunque no sea tu turno.","Если у вас есть карта, которая на столе, вы можете нажать на свою и заберёте ход на себя","如果你有跟在桌面上一模一樣的卡牌, 就算還沒有到你的回合你也可以馬上發出那卡牌。","Jeśli masz dokładnie taką samą kartę, jaka widnieje na stole, możesz położyć ją nawet jeśli nie jest to twoja kolej.","Ha olyan kártyával rendelkezel, amely az asztalon van, akkor kijátszhatod akkor is, ha nem a te köröd van.",""},
HOUSE_CLEAN_FINISH ={"Clean Finish","Final Limpo","Finition Propre","Final Limpio","Чистый Финиш","乾淨俐落","Czysty Koniec","Tiszta Győzelem",""},
HOUSE_CLEAN_FINISH_DESC ={"You can only win the game if your last card is a numerical card.","Você só pode vencer o jogo se sua última carta for numérica.","Vous pouvez gagner cette partie uniquement si votre dernière carte est une carte numérique.","Sólo podrás ganar el juego si tu última carta es un número.","Вы можете выиграть игру, только если ваша последняя карта - цифровая.","你最後發出的一張卡牌必須要是數字卡牌才可以勝出遊戲。","Możesz wygrać jeżeli twoja ostatnia karta jest numerem.","Csak akkor nyerhetsz, ha az utolsó kártyád számkártya.",""},
HOUSE_MINI ={"Mini","","","Mínimo","Мини","迷你","","",""},
HOUSE_MINI_DESC ={"Everyone starts with 4 cards.","Todos iniciam com 4 cartas.","Tout le monde démarre avec 4 cartes.","Todos empiezan con cuatro cartas.","Игра начинается с 4 карт.","所有人起初的卡牌數量變成 4","Wszyscy startują z 4 kartami","Mindenki 4 kártyával kezd.",""},
HOUSE_MAXI ={"Maxi","","","Máximo","Макси","最大","","",""},
HOUSE_MAXI_DESC ={"Everyone starts with 9 cards.","Todos iniciam com 9 cartas.","Tout le monde démarre avec 9 cartes.","Todos empiezan con nueve cartas.","Игра начинается с 9 карт.","所有人起初的卡牌數量變成 9","Wszyscy startują z 9 kartami","Mindenki 9 kártyával kezd.",""},
HOUSE_SATISFACTION ={"Satisfaction","Satisfação","","Satisfacción","Удовлетворение","心滿意足","Zadowolenie","Elégedettség",""},
HOUSE_SATISFACTION_DESC ={"You must keep drawing cards until you find a playable card.","Compre cartas até poder jogar uma.","Vous devez continuer à tirer des cartes jusqu'à ce que vous trouviez une carte jouable.","Tendrás que estar sorteando cartas hasta que encuentres una carta jugable.","Вы должны продолжать брать карты, пока не найдете нормальную.","你需要一直抽取卡牌直到抽出一張可以馬上發出的卡牌。","Wyciągaj karty dopóki nie znajdziesz opłacalnej karty.","Addig kell húznod kártyát, amíg kijátszhatót nem találsz.",""},
HOUSE_INSATISFACTION ={"Unsatisfied","Insatisfação","Insatisfaction","Insatisfecho","Неудовлетворенный","不滿意","Niezadowolenie","Kielégítetlen",""},
HOUSE_INSATISFACTION_DESC ={"When you draw a card, you pass your turn automatically.","Comprar carta fará você passar a vez automaticamente.","Lorsque vous tirez une carte, vous passez votre tour automatiquement.","Cuando sortees una carta pasarás automáticamente de turno.","Когда вы берете карту, вы автоматически пропускаете свой ход.","當你抽取卡牌, 將會自動結束自己的回合。","Kiedy dobierasz kartę twój ruch zostaje przerwany automatycznie.","Ha húzol egy kártyát, azonnal kimaradsz a körből.",""},
HOUSE_FLASH ={"Flash","Rápido","","","Флэш","閃現","Błysk","Villanás",""},
HOUSE_FLASH_DESC ={"You only have 5 seconds to play!","São apenas 5 segundos para jogar!","Vous avez uniquement 5 secondes pour jouer!","¡Sólo tienes cinco segundos para escoger!","У вас есть только 5 секунд, чтобы играть!","你只有 5 秒來決定出牌!","To tylko 5 sekund na gre!","Csak 5 másodperced van játszani!",""},
HOUSE_REVELATION ={"Revelation","Revelação","Révélation","Revelación","Откровение","泄密","Rewelacja","Jelenés",""},
HOUSE_REVELATION_DESC ={"The top card of the deck is visible to everyone.","A carta no topo do baralho é visível para todos.","La carte supérieure de la pioche est visible par tout le monde.","La carta más alta de la baraja estará visible a todos.","Верхняя карта колоды видна всем.","所有人都看的見牌庫中第一張卡牌。","Górna karta z talli jest widoczna dla wszystkich.","A pakli felső kártyája mindenki számára látható.",""},
HOUSE_PERFECTION ={"Perfection","Perfeccionista","","Perfección","Совершенство","完美主義","Doskonałość","Tökéletesség",""},
HOUSE_PERFECTION_DESC ={"If you play a number card that is equal to the number of cards in your hand, you can play again.","Se jogar um número igual ao número de cartas na mão, jogue novamente.","Si vous jouez une carte numérique égale au nombre de cartes de votre jeu, vous pouvez rejouer.","Si juegas una carta cuyo número es equivalente al número de cartas que tienes a la mano, tendrás otro turno.","Если вы играете цифровой картой, которая равна количеству карт в вашей руке, вы можете играть снова.","如果你發出的卡牌上的數字跟你持有的卡牌數目一樣, 你可以再發出一張牌。","Jeśli grasz kartą z takim samym numerem jaką trzymasz w ręku zagraj ponownie.","Ha olyan számkártyát játszol amely értéke egyenlő a kezedben lévő kártyák számával, újra játszhatsz.",""},
HOUSE_TRACKING ={"Tracking","Rastrear","Traçage","Rastreo","Отслеживание","追蹤","Śledzenie","Nyomkövetés",""},
HOUSE_TRACKING_DESC ={"When you draw a card, you get the option to choose one of three cards.","Ao comprar carta, você escolhe uma entre três cartas para comprar.","Lorsque vous piochez une carte, vous avez l'option de choisir une sur trois cartes.","Cuando sortees una carta, tendrás la opción de escoger una de tres cartas.","Когда вы берёте карту, вы получаете возможность выбрать одну из трёх карт.","當你抽取卡牌的時候, 你可以在 3 個選擇中選一個。","Kiedy dobierasz kartę możesz wybrać jedną z pośród trzech podanych. ","Ha egy kártyát húznál, választhatsz három kártya közül.",""},
HOUSE_MULLIGAN ={"Mulligan","Segunda Chance","","","Пересдача","穆里根","","",""},
HOUSE_MULLIGAN_DESC ={"When the game starts, you can change your hand with a new one.","No início do jogo, você pode trocar sua mão por uma nova.","Lorsque le jeu commence, vous pouvez changer votre jeu avec un autre.","Cuando el juego comienze, podrás cambiar tu baraja con una nueva.","Когда игра начнётся, вы можете сменить свои карты на новые.","在遊戲開始的時候, 你可以選擇把卡組換掉。","Kiedy gra się rozpoczyna, możesz wymienić swoją pulę kart na nową.","Amikor a játék elkezdődik, kicserélheted a kezedben lévő kártyáid újakra.",""},
HOUSE_OVERLOAD ={"Overload","Sobrecarga","Surcharge","Sobrecarga","Перегрузка","負荷過多","Przeciążenie","Túltöltődés",""},
HOUSE_OVERLOAD_DESC ={"Players with more than 10 cards get eliminated.","Quem ficar com mais de 10 cartas na mão será eliminado.","Les joueurs avec plus de 10 cartes sont éliminés.","Jugadores que posean más de diez cartas serán eliminados.","Игроки с более чем 10 картами исключаются.","玩家手中卡牌多於 10 就會被淘汰掉。","Gracz mający więcej niż 10 kart, będzie wyeliminowany. ","A több mint 10 kártyával rendelkező játékosok kiesnek a játékból.",""},
HOUSE_BLACK ={"Black Cards","Cartas Pretas","Cartes Noires","Cartas Negras","Чёрные Карты","黑色恐怖","Czarne Karty","Fekete Kártyák",""},
HOUSE_BLACK_DESC ={"If you play the exact same card as the top card, it turns into a black one. Only a card with the same number or symbol can be played on it.","Se jogar uma carta idêntica à da mesa, a carta fica com cor preta.","Si vous jouez exactement la même carte que celle du haut, elle devient noire. Seule une carte avec le même numéro ou symbole peut être jouée dessus.","Si juegas exactamente la mimsa carta que está en el tope, se tornará a una negra. Únicamente una carta que contenga el mismo número o símbolo podrá ser jugada sobre ésta.","Если вы кладёте ту же карту, какая сверху, она превращается в чёрную. Положить можно только ту, которая имеет такой же символ и номер.","如果你發出的卡跟桌面上的卡牌一模一樣, 它會變成黑色。之後只可以發出跟黑卡有著一樣的數字或符號的卡牌。","Jeśli zagrasz taką samą kartą jak karta z góry, stanie się czarna.","Ha az asztalon lévő kártyával azonos kártyát játszol ki, feketévé változik. Csak olyan kártya játszható rá, amelyen ugyanaz a szám vagy szimbólum szerepel.",""},
HOUSE_STACK ={"Stacking","Empilhar","Empilage","Apilando","Множество","堆疊","Układanie","Halmozás",""},
HOUSE_STACK_DESC ={"You can play several cards with the same numerical value in one turn.","Você pode jogar várias cartas do mesmo número de uma só vez.","Vous pouvez jouer plusieurs cartes avec la même valeur numérique en un tour.","Podrás jugar varias cartas que tengan el mismo valor número en un turno.","Вы можете положить несколько карт с одинаковым числами за один ход.","你可以在同一個回合裡發出多張同一個數字的卡牌。","Możesz wyłożyć kilka kart z tym samym numerem podczas jednej kolejki.","Egy kör alatt több, ugyanolyan számértékkel rendelkező kártyát játszhatsz.",""},
HOUSE_PEACE ={"Peace Card","Carta da Paz","Carte Paix","Carta de Paz","Мирная Карта","和平之卡","Karta Pokoju","Béke Kártya",""},
HOUSE_PEACE_DESC ={"When you play this card, action cards will have no effect on the next two turns.","Ao jogar esta carta, cartas de ação não terão efeito nos próximos dois turnos.","Lorsque vous jouez cette carte, les cartes action n'auront pas d'effet aux 2 prochains tours.","Cuando juegues esta carta, las cartas de acción no tendrán efecto en los siguientes dos turnos.","Когда вы положили эту карту, карты действий не будут работать следующие два хода.","當你發出這張卡牌之後, 行動卡都會在接下來的兩個回合中失效。","Kiedy zagrasz tą kartą, karty akcji nie będą miały żadnego działania przez kolejne dwie kolejki.","Ha kijátszod ezt a kártyát, az akciókártyák elvesztik a hatásukat két körig.",""},
HOUSE_DEATH ={"Sudden Death Card","Carta da Morte Súbita","Carte Mort Subite","Carta de Muerte Súbita","Карта Внезапной Смерти","暴斃卡牌","Karta Nagłej Śmierci","Hirtelen Halál Kártya",""},
HOUSE_DEATH_DESC ={"After playing this card, anyone who can't play a card will be eliminated.","Após jogar esta carta, quem não puder jogar cartas será eliminado.","Après avoir joué cette carte, tout ceux qui ne peuvent pas jouer une carte seront éliminés.","Después de jugar esta carta, cualquiera que no pueda jugar una carta será eliminado.","После этой карты любой, кто не может положить карту, будет удалён.","在發出這張卡牌之後, 玩家要是不能夠發出合適的卡牌會被直接淘汰。","Po zagraniu tej karty, ktokolwiek kto nie może zagrać kartą zostanie wyeliminowany.","Miután kijátszod ezt a kártyát, bárki aki nem tud mit kijátszani kiesik a játékból.",""},
HOUSE_CAROUSEL ={"Treadmill Card","Carta da Esteira","Carte Tapis roulant","Carta Cinta","Беговая Дорожка","跑步機卡牌","Biegająca Karta","Futópad Kártya",""},
HOUSE_CAROUSEL_DESC ={"When you play this card, everyone passes their cards to the next player.","Ao jogar esta carta, todos passam suas cartas para o próximo jogador.","Lorsque vous jouez cette carte, tout le monde passe ses cartes au joueur suivant.","Cuando juegues esta carta, todos pasarán sus cartas al siguiente jugador.","Когда вы положили эту карту, каждый передает свои карты следующему игроку.","當你發出這卡牌, 所有人會把自己的卡組讓給下一個玩家。","Kiedy zagrasz tą kartą, każdy przekaże swoje karty następnej osobie. ","Ha kijátszod ezt a kártyát, mindenki átadja a kártyáit a következő játékosnak.",""},
HOUSE_TRADE ={"Trade Card","Carta da Troca","Carte Échange","Carta de Intercambio","Торговая Карта","交換卡","Wymiana Kart","Csere Kártya",""},
HOUSE_TRADE_DESC ={"When you play this card, you exchange cards with a player of your choice.","Ao jogar esta carta, escolha um adversário para trocar de cartas com ele.","Lorsque vous jouez cette carte, vous échangez vos cartes avec un joueur de votre choix.","Cuando juegues esta carta, intercambiarás cartas con un jugador a tu elección.","Когда вы положили эту карту, вы обмениваетесь картами с игроком по вашему выбору.","當你發出這卡牌之後, 你可以選擇跟一位玩家來交換卡組。","Używając tej karty możesz dokonać wymiany kartą z innym graczem.","Ha kijátszod ezt a kártyát, kicseréled a kártyáidat egy általad választott játékossal.",""},
HOUSE_GIFT ={"Donate Card","Carta da Doação","Carte Don","Carta de Donación","Пожертвовать Карту","捐獻卡","Darowana Karta","Adományozó Kártya",""},
HOUSE_GIFT_DESC ={"When you play this card, give a random card from your hand to a player of your choice.","Ao jogar esta carta, escolha um adversário para doar uma carta aleatória para ele.","Lorsque vous jouez cette carte, donnez une carte au hasard de votre jeu à un joueur de votre choix.","Cuando juegues esta carta, de tu baraja le darás una carta a un jugador de tu elección.","Когда вы положили эту карту, отдайте случайную карту из вашей руки игроку по вашему выбору.","當你發出這卡牌之後, 隨機在你卡組中抽一張卡送給一位你選擇的玩家。","Kiedy zagrasz tą kartą, wybierz gracza, któremu dasz jedną losową kartę z twojej puli.","Ha kijátszod ezt a kártyát, egy általad választott játékosnak adsz egy véletlenszerű kártyát a kezedből.",""},
HOUSE_BOMB ={"Bomb Card","Carta Bomba","Carte Bombe","Carta Bomba","Карта-Бомба","炸彈卡","Bombowa Karta","Bomba Kártya",""},
HOUSE_BOMB_DESC ={"If you draw this card, you get eliminated.","Se comprar esta carta, você perde.","Si vous tirez cette carte, vous êtes éliminé.","Si juegas esta carta serás eliminado.","Если вы возьмёте эту карту, вы будете устранены.","如果你抽到這卡牌, 你就會被淘汰出局。","Jeśli weźmiesz tę kartę, przegrywasz.","Ha kihúzod ezt a kártyát, kiesel a játékból.",""},
HOUSE_RANDOM ={"Mysterious Card","Carta Misteriosa","Carte Mystérieuse","Carta Misteriosa","Таинственная Карта","神秘卡牌","Losowa Karta","Titokzatos Kártya",""},
HOUSE_RANDOM_DESC ={"This card activates a random effect when played.","Esta carta ativa um efeito aleatório quando jogada.","Cette carte active un effet aléatoire lorsqu'elle est jouée.","Esta carta activa un efecto aleatorio cuando es jugada.","Эта карта активирует случайный эффект при игре.","這張卡牌在發出之後會有隨機的效果。","Ta karta aktywuje losowy efekt kiedy nią zagrasz.","Ha kijátszod ezt a kártyát, egy véletlenszerű hatást aktivál.",""},
HOUSE_VIEW ={"Clairvoyance Card","Carta da Clarividência","Carte Clairvoyance","Carta de Clarividencia","Карта Ясновидения","洞察卡牌","Karta Jasnowidza","Tisztánlátó Kártya",""},
HOUSE_VIEW_DESC ={"When you play this card, every other player will reveal a random card of their hand.","Ao jogar esta carta, todos mostram uma de suas cartas.","Lorsque vous jouez cette carte, tous les autres joueurs révèlent une carte aléatoire de leur jeu.","Cuando juegues esta carta, cada jugador revelará una carta aleatoria de su baraja.","Когда вы положили эту карту, каждый игрок показывает случайную карту своей руки.","當你發出這卡牌, 所有其他玩家都會展示出他們卡組中的一張牌。","Kiedy zagrasz tą kartą, inni gracze pokażą jedną kartę ze swojej puli","Ha kijátszod ezt a kártyát, minden más játékos megmutat egy véletlenszerű kártyát a kezében.",""},
HOUSE_RAIN ={"Rain Card","Carta da Chuva","Carte Pluie","Carta de Lluvia","Дождевая Карта","雨神卡牌","Deszcz Kart","Eső Kártya",""},
HOUSE_RAIN_DESC ={"When you play this card, every other player draws 1 card.","Ao jogar esta carta, seus adversários compram 1 carta.","Lorsque vous jouez cette carte, tous les autres joueurs tirent 1 carte.","Cuando juegues esta carta, cada jugador sorteará una carta.","Когда вы положили эту карту, каждый игрок берёт одну карту.","當你發出這卡牌, 所有其他玩家罰抽一張卡。","Kiedy użyjesz tej karty gracze dobierają po 1 karcie.","Ha kijátszod ezt a kártyát, minden más játékos húz egy kártyát.",""},
HOUSE_EQUALITY ={"Equality Card","Carta da Igualdade","Carte Égalité","Carta de Igualdad","Карта Равенства","公平卡牌","Karta Równości","Egyenlőség Kártya",""},
HOUSE_EQUALITY_DESC ={"When you play this card, every player either draws or discards cards until everyone has 3 cards.","Ao jogar esta carta, todos compram ou descartam até terem 3 cartas.","Lorsque vous jouez cette carte, tous les joueurs chaque joueur tire ou défausse des cartes jusqu'à ce que tout le monde ait 3 cartes.","Cuando juegues esta carta, cada jugador sorteará o descartará hasta que todos tengan tres cartas.","Когда вы положили эту карту, каждый игрок либо тянет, либо сбрасывает карты, пока у всех не будет 3 карты.","當你發出這卡牌, 所有人會抽取或棄置卡牌直到卡組只剩下 3 張卡牌。","Jeśli zagrasz tą kartą każdy gracz dobiera lub schodzi do 3 kart.","Ha kijátszod ezt a kártyát, minden játékos addig húz vagy dob el kártyákat, míg 3 kártyája nem lesz.",""},
HOUSE_CHAIRS ={"Dancing Chairs Card","Carta da Dança","Cartes Chaises Musicales","Carta de Sillas Danzantes","Карта 'Танцующие стулья'","舞動椅子卡牌","Karta Tańczące Fotele","Táncoló Székek Kártya",""},
HOUSE_CHAIRS_DESC ={"When you play this card, all the other players' chairs randomly change positions.","Ao jogar esta carta, seus adversário trocam de posições aleatoriamente.","Lorsque vous jouez cette carte, les chaises des autres joueurs changent de position.","Cuando juegues esta carta, todas las sillas de los jugadores cambiarán de lugares aleatoriamente.","Когда вы положили эту карту, все стулья других игроков случайным образом меняют позиции.","當你發出這卡牌, 所有其他玩家的位置都會隨機改變。","Kiedy zagrasz tą kartą, inni gracze zmienią swoje krzesła.","Ha kijátszod ezt a kártyát, minden más játékos széke véletlenszerűen helyet cserél.",""},
HOUSE_IMITATE ={"Emote Card","Carta da Emoção","Carte Émote","Carta de Emote","Карта Эмоций","表情卡","Karta Emotka","Érzelem Kártya",""},
HOUSE_IMITATE_DESC ={"When you play this card, everyone must perform the emote being shown. The last player to do so, draws 2 cards.","Ao jogar esta carta, todos devem imitar uma emoção mostrada. Quem imitar por último compra 2 cartas.","Lorsque vous jouez cette carte, tout le monde doit jouer l'émote montré. Le dernier joueur à le faire, tire 2 cartes.","Cuando juegues esta carta, todos deberán realizar el emote que se mostrará. El último jugador en hacerlo recibirá dos cartas.","Когда вы положили эту карту, каждый должен выполнить показанную эмоцию. Последний игрок, который сделает это, берёт 2 карты.","當你發出這卡牌之後, 所有人必須跟著做出顯示著的表情。 最後兩個做出正確表情的玩家會被罰抽 2 張卡牌。","Kiedy zagrasz tą kartą, inni każdy musi zachowywać się tak, jak emotka pokazała. Kto zrobi to ostatni, dostaje dwie dodatkowe karty.","Ha kijátszod ezt a kártyát, mindenkinek ki kell fejeznie a megjelenített érzelmet. Az utolsó játékos húz 2 kártyát.",""},
HOUSE_MEEP ={"Meep! Card","Carta do Meep!","Carte Meep!","Carta de ¡Meep!","Карта 'Meep!'","Meep! 卡牌","Karta Meep","Meep! Kártya",""},
HOUSE_MEEP_DESC ={"When you play this card, you gain the Meep power!","Ao jogar esta carta, você ganha o poder do Meep!","Lorsque vous jouez cette carte, vous gagnez le pouvoir de Meep!","¡Cuando juegues esta carta, obtendrás el poder del Meep!","Когда вы разыгрываете эту карту, вы получаете силу Meep!","當你發出這卡牌之後, 你會得到 Meep 的能力!","Kiedy użyjesz tej karty możesz władać meepem!","Ha kijátszod ezt a kártyát, megkapod a Meep erőt.",""},
HOUSE_NO_ACTION ={"No Action","Sem Ação","Pas d'Action","No Acción","Бездействие","沒有動力","Bez Akcji","Nincs Akció",""},
HOUSE_NO_ACTION_DESC ={"The deck consists only of numerical and wild cards.","O baralho é formado apenas por números e curingas.","La pioche consiste uniquement en cartes numériques et noires.","El mazo consistirá solamente de cartas númericas y cartas comodín.","Колода состоит только из цифровых и чёрных карт.","整個卡庫只有數字跟換顏色卡牌。","W tej rozgrywce udział biorą tylko karty z numerami i karty wild.","A pakli csak szám- és Színválasztó kártyákat tartalmaz.",""},
HOUSE_CAMOUFLAGE ={"Camouflage","Camuflagem","","Camuflage","Маскировка","偽裝","Kamuflaż","Álca",""},
HOUSE_CAMOUFLAGE_DESC ={"You can't see anyone's number of cards until they have only 1 card left.","Você não enxerga quantas cartas seus adversários tem até que fiquem com 1 carta.","Vous ne pouvez pas voir le nombre de cartes des autres joueurs jusqu'à ce qu'ils en aient qu'une.","No podrás ver el número de cartas de nadie hasta que solamente tenga una carta.","Вы не можете видеть чьё-либо количество карт, пока у них не останется только 1 карта.","你不會看到其他人卡組裡有多少卡牌直到他們剩下最後 1 張卡。","Nie możesz zobaczyć ile kart ma twój przeciwnik dopóki nie zostanie z jedną kartą.","Nem látod mások kártyáinak számát, amíg csak egy kártyájuk nem lesz.",""},
HOUSE_ADD_RULE ={"Rule Card","Carta da Regra","Carte Règle","Carta de Regla","Карта Правил","規矩卡牌","Karta Zasad","Házszabály Kártya",""},
HOUSE_ADD_RULE_DESC ={"When you play this card, add a new rule to the current round.","Ao jogar esta carta, adicione uma nova regra à partida atual.","Lorsque vous jouez cette carte, une nouvelle règle est rajoutée au tour actuel.","Cuando juegues esta carta, añadirá una nueva regla a la ronda actual.","Когда вы положили эту карту, добавьте новое правило в текущий раунд.","當你發出這卡牌之後, 將會馬上新增一道自訂規矩。","Kiedy zagrasz tą kartą wprowadzasz nową zasadę do aktualnej rundy.","Ha kijátszod ezt a kártyát, válassz egy új szabályt ehhez a játékhoz.",""},
HOUSE_TIME ={"Reduced Time","Tempo Reduzido","Temps Réduit","Tiempo Reducido","Сокращенное Время","時間緊湊","Redukcja Czasu","Csökkentett Idő",""},
HOUSE_TIME_DESC ={"After 6 minutes, the player whose hand is worth the least points wins.","Após 6 minutos, vence quem tiver menos pontos na mão.","Après 6 minutes, le joueur dont le jeu vaut le moins de points gagne.","Después de seis minutos, el jugador cuya baraja valga menos puntos gana.","Через 6 минут выигрывает игрок, в чьей руке меньше всего карт.","6 分鐘過後, 手中卡組分數總和最少的玩家會勝出遊戲。","Po upływie 6 minut zwycięzca otrzyma mniej punktów.","6 perc után az a játékos nyer, akinek a kezében lévő kártyák értéke a legkevesebb.",""},
HOUSE_CHESS ={"Mad Chess","Xadrez Maluco","Chéquiers fous","Tablero Loco","Безумные Шахматы","瘋狂象棋","Szalone Szachy","Őrült Sakk",""},
HOUSE_CHESS_DESC ={"If you play a chess piece over another piece, activate the previous piece's effect. <b><a href='event:chess'>Click here</a></b> to see the various effects.","Se você jogar uma peça de xadrez em cima de outra peça, ative o efeito da peça anterior. <b><a href='event:chess'>Clique aqui</a></b> para ver os efeitos.","Si vous jouez une pièce d'échecs sur une autre pièce, ça active l'effet de la pièce précédente. <b><a href='event:chess'>Cliquez ici</a></b> pour voir les différents effets.","Si juegas una pieza sobre otra pieza, activará el efecto anterior de la pieza. <b><a href='event:chess'>Cliquea aquí</a></b> para ver los diferentes efectos.","Если вы играете шахматными фигурами, активируйте эффект предыдущей. <b><a href='event:chess'>Нажмите здесь</a></b> чтобы увидеть различные эффекты.","如果你在有象棋圖案的卡牌上再發一張, 就會激活前一張卡牌象棋上的效果。 <b><a href='event:chess'>點這裡</a></b> 查看不同的象棋效果。","Jesli zagrasz fragmentem szach nad innym takim fragmentem, aktywujesz efekt poprzedniego fragmentu. <b><a href='event:chess'>Kliknij tutaj</a></b> by zobaczyć różne efekty.","Ha egy sakkbábút játszol egy másik sakkbábúra, aktiváld az előző képességét. <b><a href='event:chess'>Kattints ide</a></b> hogy lásd a különböző hatásokat.",""},
HOUSE_STEAL ={"Recycling Card","Carta da Reciclagem","Carte Recyclage","Carta de Reciclaje","Карта Переработки","回收卡牌","Karta Recyklingu","Újrahasznosító Kártya",""},
HOUSE_STEAL_DESC ={"When you play this card, every other player discards 1 action card, provided they own one, then draws 1 card.","Ao jogar esta carta, todos os outros descartam uma carta de ação aleatória e compram 1 carta para repor.","Lorsque vous jouez cette carte, tous les autres joueurs se défaussent d'une carte action, à condition qu'ils en possèdent une, puis tirent une carte.","Cuando jugues esta carta, cada jugador descartará una carta de acción y sorteara una carta provicionada de las que tenían.","Когда вы положили эту карту, каждый игрок сбрасывает 1 карту действия, если у него она есть, а затем берет 1 карту.","當你發出這卡牌, 所有其他的玩家如果手上擁有功能卡牌都會被逼丟棄 1 張, 然後再抽回 1 張卡。","Kiedy zagrasz tą kartą, każdy inny gracz odrzuca 1 kartę akcji i dobiera kartę pod warunkiem, że są własne.","Ha kijátszod ezt a kártyát, minden játékos eldob 1 akciókártyát, ha van neki, majd húz 1 kártyát.",""},
HOUSE_HARD ={"Hard Mode","Modo Rigoroso","Mode Difficile","Modo Difícil","Сложный Режим","困難模式","Tryb Trudny","Nehéz Mód",""},
HOUSE_HARD_DESC ={"If you click on an invalid card, you draw 1 card and lose your turn. You draw 4 cards when challenged for not saying UNO.","Clicar em carta errada faz passar a vez. Não falar UNO faz comprar 4 cartas.","Si vous cliquez sur une carte invalide, vous tirez une carte et passez votre tour. Vous tirez 4 cartes si vous avez été défié pour ne pas avoir dit UNO.","Si das clic en una carta inválidad perderás tu turno. Si eres desafiado por no haber dicho UNO, recibirás cuatro cartas.","Если вы нажмете на недействительную карту, вы берёте 1 карту и теряете свой ход. Вы берете 4 карты, когда за вас нажимают УНО.","如果你點錯了一張不適合發出的卡牌, 你會被罰抽 1 張卡然後失去你的回合。而當你忘記了說 UNO 的時候又剛好被別人質疑, 你會被罰抽 4 張卡。","Jeśli klikniesz niewłaściwą kartę przeczekaj swoją kolejkę. Jeśli zostałeś wyzwany bo nie powiedziałeś UNO dobierasz 4 karty.","Ha a kezedben nem megfelelő kártyára kattintasz, húznod kell 1 kártyát és kimaradsz a körből. 4 kártyát húzol ha kihívnak, mert nem mondtál UNO-t.",""},
HOUSE_FAST_DRAW ={"Fast Drawing","Compra Rápida","Tirage Rapide","Sorteo Rápido","Быстрая Взятка","快速抽取","Szybkie Dobieranie","Gyors Húzás",""},
HOUSE_FAST_DRAW_DESC ={"Drawn cards are played immediately (unless they are drawn due to a penalty).","Cartas compradas são jogadas imediatamente (exceto por penalidades).","Les cartes tirées sont jouées automatiquement (à moins qu'elles ne soient tirés en raison d'une pénalité).","Las cartas sorteadas son jugadas inmediatamente (a menos de que sean sorteadas por penalización).","Вытащенные карты ставятся сразу (если они не вытянуты из-за штрафа).","你抽出的卡牌會馬上被發出 (除非那是罰抽的卡牌) 。","Dobrane karty są grane natychmniast (chyba, że są pobrane z powodu kary).","A felhúzott kártyák azonnal kijátszásra kerülnek (kivéve ha más kártya által, vagy büntetésből lettek húzva).",""},
HOUSE_THUNDER ={"Thunder Card","Carta do Trovão","Carte Tonnerre","Carta Relámpago","Громовая Карта","雷電暴擊卡牌","Karta Grzmotu","Mennydörgés Kártya",""},
HOUSE_THUNDER_DESC ={"When you play this card, two random players draw 1-5 cards.","Ao jogar esta carta, dois jogadores aleatórios compram de 1 a 5 cartas.","Lorsque vous jouez cette carte, 2 joueurs aléatoires tirent de 1 à 5 cartes.","Cuando juegues esta carta, dos jugadores aleatorios sortearán de una a cinco cartas.","Когда вы положили эту карту, два случайных игрока берут 1-5 карт.","當你發出這卡, 隨機兩個玩家會被罰抽 1-5 張卡牌。","Kiedy zagrasz tą kartą, dwoje losowych graczy dobierze 1-5 kart.","Ha kijátszod ezt a kártyát, két véletlenszerű játékos felhúz 1-5 kártyát.",""},
HOUSE_CLONE ={"Cloning Card","Carta da Clonagem","Carte Clone","Carta de Clonación","Карта-Клон","複製卡牌","Karta Klonowania","Másoló Kártya",""},
HOUSE_CLONE_DESC ={"This card activates the same effect as the previous card.","Esta carta ativa o mesmo efeito da carta anterior.","Cette carte active les mêmes effets que la carte précédente.","Esta carta activa el mismo efecto de la carta anteriormente usada.","Эта карта активирует тот же эффект, что и предыдущая карта.","這張卡發出了之後會跟上一張卡有著一樣的效果。","Ta karta uaktywnia ten sam efekt co poprzednio zagrana karta.","Ha kijátszod ezt a kártyát, az előző kártya hatásait aktiválja.",""},
HOUSE_WEB ={"Web Card","Carta da Teia","Carte Toile d'Araignée","Carta Telaraña","Паучья Карта","蜘蛛網卡牌","Karta Sieci","Háló Kártya",""},
HOUSE_WEB_DESC ={"When you play this card, chose a player who will miss their next turn.","Ao jogar esta carta, escolha um jogador para ficar 1 turno sem jogar.","Lorsque vous jouez cette carte, choisissez un joueur qui loupera son tour.","Cuando juegues esta carta, podrás elegir un jugador para que pierda su siguiente turno.","Когда вы положили эту карту, выбирайте игрока, который пропустит свой следующий ход.","當你發出這卡牌, 選擇一個玩家使他失去下一回合。","Jeśli zagrasz tą kartą, wybierz gracza, który straci następną kolejkę.","Ha kijátszod ezt a kártyát, válassz egy játékost, aki kimarad a körből.",""},
HOUSE_SHINY ={"Shiny Hand","Mão Brilhante","Main Brillante","Baraja Reluciente","Блестящая Рука","閃爍小手","Błyszcząca Dłoń","Fényes Kártyák",""},
HOUSE_SHINY_DESC ={"Players holding a wild card or at least one card of each color will have their hand highlighted.","Quem tiver um curinga ou as 4 cores na mão ficará com o número de cartas com cor branca.","Les joueurs ayant une carte noire ou au moins une carte de chaque couleur auront leur jeu en surbrillance.","Jugadores teniendo a la mano una carta comodín o al menos una carta de cada color tendrán su baraja brillando.","Игроки, имеющие чёрные карты или хотя бы одну карту каждого цвета, будут подсвечены.","手上持有換色卡牌或每個顏色的卡牌都有至少一張的時候, 手中的卡牌會發白光標示。","Gracze posiadający Kartę Wild lub przynajmniej jedną kartę z każdego koloru, będą mieli podświetloną rękę.","Azok kártyái, akik vagy Színváltó kártyát, vagy a négy színből legalább egy-egy kártyát tartanak a kezükben, kiemelődnek fehérrel.",""},
HOUSE_SEQUENCE ={"Sequence","Sequência","Séquence","Secuencia","Последовательность","排列","Sekwencja","Sorozat",""},
HOUSE_SEQUENCE_DESC ={"You can play several cards of the same color, as long as they form a numerical sequence.","Você pode jogar várias cartas da mesma cor, desde que formem uma sequência numérica.","Vous pouvez jouer plusieurs cartes de la même couleur, à condition qu'elles forment une séquence numérique.","Podrás jugar varias cartas del mismo color, siempre y cuando formen una secuencia numérica.","Вы можете положить несколько карт одного цвета, если они образуют числовую последовательность.","你可以連續發出幾張一樣顏色的卡牌, 只要它們能夠組成數字順序。","Możesz zagrać kilka kart o tym samym kolorze, pod warunkiem, że tworzą sekwencję liczbową.","Egy körben több azonos színű kártyát játszhatsz, ha számtani sorozatot alkotnak.",""},
HOUSE_LUCK ={"Luck Card","Carta da Sorte","Carte Chance","Carta de la Suerte","Карта Удачи","幸運卡牌","Karta Szczęścia","Szerencse Kártya",""},
HOUSE_LUCK_DESC ={"When you play this card, you can choose the next card that you draw (unless it's due to a penalty).","Ao jogar esta carta, escolha a próxima carta que você comprar (a menos que seja por penalidade).","Lorsque vous jouez cette carte, vous pouvez choisir la prochaine carte que vous tirerez (à moins qu'elles ne soient tirés en raison d'une pénalité).","Cuando juegues esta carta, podrás elegir la siguiente carta que sortees (a menos de que sea por penalización).","Когда вы положили эту карту, в следующем ходу можете выбрать карту, которую хотите (если это не из-за штрафа).","當你發出這卡牌的時候, 你可以選擇下一張你要抽取的卡牌 (除非是被罰抽卡牌)。","Grając tą kartą możesz wybrać następną kartę, którą dobierzesz (chyba, że jest to kara)","Ha kijátszod ezt a kártyát, kiválaszthatod mi legyen a következő húzásod (kivéve ha más kártya által, vagy büntetésből lett húzva).",""},
HOUSE_BOX ={"Gift Card","Carta do Presente","Carte Cadeau","Carta de Regalo","Подарочная Карта","禮物卡","Karta Prezent","Ajándék Kártya",""},
HOUSE_BOX_DESC ={"When you play this card, everyone gains a Mysterious Card, which activates a random effect.","Ao jogar esta carta, todos ganham uma Carta Misteriosa, que ativa um efeito aleatório.","Lorsque vous jouez cette carte, tout le monde gagne une Carte Mystérieuse, qui active un effet aléatoire.","Cuando juegues esta carta, todos obtendrán una Carta Misteriosa.","Когда вы положили эту карту, каждый получает Таинственную Карту, которая активирует случайный эффект.","當你發出這卡, 所有人會得到一張神秘卡牌, 它會有隨機效果。","Kiedy zagrasz tą kartą, każdy otrzymuje Losową Kartę, która aktywuje losowy efekt.","Ha kijátszod ezt a kártyát, minden játékos kap egy Titokzatos Kártyát, amely véletlenszerű hatást aktivál.",""},
HOUSE_WISH ={"Wish Card","Carta do Desejo","Carte de Vœux","Carta de Deseo","Карта Желаний","許願卡","Karta Życzenie","Kívánság Kártya",""},
HOUSE_WISH_DESC ={"When you play this card, you exchange a random card from your hand with one from the discard pile.","Ao jogar esta carta, troque uma carta aleatória da sua mão por uma da pilha de descartes.","Lorsque vous jouez cette carte, vous échangez une carte aléatoire de votre jeu avec une carte de la défausse.","Cuando juegues esta carta, intercambiarás una carta aleatoria de tu baraja por otra de la pila de descarte.","Когда вы положили эту карту, вы меняете случайную карту из вашей руки на одну из колоды сброса.","當你發出這卡牌, 你可以在手中選一張卡跟已出牌的卡交換。","Kiedy zagrasz tą kartą, wymieniasz losową kartę na jedną ze stosu kart odrzuconych.","Ha kijátszod ezt a kártyát, kicserélhetsz egy véletlenszerű kártyát a kezedben egyre a kijátszott kártyák közül",""},
HOUSE_TEAM ={"Team Match","Jogo em Duplas","Parties en Équipe","En Equipos","Командный Матч","團隊模式","Runda Drużynowa","Csapatmérkőzés",""},
HOUSE_TEAM_DESC ={"Each player has a partner. If one of them wins, both players win.","Cada jogador tem uma dupla. Se um vencer, a equipe toda vence.","Chaque joueur a un coéquipier. Si un des deux gagne, les deux remportent la partie.","Cada jugador tiene un compañero. Si uno de ellos gana, ambos ganan.","У каждого игрока есть партнёр. Если один из них выигрывает, выигрывают оба игрока.","每一個玩家都有搭檔。 如果其中一人勝了, 兩人都會獲勝。","Każdy gracz ma partnera. Jeśli jeden z nich wygra, oboje wygrywają.","Minden játékos rendelkezik egy csapattárssal. Ha bármelyikük nyer, mindketten nyernek.",""},
HOUSE_PORTAL ={"Portal Card","Carta do Portal","Carte Portail","Carta Portal","Карта-Портал","傳送門","Karta Portal","Portál Kártya",""},
HOUSE_PORTAL_DESC ={"Two matches are taking place at the same time. Play this card to switch between them.","Duas partidas estão acontecendo ao mesmo tempo. Jogue esta carta para alternar entre elas.","","Dos rondas están tomando lugar a la vez. Juega esta carta para cambiar entre ellas.","Два матча проходят одновременно. Положите эту карту, чтобы переключаться между ними.","兩場遊戲同時在進行。發出這卡來進行兩組卡組的替換。","Dwie rozgrywki odbywają się w tym samym czasie. Zagraj tą kartą, aby przełączyć się między nimi.","Két játék vesz részt párhuzamosan. Ha kijátszod ezt a kártyát, válthatsz köztük.",""},
HOUSE_INK ={"Ink Card","Carta da Tinta","Carte Encre","Carta de Tinta","Чернильная Карта","墨水卡牌","Karta Atrament","Tinta Kártya",""},
HOUSE_INK_DESC ={"When you play this card, every colored card on the next player's hand turns the color of your ink card.","Ao jogar esta carta, pinte todas as cartas do próximo jogador com a cor desta carta.","Lorsque vous jouez cette carte, chaque carte de couleur dans le jeu du joueur suivant va prendre la couleur de votre Carte Encre.","Cuando juegues esta carta, usarás su color para colorear la siguiente carta de todos los jugadores.","Когда вы положили эту карту, каждая цветная карта следующего игрока закрашивается в определённый цвет.","當你發出這卡, 下一個玩家手上所有有顏色的卡牌都會變成你發出的墨水卡牌的顏色。","Kiedy zagrasz tą kartą, użyjesz jej koloru, aby pokolorować wszystkie karty następnego gracza.","WHa kijátszod ezt a kártyát, a következő játékos minden kártyájának színe a Tinta Kártyád színévé változik.",""},
HOUSE_CONFUSE ={"Confusion Card","Carta da Confusão","Carte Confusion","Carta de Confusión","Карта-Путаница","迷惑卡牌","Karta Zguba","Zavarodottság Kártya",""},
HOUSE_CONFUSE_DESC ={"When you play this card, you will play a random card on your next turn.","Ao jogar esta carta, você jogará de forma aleatória no próximo turno.","Lorsque vous jouez cette carte, vous jouerez une carte aléatoire au tour suivant.","Cuando juegues esta carta, jugarás una carta aleatoria en tu siguiente turno.","Когда вы положили эту карту, за вас положат случайную карту на следующем ходу.","當你發出這卡牌, 你會在下一個回合隨機發出一張卡。","Kiedy zagrasz tą kartą, użyjesz losowej karty w twojej następnej kolejce.","Ha kijátszod ezt a kártyát, a következő körben véletlenszerű kártyát fogsz kijátszani.",""},
HOUSE_TREASURE ={"Search Card","Carta da Busca","Carte Recherche","Carta de Búsqueda","Карта Поиска","搜尋卡牌","Karta Wyszukiwania","Kincskereső Kártya",""},
HOUSE_TREASURE_DESC ={"When you play this card 3 times, you receive the Treasure Card. When you play that one, you automatically win the game.","Ao jogar esta carta 3 vezes, receba a Carta do Tesouro, que faz você vencer o jogo.","Lorsque vous jouez cette carte, vous recevez la Carte au Trésor. Lorsque vous jouez celle-ci, vous gagnez automatiquement la partie.","Cuando juegues tres veces esta carta, recibirás la Carta del Tesoro, y ganarás el juego.","Когда вы положили эту карту 3 раза, вы получаете карту сокровищ. Когда вы положите её, вы автоматически выигрываете игру.","當你發出這卡 3 次, 你會得到寶藏卡牌。 當你發出寶藏卡牌, 你就會自動勝出遊戲。","Kiedy zagrasz tą kartą 3 razy, zyskasz Kartę Skarbu, którą zapewnisz sobie zwycięstwo.","Ha kijátszod ezt a kártyát háromszor, megkapod a Kincskártyát, amelyet kijátszva azonnal megnyered a játékot.",""},
HOUSE_NEIGHBOR ={"Neighbor","Vizinho","Voisin","Vecino","Сосед","鄰居","Sąsiad ","Szomszéd",""},
HOUSE_NEIGHBOR_DESC ={"Cards of equal numerical value no longer match. They only match cards of a value either higher or lower by 1.","Números iguais não combinam mais. Números só combinam com um número acima ou abaixo.","Les cartes de même valeur numérique ne correspondent plus. Elles ne correspondent qu'aux cartes d'une valeur supérieure ou inférieure de 1.","Cartas de valor número igual no podrán ser jugadas. Solo podrán ser jugadas cartas con un valor mayor o menor por uno.","Карты с одинаковым числовым значением больше не совпадают. Они соответствуют только картам, стоимость которых выше или ниже на 1.","卡牌上的數字不再相符合。 它們只對應原本的數字加及減 1 後的數值。","Karty o równej wartości już nie pasują. Pasują tylko karty o wartości większej lub mniejszej o 1.","Az azonos számértékű kártyák nem játszhatóak egymásra. Csak olyan számértéket lehet rájuk játszani, amely kisebb vagy nagyobb 1-el.",""},
HOUSE_MESS ={"Mess","Bagunça","Bazar","Tablero","Беспорядок","大混亂","Bałagan","Zűrzavar",""},
HOUSE_MESS_DESC ={"The deck consists only of action cards.","O baralho é formado apenas por cartas de ação.","Le jeu se compose uniquement de cartes action.","La baraja consiste solamente de cartas de acción.","Колода состоит только из карт действий.","整個牌庫只有行動卡牌。","Talia składa się tylko z kart akcji.","A pakli csak akciókártyákat tartalmaz.",""},
HOUSE_BATATA ={"Potato Card","Carta da Batata","Carte Patate","Carta de Papa","Картофельная Карта","馬鈴薯卡牌","Karta Ziemniak","Burgonya Kártya",""},
HOUSE_BATATA_DESC ={"When you play this card, put it in a player's hand. Whoever keeps this card in hand for 5 turns will be eliminated.","Ao jogar esta carta, coloque-a na mão de um jogador. Quem ficar com esta carta na mão por 5 turnos perde.","Lorsque vous jouez cette carte, vous échangez une carte aléatoire de votre jeu avec une de la défausse.","Cuando juegues esta carta, le darás a la baraja de un jugador aleatorio una Carta de Papa. Si te quedas con la carta en tu baraja por cinco turnos, serás eliminado.","Когда вы положили эту карту, кладите её в руку игрока. Тот, кто держит эту карту в руке в течение 5 ходов, будет уничтожен.","當你發出這卡, 把它放到一個玩家手中的牌裡。 只要有人把馬鈴薯卡留在手裡超過 5 輪就會被淘汰。","Kiedy zagrasz ta kartą, dajesz Kartę Ziemniaka graczowi. Jeśli będziesz trzymał Kartę Ziemniaka przez 5 rund, zostaniesz wyeliminowany. ","Ha kijátszod ezt a kártyát, válassz egy játékost akinek a kezébe kerül. Akinek ez a kártya 5 körig a kezében marad, az kiesik a játékból.",""},
HOUSE_CURSE ={"Curse Card","Carta da Maldição","Carte Malédiction","Carta de Maldición","Проклятие Карты","詛咒卡","Karta Przekleństwa","Átok Kártya",""},
HOUSE_CURSE_DESC ={"When you play this card, inflict a random curse to everyone for a few turns.","Ao jogar esta carta, aplique uma maldição aleatória que dura alguns turnos.","Lorsque vous jouez cette carte, une malédiction aléatoire est infligée à tout le monde pendant quelques tours.","Cuando juegues esta carta, aplicará una maldición que afectará unos cuantos turnos.","Когда вы положили эту карту, наложите на всех случайное проклятие на несколько ходов.","當你發出這卡, 將會在所有人身上施以隨機一個持續幾個回合的詛咒。","Kiedy zagrasz tą kartą, zastosuj wybraną klątwę, która będzie trwać przez kilka kolejek.","Ha kijátszod ezt a kártyát, néhány körre mindenkit átok sújt.",""},
HOUSE_LIMBO ={"Limbo","","Limbes","","Лимбо","林波舞","Otchłań","Limbó",""},
HOUSE_LIMBO_DESC ={"Whoever exceeds the limit of cards in hand will be eliminated. The limit starts at 12 cards and reduces by 1 every minute.","Quem ultrapassar o limite de cartas na mão será eliminado. O limite começa em 12 e reduz em 1 a cada minuto.","Quiconque dépasse la limite des cartes en main sera éliminé. La limite commence à 12 cartes et diminue de 1 toutes les minutes.","Cualquiera que exceda el límite de cartas en baraja será eliminado. El límite empieza con doce cartas y se le va restando una por cada minuto que pasa.","Тот, кто превысит лимит карт в руке, будет удалён. Лимит начинается с 12 карт и уменьшается на 1 каждую минуту.","只要有人手中持有的卡牌數量超過上限就會被淘汰。 上限起初是 12 張卡然後每一分鐘將會減少 1 張。","Ktokowiek przekroczy limit kart w ręce zostanie wyeliminowany.  Limit zaczyna się od 12 kart i zmniejsza się o 1 co minutę.","Aki túllépi a kézben tartható kártyák határát, az kiesik a játékból. A határ 12 kártyával indul, és percenként csökken 1-el.",""},
HOUSE_MAGNET ={"Magnet Card","Carta do Imã","Carte Magnétique","Carta Magnética","Карта-Магнит","磁力卡牌","Magnetyczna Karta","Mágnes Kártya",""},
HOUSE_MAGNET_DESC ={"When you play this card, discard every card that has your magnet card's color.","Ao jogar esta carta, descarte todas as cartas da mesma cor que esta.","Lorsque vous jouez cette carte, vous déffaussez toutes les cartes qui ont la couleur de votre carte magnétique.","Cuando juegues esta carta, descartará todas las cartas con el mismo color de ésta.","Когда вы положили эту карту, она сбросит карты, которые такого же цвета, как и она.","當你發出這卡, 將會丟棄你手中跟磁力卡牌一樣顏色的卡牌。","Kiedy zagrasz tą kartą pozbędziesz się wszystkich kart o tym samym kolorze co ta karta.","Ha kijátszod ezt a kártyát, dobj el minden kártyát a kezedből amely a mágnes színével megegyező színű.",""},
HOUSE_PLUS99 ={"Wild +99","Curinga +99","Carte +99","Comodín +99","Чёрная +99","換色 +99","","Színváltó +99",""},
HOUSE_PLUS99_DESC ={"When you play this card, the next player will be eliminated by drawing too many cards. This card can be challenged.","Ao jogar esta carta, o próximo jogador morre de tanto comprar cartas. Esta carta pode ser desafiada.","Lorsque vous jouez cette carte, le prochain joueur sera éliminé pour avoir pioché beaucoup trop de cartes. Cette carte peut être défiée.","Cuando juegues esta carta, el siguiente jugador morirá de sortear tantas cartas. Ésta puede ser desafiada.","Когда вы положили эту карту, следующий игрок будет удалён из-за вытягивания слишком большого количества карт. Эта карта может быть выиграна. ","當你發出這卡, 下一個玩家會因為罰抽太多卡而被淘汰。 這張卡也是可以被質疑的。","Kiedy zagrasz tą kartą, następny gracz zginie przez dobranie ogromniej ilości kart. Ta karta może zostać wyzwana.","Ha kijátszod ezt a kártyát, a következő játékos kiesik a játékból,  mert túl sok kártyát húzott. Ezt a kártyát ki lehet hívni.",""},
HOUSE_TORNADO ={"Tornado Card","Carta do Tornado","Carte Tornade","Carta de Tornado","Карта-Торнадо","龍捲風卡牌","Karta Tornado","Forgószél Kártya",""},
HOUSE_TORNADO_DESC ={"When you play this card, you shuffle the other players' cards.","Ao jogar esta carta, embaralhe as cartas dos outros jogadores.","Lorsque vous jouez cette carte, vous échanger vos cartes avec celles des autres joueurs.","Cuando juegues esta carta, barajeará las cartas de los demás jugadores.","Когда вы положили эту карту, вы перетасовываете карты других игроков.","當你發出這卡牌, 你會搗亂別人的卡組。","Kiedy zagrasz tą kartą, tasuje karty innych graczy.","Ha kijátszod ezt a kártyát, a többi játékos kártyái megkeverődnek.",""},
HOUSE_THEFT ={"Robbery Card","Carta do Roubo","Carte Vol","Carta de Robo","Карта-Ограбление","怪盜卡牌","Karta Rabunku","Rablás Kártya",""},
HOUSE_THEFT_DESC ={"When you play this card, you force a player to give you a wild card, provided they have one.","Ao jogar esta carta, force um jogador a dar uma carta curinga para você (se ele tiver uma).","Lorsque vous jouez cette carte, vous forcez un joueur à vous donner une carte noire, à condition que ce joueur en ait.","Cuando juegues esta carta, forzarás a un jugador a darte una carta comodín (si es que tiene una).","Когда вы положили эту карту, вы заставляете игрока дать вам чёрную карту, если она у него есть.","當你發出這卡牌, 你強迫一個玩家給你一張換色卡牌, 前提是他要擁有一張。","Kiedy zagrasz tą kartą, zmuś gracza, aby dał ci kartę wild (jeśli ją posiada).","Ha kijátszod ezt a kártyát, egy általad kiválasztott játékosnak oda kell adnia neked egy Színválasztó kártyát, ha van a kezében.",""},
HOUSE_SIMON ={"Simon's Card","Carta da Memorização","","Carta de Simón","Карта Симона","西蒙卡組","Karta Simona","Simon Kártyája",""},
HOUSE_SIMON_DESC ={"When you play this card, repeat, in order, the colors of previous Simon's Cards. Fail & draw 1 card. Succeed & choose the next color.","Ao jogar esta carta, repita as cores escolhidas por outras cartas desta. Se errar, compre 1 carta. Se acertar, escolha a próxima cor.","","Cuando juegues estta carta, repetirá todos los colores elegidos antes por otras cartas de Simón. Si pierdes, sorteas una carta, sino, eliges el siguiente color.","Когда вы положили эту карту, повторяйте по порядку цвета предыдущих карт Симона. Сбой - возьмите 1 карту. Преуспейте и выберите следующий цвет.","當你發出這卡時, 需要重複之前發出的西蒙卡牌的顏色順序。 重複順序錯誤就罰抽 1 張卡。 成功就可以選擇下一個顏色加到順序中。","Kiedy zagrasz tą kartą, powtórz wszystkie inne kolory wybrane wcześniej przez inne Karty Simona. W przypadku pominięcia, dobierz 1 kartę. Jeśli trafisz, wybierz następny kolor.","Ha kijátszod ezt a kártyát, ismételd meg sorban az eddigi Simon Kártyák által válaszott színeket. Ha nem sikerül, húzz egy kártyát. Ha sikerül, válaszd ki a következő színt.",""},
HOUSE_BAN ={"Banishment Card","Carta do Banimento","","Carta de Sanción","Карта Изгнания","驅逐卡牌","Karta Banicji","Száműzetés Kártya",""},
HOUSE_BAN_DESC ={"When you play this card, choose one of three cards from your hand and remove from the game every card matching its symbol.","Ao jogar esta carta, escolha uma entre 3 cartas da sua mão. Tire do jogo TODAS as cartas com o mesmo símbolo da carta escolhida.","","Cuando juegues esta carta, tendrás que elegir una de tres cartas de tu baraja, y remover del juego cada carta que coincida con su símbolo.","Когда вы положили эту карту, выберите одну из трёх карт из своей руки и удалите из игры каждую карту, соответствующую ее символу.","當你發出這卡, 在三張你卡組的卡牌中選取一張, 之後跟那卡牌有著一樣的圖案/數字的卡會從遊戲中刪去。","Kiedy zagrasz tą kartą, wybierz jedną z trzech kart z twojej ręki i usuń z gry każdą kartę pasującą do jej symbolu.","Ha kijátszod ezt a kártyát, válassz egy, a kezedben lévő kártyát három lehetőségből, majd száműzz a játékból minden olyan szimbólummal rendelkező kártyát.",""},
HOUSE_MIX ={"Combo Cards","Cartas Combo","","Carta de Combo","Комбо-Карты","累計卡牌","Karty Combo","Keverék Kártyák",""},
HOUSE_MIX_DESC ={"These cards activate the two effects corresponding to their symbols.","Estas cartas ativam os dois efeitos correspondentes aos símbolos delas.","","Esas cartas activan los dos efectos correspondientes a sus símbolos.","Эти карты активируют два эффекта, соответствующие их символам.","這些卡牌會激活上面的圖案的兩個效果。","Karty te aktywują dwa efekty odpowiadające ich symbolom.","Ezek a kártyák a rajtuk megjelenő két szimbólumhoz tartozó hatást aktiválják.",""},
HOUSE_DICE ={"Dice Card","Carta do Dado","","Carta de Dado","Игральные Карты","骰子卡牌","Karta Kości Do Gry","Dobókocka Kártya",""},
HOUSE_DICE_DESC ={"When you play this card, force the next player to roll the dice and suffer the effects.","Ao jogar esta carta, force o próximo jogador a rolar o dado e sofrer uma consequência.","","Cuando juegues esta carta, forzarás al siguiente jugador a rodar los dados y sufrir los efectos.","Когда вы положили эту карту, вынуждайте следующего игрока бросать кости и переносить эффекты.","當你發出這卡牌, 會迫使下一個玩家去投骰然後承受相關的效果。","Kiedy zagrasz tą kartą, zmuś następnego gracza, aby rzucił kostką i poniósł skutki.","Ha kijátszod ezt a kártyát, a következő játékosnak dobókockát kell dobnia, majd annak hatásait elviselni.",""},
HOUSE_HALF ={"Authority Card","Carta da Autoridade","","Carta de Autoridad","Авторитетная Карточка","權力卡牌","Karta Autorytetu","Felhatalmazó Kártya",""},
HOUSE_HALF_DESC ={"Draw only half of the cards while holding this card in your hand.","Compre apenas metade das cartas enquanto segurar esta carta na mão.","","Solo podrás sortear la mitad de las cartas mientras tengas esta carta en tu baraja.","Возьмите только половину карт, держа эту карту в руке.","當你手中持有這卡牌被罰抽的時候只需抽取一半的卡。","Dobierz tylko połowę kart, trzymając tę ​​kartę w twojej dłoni.","Amíg ez a kártya a kezedben van, csak feleannyi kártyát kell húznod.",""},
HOUSE_JUSTICE ={"Justice Card","Carta da Justiça","","Carta de Justicia","Карта Правосудия","正義卡牌","Karta Sprawiedliwości","Igazság Kártya",""},
HOUSE_JUSTICE_DESC ={"When you play this card, discard 1 card for each player with fewer cards than you.","Ao jogar esta carta, descarte 1 carta por cada jogador com menos cartas que você.","","Cuando jugues esta carta, descartará una carta por cada jugador con menos cartas que tú.","Когда вы положили эту карту, сбросьте 1 карту для каждого игрока, у которого меньше карт, чем у вас.","當你發出這卡牌, 每當有一個玩家持有的卡牌比你少你就會丟棄掉一張卡。","Kiedy zagrasz tą kartą, odrzuć 1 kartę dla każdego gracza z mniejszą ilością kart niż ty.","Ha kijátszod ezt a kártyát, dobj el egy véletlenszerű kártyákat annyiszor, mint ahány játékos van kevesebb kártyával, mint ami neked van.",""},
HOUSE_MIMIC ={"Imitation Card","Carta da Imitação","","Carta de Imitación","Имитационная Карта","模仿卡牌","Karta Imitacji","Utánzó Kártya",""},
HOUSE_MIMIC_DESC ={"When you play this card, choose a player. You will imitate their actions (play/draw cards) until your next turn.","Ao jogar esta carta, escolha um jogador. Você imitará as ações dele (jogar/comprar cartas) até sua próxima vez.","","Cuando juegues esta carta, eligirás una jugador. A este mismo jugador imitarás las acciones (jugar/sortear cartas) hasta tu siguiente turno.","Когда вы положили эту карту, выбирайте игрока. Вы будете подражать его действиям (играть / брать карты) до вашего следующего хода.","當你發出這卡牌的時候, 選擇一個玩家。 你會仿傚他的行動 (發/抽卡) 直到你下一個回合。","Kiedy zagrasz tą kartą, wybierz gracza. Będziesz imitować ich działania (grać / dobierać karty) aż do następnej tury.","Ha kijátszod ezt a kártyát, válassz egy játékost. A következő körödig utánozni fogod a cselekvéseit (kártya kijátszása/húzása).",""},
HOUSE_BG ={"Blue and Green","Azul e Verde","","Azul y Verde","Синий и Зелёный","藍天綠地","Niebieski i Zielony","Kék és Zöld",""},
HOUSE_BG_DESC ={"Blue and green cards will be treated as if they were the same color.","Cartas azuis e verdes serão tratadas como se fossem da mesma cor.","","Las cartas de color azul y verde serán tratadas como si del mismo color fuesen.","Синие и зелёные карты будут рассматриваться так, как если бы они были одного цвета.","藍色跟綠色會被當作成同一個顏色。","Niebieskie i zielone karty będą traktowane tak, jakby były tego samego koloru.","A kék és zöld kártyák azonos színűeknek számítanak.",""},
HOUSE_DOS ={"DOS!","","","","ДОС!","","","",""},
HOUSE_DOS_DESC ={"Instead of declaring UNO, you need to declare DOS when you have two cards in your hand.","Ao invés de declarar UNO, você precisa declarar DOS quando tiver duas cartas na mão.","","En vez de declarar UNO, deberás de declarar DOS cuanto tengas dos cartas en tu baraja.","Вместо того, чтобы объявлять УНО, вам нужно объявить ДОС, когда у вас в руке две карты.","你需要在你卡組只剩下兩張卡牌的時候喊 DOS, 而不是 UNO。","Zamiast deklarować UNO, musisz zadeklarować DOS, gdy masz dwie karty w ręce.","Ahelyett, hogy UNO-t kellene bemondani, DOS-t kell, ha két kártya van csak a kezedben.",""},
HOUSE_PARADOX ={"Paradox Card","Carta do Paradoxo","","Carta Paradoja","Карта-Парадокс","悖論卡牌","Karta Paradoksu","Paradox Kártya",""},
HOUSE_PARADOX_DESC ={"When you play this card, send a random card from your hand to your hand in your next match.","Ao jogar esta carta, envie uma carta aleatória da sua mão para a sua mão da sua próxima partida.","","Cuando juegues esta carta, enviará una carta aleatoria de tu baraja, a tu baraja pero en tu siguiente turno.","Когда вы положили эту карту, отправьте случайную карту из вашей руки в вашу руку в следующем матче.","當你發出這卡牌, 你會把手中隨機的一張卡傳送到你下一場遊戲中的卡組。","Kiedy zagrasz tą kartą, wyślij losową kartę z ręki do ręki w następnej rundzie.","Ha kijátszod ezt a kártyát, a kezedből egy véletlenszerű kártya a következő játékban lévő kezdeti kártyáid közé kerül.",""},
HOUSE_ODD_EVEN ={"Traffic Light Card","Carta do Semáforo","","Carta Semáforo","Карта Светофора","交通燈卡","Karta Sygnalizacji Świetlnej","Közlekedési Lámpa Kártya",""},
HOUSE_ODD_EVEN_DESC ={"When you play this card, you won't be able to win with either odds or evens (randomly chosen). Playing this card again changes it.","Ao jogar esta carta, será proibido vencer com cartas pares ou ímpares (escolhido aleatoriamente). Ao jogar isso de novo, mude.","","When playing this card again, switch to the other option. Cuando juegues esta carta, estará prohibido ganar con cartas pares o impares, dependiendo de cuál sea elegido. Cuando la juegues nuevamente, cambiará a la otra opción.","Когда вы положили эту карту, вы не сможете выиграть ни с коэффициентами, ни с чётными (выбранными случайным образом). Повторное использование этой карты меняет её.","當你發出這卡牌, 你將不能夠以單數或雙數的卡牌勝出遊戲 (隨機決定)。 再發出這卡會改變效果。","Kiedy zagrasz tą kartą, zabronione będzie wygrywanie kartami nieparzystymi lub parzystymi (wybieranymi losowo). Podczas ponownego zagrania tą kartą, zmień na inną opcję.","Ha kijátszod ezt a kártyát, akkor nem lehet a játékot megnyerni vagy páros vagy páratlan kártyákkal (véletlenszerűen kiválasztva). Ha ismét kijátszod ezt a kártyát, akkor megcserélődik.",""},
HOUSE_LOCK ={"Lock Card","Carta da Tranca","","Carta de Bloqueo","Блокировка Карты","鎖卡","Karta Blokady","Zár Kártya",""},
HOUSE_LOCK_DESC ={"When you play this card, lock two cards in every other player's hand for 1 turn.","Ao jogar esta carta, bloqueie duas cartas na mão de cada outro jogador por 1 turno.","","Cuando juegues esta carta, bloqueará dos cartas por cada jugador por un turno.","","當你發出這卡, 會在一個回合內鎖著所有人手上的兩張卡。","","Ha kijátszod ezt a kártyát, egy körig minden ellenfeled kezében két kártya lezáródik.",""},
HOUSE_SHARE ={"Sharing Card","Carta da Partilha","","","","分享卡","","Osztozkodás Kártya",""},
HOUSE_SHARE_DESC ={"When you play this card, give copies of your cards randomly to the other players (maximum 10 cards).","Ao jogar esta carta, dê cópias das suas cartas aleatoriamente aos outros jogadores (máximo 10 cartas).","","","","當你發出這卡, 你手上的卡會被隨機複製給其他玩家 (上限 10 張)。","","Ha kijátszod ezt a kártyát, a többi játékos véletlenszerűen kap a kezedben lévő kártyákról másolatokat (maximum 10 kártya).",""},
HOUSE_TWO_HANDS ={"Two Hands","Duas Mãos","","","","雙手","","Két Kéznyi Lap",""},
HOUSE_TWO_HANDS_DESC ={"You have two hands of cards to play. Finish one first to be able to use the other and win the game!","Você tem duas mãos de cartas para jogar. Termine uma primeiro para poder usar a outra e ganhar o jogo!","","","","你有兩組的卡牌遊玩。首先完成一組卡牌再使用第二組來取得遊戲勝利!","","Két kéznyi kártyával kell játszanod. Ha az elsőt befejezted, akkor használhatod a másodikat, hogy megnyerd a játékot.",""},
HOUSE_REVERSE ={"Counterattack","Contra-ataque","","","","反擊","","Ellentámadás",""},
...
HOUSE_POKER ={"Rule Poker","Poker de Regras","","","","規矩扑克","","Szabály Póker",""},
HOUSE_POKER_DESC ={"At the start of the game, each player chooses a rule to add to the match.","No início do jogo, cada jogador escolhe uma regra para colocar na partida.","","","","在遊戲開始之前, 每一個玩家可選擇一個規矩加到遊戲當中。","","A játék kezdetekor minden játékos választhat egy szabályt, amit hozzáadhat a játékhoz.",""},
HOUSE_ADD ={"More Rules","Mais Regras","","","","更多規矩","","Több Szabály",""},
HOUSE_ADD_DESC ={"Enable this rule to allow the game to sometimes add other rules.","Ative esta regra para permitir que o jogo adicione outras regras de vez em quando.","","","","選擇這規矩來讓遊戲隨時增加額外的規矩。","","Ha ez a szabály érvényes, a játékhoz véletlenszerűen egyéb szabályok hozzáadódhatnak.",""},
HOUSE_LIMITLESS ={"Limitless","Sem Limite","","","","無限","","Határtalan",""},
HOUSE_LIMITLESS ={"Players can now have more than 30 cards in hand.","Os jogadores agora podem ter mais de 30 cartas na mão.","","","","現在玩家手上可以多於 30 張卡牌。","","A játékosoknak lehet egyszerre több, mint 30 kártya a kezében.",""},
HOUSE_TOURNAMENT ={"Tournament","Torneio","","Torneo","Турнир","聯賽","Turniej","Bajnokság",""},
HOUSE_TOURNAMENT_DESC ={"Multiple matches will occur. When a player reaches %s points, they will be the winner. Click here and see how scoring works.","Várias partidas ocorrerão. Quando um jogador atingir %s pontos, ele será o vencedor. Clique aqui e veja como funciona a pontuação.","","Múltiples juegos ocurrirán. Cuando un jugador pase los puntos de %s, será el ganador. Da clic aquí para ver como funciona la puntuación.","Происходить будут несколько матчей. Когда игрок наберет %s очков, он станет победителем. Нажмите здесь и посмотрите, как работают оценки.","多場遊戲會同時進行。當一個玩家達到 %s 分數, 他就會成為勝利者。 點這裡查看如何計算分數。","Będą się pojawiać wielokrotne rozgrywki. Kiedy gracz osiągnie %s punktów, zostanie zwycięzcą. Kliknij tutaj i zobacz jak działa punktacja.","Egymás után több játék fog megtörténni. Ha egy játékos elér %s pontot, ő lesz a győztes. Kattints ide, hogy lásd hogy működik a pontozás.",""},
HOUSE_SURVIVOR ={"Survival Tournament","Torneio de Sobrevivência","","Torneo de Supervivencia","Турнир На Выживание","生存賽制聯賽","Turniej Przetrwania","Túlélő Bajnokság",""},
HOUSE_SURVIVOR_DESC ={"Multiple matches will occur. When a player reaches %s points, they will be eliminated. Last player standing wins. Click here and see how scoring works.","Várias partidas ocorrerão. Quando um jogador atingir %s pontos, ele será eliminado do torneio. Vence quem sobrar. Clique aqui e veja como funciona a pontuação.","","Múltiples juegos ocurrirán. Cuando un jugador pase los puntos de %s, el otro será eliminado. El último jugador en prevalecer ganará. Da clic aquí para ver como funciona la puntuación.","Происходить будут несколько матчей. Когда игрок наберет %s очков, они будут устранены. Последний стоящий игрок выигрывает. Нажмите здесь и посмотрите, как работают оценки.","多場遊戲會同時進行。 當一個玩家達到 %s 分數, 他就會被淘汰。 剩下的最後一個玩家勝出。 點這裡查看如何計算分數。","Będą pojawiać się wielokrotne rozgrywki. Kiedy gracz osiągnie %s punktów, zostanie wyeliminowany. Ostatni gracz zostanie zwycięzcą. Kliknij tutaj i zobacz jak działa punktacja.","Egymás után több játék fog megtörténni. Ha egy játékos elér %s pontot, kiesik a játékból. A legutolsó játékos, aki játékban marad, nyer. Kattints ide, hogy lásd hogy működik a pontozás.",""},
HOUSE_CUSTOM ={"Custom Card","Carta Customizada","","Carta Personalizada","Таможенная Карта","自定義卡牌","Karta Zwyczaju","Saját Kártya",""},
HOUSE_CUSTOM_DESC ={"The room owner can put the effect they want on this card.","O dono da sala pode colocar o efeito que ele quiser nesta carta.","","El dueño de la sala podrá poner los efectos que quiera en esta carta.","Владелец комнаты может поместить желаемый эффект на эту карту.","房間的創建人可以把想要的效果自行加到這張卡牌中。","Właściciel pokoju może umieścić na niej wybrany przez siebie efekt.","A szoba tulajdonosa bármilyen hatást tud erre a kártyára rakni.",""},
CARD_SKIP ={"When you play this card, the next player misses their turn.","Ao jogar esta carta, o próximo jogador perde a vez.","","Cuando juegues esta carta, el siguiente jugador perderá su turno.","Когда вы положили эту карту, следующий игрок пропускает свой ход.","當你發出這張卡, 下一個玩家會失去他的回合。","Kiedy zagrasz tą kartą, następny gracz traci swoją kolej.","Ha kijátszod ezt a kártyát, a következő játékos kimarad a körből.","Bu kartı oynadığınızda, bir sonraki oyuncu sıralarını kaçırır."},
CARD_REVERSE ={"When you play this card, the order of play is reversed. If there are only two players in the game, you play again.","Ao jogar esta carta, inverta a ordem do jogo. Se for apenas duas pessoas jogando, jogue novamente.","","Cuando juegues esta carta, la dirección de turnos en el juego cambiará. Si sólo hay dos personas jugando, pasará normal.","Когда вы положили эту карту, порядок игры меняется на противоположный. Если в игре только два игрока, вы играете снова.","當你發出這張卡, 遊戲進行的方向會反轉。 如果只有兩個玩家進行遊戲, 你可以馬上再發卡。","Kiedy zagrasz tą kartą, zmień kierunek gry. Jeśli w grze jest tylko dwóch graczy, zagraj ponownie.","Ha kijátszod ezt a kártyát, megfordul a kör iránya. Ha csak két játékos van a játékban, újra te következel.","Bu kartı oynadığınızda, oyun sırası tersine çevrilir. Eğer oyunda sadece iki oyuncu varsa, tekrar oynarsınız."},
CARD_DRAW_TWO ={"When you play this card, the next player draws 2 cards and misses their turn, (unless they have another +2).","Ao jogar esta carta, o próximo jogador deve comprar 2 cartas (a menos que ele jogue outro +2).","","Cuando juegues esta carta, el siguiente jugador necesitará sortear dos cartas (a menos de que tenga otra +2).","Когда вы полоижили эту карту, следующий игрок берет 2 карты и пропускает свой ход (если у него нет другого +2).","當你發出這張卡, 下一個玩家罰抽 2 張卡牌然後失去回合, (除非他有另一張 +2 卡牌)。","Kiedy zagrasz tą kartą, następny gracz musi dobrać 2 karty (chyba że ma inne +2).","Ha kijátszod ezt a kártyát, a következő játékos húz két kártyát, és kimarad a körből, (kivéve ha van nekik egy másik +2).","Bu kartı oynadığınızda, bir sonraki oyuncu 2 kart çeker ve sırasını kaçırır (başka bir +2'leri olmadıkça)."},
CARD_WILD ={"You can play this card over cards of every color, to switch the color to any of the four colors.","Você pode jogar esta carta a qualquer momento. Depois escolha uma cor para prosseguir o jogo.","","Podrás descartarla sobre cualquier carta y darle el poder de cambiar entre cualquier de los cuatro colores.","Вы можете положить эту карту поверх карт любого цвета, чтобы поменять цвет на любой из четырёх цветов.","你可以在任何一個顏色的卡牌上發出這換色卡牌, 用來改變出牌的顏色。","Możesz go wyłożyć na dowolnej karcie i daje on możliwość zmiany koloru na dowolny z czterech kolorów.","Bármely színű kártyára kijátszhatod ezt a kártyát, hogy megváltoztasd a színt a négy szín bármelyikére.","Rengi dört renkten herhangi birine geçirmek için bu kartı her renkteki kartların üzerinde oynayabilirsiniz."},
CARD_WILD_DRAW_FOUR ={"You can play this card over cards of every color, to switch the color to any of the four colors. You also force the next player to draw 4 cards and miss their turn (unless they have another +4). You should play this card only when you have no card matching the color of the card on the table. It is possible to challenge this card if you think it was illegally played on you.","Além de poder jogar a qualquer momento e escolher a cor, você força o próximo a comprar 4 cartas (a menos que ele tenha outro +4). Você só deve jogar esta carta caso não possua nenhuma carta da cor da carta da mesa. É possível desafiar esta carta caso você ache que a carta foi jogada injustamente.","","Además de poder jugarla en cualquier momento y elegir el color, forzarás al siguiente a recibir cuatro cartas (a menos de que juegue otro +4). Solo deberías de jugar esta carta si no tienes cartas que coincidan con el color de la carta superior en la tabla. Es posible desafiar esta carta si crees que la carta fue jugada suciamante.","Вы можете положить эту карту поверх карт любого цвета, чтобы поменять цвет на любой из четырёх цветов. Вы также заставляете следующего игрока взять 4 карты и пропустить свой ход (если у него также нет +4). Ложить эту карту следует только в том случае, если на столе нет карты, соответствующей цвету карты. Можно принять вызов, если вы думаете, что она была незаконно разыграна на вас.","你可以在任何一個顏色的卡牌上發出這 +4 卡牌, 改變出牌的顏色。 同時, 你也會令下一個玩家罰抽 4 張卡牌以及跳過他的回合 (除非他也有一張 +4 卡牌)。 你只可以在手中的卡牌沒有跟桌面上的卡一樣顏色的時候才可以發出 +4 卡牌。 如果你覺得別人沒有照規定發出 +4 卡牌, 你可以質疑他。","Oprócz możliwości wyłożenia go w dowolnym momencie i wyboru koloru, wymuszasz graczowi dobranie 4 kart (chyba, że ​​zagra on kolejną kartą +4). Powinieneś zagrać tę kartę tylko, jeśli nie masz karty pasującej do koloru górnej karty na stole. Możesz zakwestionować tę kartę, jeśli uważasz, że karta została niesprawiedliwie zagrana.","Bármely színű kártyára kijátszhatod ezt a kártyát, hogy megváltoztasd a színt a négy szín bármelyikére. Ezen kívül a következő játékosnak négy kártyát kell húznia, majd kimarad a körből (kivéve ha van neki egy másik +4). Csak akkor szabad ezt a kártyát kijátszani, ha nincs olyan színű kártya a kezedben, mint amilyen az asztalon van. Ha szerinted helytelenül játszották ki rád ezt a kártyát, ki lehet hívni. ","Rengi dört renkten herhangi birine geçirmek için bu kartı her renkteki kartların üzerinde oynayabilirsiniz. Ayrıca bir sonraki oyuncuyu 4 kart çekmeye ve sıralarını kaçırmaya zorlarsınız (başka bir +4'leri yoksa). Bu kartı sadece masadaki kartın rengiyle eşleşen kartınız yoksa oynamalısınız. Sizde yasadışı olarak oynandığını düşünüyorsanız, bu karta meydan okumak mümkündür."},
CARD_PAWN ={"When someone plays a chess card over this card, the previous player draws 1 card.","Quando alguém jogar uma peça de xadrez em cima desta carta, o jogador anterior compra 1 carta.","","Cuando alguien juega una pieza de tablero sobre esta carta, el jugador anterior sortea una carta.","Когда кто-то ложит шахматную карту поверх этой карты, предыдущий игрок берет 1 карту.","當有玩家在這張卡之後發出另一張棋子卡牌, 上一個玩家罰抽 1 張卡牌。","Gdy ktoś zagra figurą szachową na tej karcie, poprzedni gracz dobiera 1 kartę.","Ha valaki egy sakk kártyát játszik erre a kártyára, az előző játékos húz egy kártyát.","Birisi bu kartın üzerinde satranç kartı oynadığında, önceki oyuncu 1 kart çeker."},
CARD_BISHOP ={"When someone plays a chess card over this card, they donate 1 random card to the previous player.","Quando alguém jogar uma peça de xadrez em cima desta carta, ele doa uma carta aleatória para o jogador anterior.","","Cuando alguien juega una pieza de tablero sobre esta carta, le da una carta aleatoria al jugador anterior.","Когда кто-то ложит шахматную карту поверх этой карты, он жертвует 1 случайную карту предыдущему игроку.","當有玩家在這張卡之後發出另一張棋子卡牌, 他會把隨機一張手中的牌送給上一個玩家。","Gdy ktoś zagra figurą szachową na tej karcie, daje 1 losową kartę dla poprzedniego gracza.","Ha valaki egy sakk kártyát játszik erre a kártyára, egy véletlenszerű kártyát adományoz az előző játékosnak.","Birisi bu kartın üzerinde satranç kartı oynadığında, önceki oyuncuya 1 rastgele kart bağışlar."},
CARD_KNIGHT ={"When someone plays a chess card over this card, the order of play is reversed and the next player draws 1 card and misses their turn.","Quando alguém jogar uma peça de xadrez em cima desta carta, o jogo inverte e o próximo jogador compra 1 carta e perde a vez.","","Cuando alguien juega una pieza de tablero sobre esta carta, el juego se torna de reverso y el sigueinte jugador sortea una carta y pierde su turno.","Когда кто-то ложит шахматную карту поверх этой карты, порядок игры меняется на противоположный, и следующий игрок берёт 1 карту и пропускает свой ход.","當有玩家在這張卡之後發出另一張棋子卡牌, 遊戲方向反轉而且下一個玩家罰抽 1 張卡及失去他的回合。","Gdy ktoś zagra figurą szachową na tej karcie, kierunek gry się odwraca, a następny gracz dobiera 1 kartę i traci swoją kolej.","Ha valaki egy sakk kártyát játszik erre a kártyára, a kör iránya megfordul, a következő játékos húz egy kártyát, és kimarad a körből.","Birisi bu kartın üzerinde bir satranç kartı oynadığında, oyun sırası tersine çevrilir ve bir sonraki oyuncu 1 kart çeker ve sırasını kaçırır."},
CARD_ROOK ={"When someone plays a chess card over this card, the previous player draws 2 cards.","Quando alguém jogar uma peça de xadrez em cima desta carta, o jogador anterior compra 2 cartas.","","Cuando alguien juega una pieza de tablero sobre esta carta, el jugador anterior sortea dos cartas.","Когда кто-то ложит шахматную карту поверх этой карты, предыдущий игрок берёт 2 карты.","當有玩家在這張卡之後發出另一張棋子卡牌, 上一個玩家罰抽 2 張卡牌。","Gdy ktoś zagra figurą szachową na tej karcie, poprzedni gracz dobiera 2 karty.","Ha valaki egy sakk kártyát játszik erre a kártyára, az előző játékos húz két kártyát.","Birisi bu kartın üzerinde satranç kartı oynadığında, önceki oyuncu 2 kart çeker."},
CARD_QUEEN ={"When someone plays a chess card over this card, the previous player will draw cards until they have 10 cards.","Quando alguém jogar uma peça de xadrez em cima desta carta, o jogador anterior compra cartas até ter 10 cartas na mão.","","Cuando alguien juega una pieza de tablero sobre esta carta, el jugador anterior tendrá que sortear cartas hasta que tenga diez.","Когда кто-то ложит шахматную карту поверх этой карты, предыдущий игрок будет брать карты, пока у него не будет 10 карт.","當有玩家在這張卡之後發出另一張棋子卡牌,　上一個玩家需要一直罰抽直到他手中有 10 張卡牌。","Gdy ktoś zagra figurą szachową na tej karcie, poprzedni gracz dobiera karty, dopóki nie będzie miał ich 10.","Ha valaki egy sakk kártyát játszik erre a kártyára, az előző játékos addig húz kártyákat, amíg 10 lesz a kezében.","Birisi bu kartın üzerinde satranç kartı oynadığında, önceki oyuncu 10 kart alana kadar kart çeker."},
CARD_KING ={"When someone plays a chess card over this card, they give all their cards, except one, to the previous player.","Quando alguém jogar uma peça de xadrez em cima desta carta, ele doa todas as cartas, exceto uma, para o jogador anterior.","","Cuando alguien juega una pieza de tablero sobre esta carta, le da todas sus cartas, excepto una, al jugador anterior.","Когда кто-то ложит шахматную карту поверх этой карты, он передает все свои карты, кроме одной, предыдущему игроку.","當有玩家在這張卡之後發出另一張棋子卡牌, 他會把手上的卡牌 (除了一張以外) 全部送給上一個玩家。","Gdy ktoś zagra figurą szachową na tej karcie, oddaje wszystkie swoje karty dla poprzedniego gracza z wyjątkiem jednej.","Ha valaki egy sakk kártyát játszik erre a kártyára, egy kivételével a kezében lévő összes kártyáját az előző játékosnak adja.","Birisi bu kartın üzerinde satranç kartı oynadığında, biri hariç tüm kartlarını bir önceki oyuncuya verir."},
CARD_TREASURE ={"When you play this card, you win the game!","Ao jogar esta carta, você vence o jogo!","","¡Cuando juegues esta carta ganarás el juego!","Когда вы ложите эту карту - вы выигрываете игру!","當你發出這卡牌, 你直接勝出!","Kiedy zagrasz tą kartą, wygrywasz grę!","Ha kijátszod ezt a kártyát, megnyered a játékot!","Bu kartı oynadığınızda oyunu kazanırsınız!"},
CARD_SHIELD ={"This card can protect you against +2 and +4 cards.","Esta carta pode te proteger de +2 e +4.","","Esta carta te protege contra +2 y +4.","Эта карта может защитить вас от +2 и +4","這張卡保護你不受到 +2 及 +4 的罰抽效果。","Ta karta chroni Cię przed kartami +2 i +4.","Ezzel a kártyával kivédheted a +2-es és +4-es kártyákat.","Bu kart sizi +2 ve +4 kartlara karşı koruyabilir."},
...
HOUSE_BLUE ={"Peace?","Paz?","Paix?","¿Paz?","Мир?","和平?","Pokój?","Béke?","Barış?"},
HOUSE_BLUE_DESC ={"When Charlotte plays a blue numerical card, every other player can only play numerical cards during the next turn.","Quando Charlotte joga um número azul, os outros podem jogar apenas cartas numéricas no próximo turno.","Lorsque Charlotte joue une carte numérique bleue, tous les autres joueursWhen Charlotte plays a blue numerical card, tous les autres joueurs ne peuvent jouer que des cartes numériques pendant le tour suivant.","Cuando Charlotte juega una carta numérica azul, todos los demás jugadores solo podrán jugar cartas numéricas en su siguiente turno.","Когда Charlotte ложит синюю цифровую карту, любой другой игрок может играть только числовые карты в течение следующего хода.","當 Charlotte 發出藍色的數字卡牌, 所有玩家下一回合只可以發出數字卡牌。","Kiedy Charlotte zagra niebieską kartą z liczbą, każdy gracz musi zagrać numeryczną kartą podczas następnej tury .","Ha Charlotte kék számkártyát játszik, a többi játékos egy körig csak számkártyát játszhat.","Charlotte mavi bir sayısal kart oynadığında, diğer tüm oyuncular bir sonraki turda yalnızca sayısal kartları oynayabilir."},
HOUSE_YELLOW ={"Rage?","Ira?","","¿Rabia?","Ярость?","狂暴?","Wściekłość?","Harag?",""},
HOUSE_YELLOW_DESC ={"When Charlotte plays a yellow numerical card, another random player draws 1-3 cards.","Quando Charlotte joga um número amarelo, outro jogador aleatório compra de 1 a 3 cartas.","Lorsque Charlotte joue une carte numérique jaune, un joueur au hasard tire 1-3 cartes.","Cuando Charlotte juega una carta numérica amarilla, un jugador aleatorio recibe de una a tres cartas.","Когда Charlotte ложит жёлтую цифровую карту, другой случайный игрок берёт 1-3 карты.","當 Charlotte 發出黃色的數字卡牌, 隨機一個玩家罰抽 1-3 張卡牌。","Kiedy Charlotte zagra żółtą kartą, losowy gracz dobiera 1-3 karty.","Ha Charlotte sárga számkártyát játszik, egy véletlenszerű játékos húz 1-3 kártyát.","Charlotte sarı bir sayısal kart oynadığında, başka bir rastgele oyuncu 1-3 kart çeker."},
HOUSE_GREEN ={"Equality?","Igualdade?","Égalité?","¿Igualdad?","Равенство?","平等?","Równość?","Egyenlőség?","Eşitlik?"},
HOUSE_GREEN_DESC ={"When Charlotte plays a green numerical card, her number of cards will adjust to be equal to the player's with the least cards.","Quando Charlotte joga um número verde, ela fica com o mesmo número de cartas de quem está vencendo.","Lorsque Charlotte joue une carte numérique verte, son nombre de cartes s'ajustera pour être égal à celui du joueur ayant le moins de cartes.","Cuando Charlotte juega una carta numérica verde, su número de cartas se ajustará para ser igual al del jugador con menos cartas.","Когда Charlotte ложит зелёную цифровую карту, её количество карт будет скорректировано, чтобы быть равным количеству карт игрока с наименьшим количеством карт.","當 Charlotte 發出綠色的數字卡牌, 她的卡牌數目會調整到等於玩家中擁有最少卡牌的數目。","Kiedy Charlotte zagra zieloną numeryczną kartą, jej liczba zostanie dostosowana tak by być równa graczowi z najmniejszą ilością kart. ","Ha Charlotte zöld számkártyát játszik, annyi kártyát húz vagy dob el, hogy annyi legyen a kezében, mint amennyi a legkevesebb kártyával rendelkező játékosnak van.","Charlotte yeşil bir sayısal kart oynadığında, kart sayısı oyuncunun en az kartı olan oyuncuya eşit olacak şekilde ayarlanır."},
CURSE_ANVIL ={"When someone draws a card, they draw an additional one.","Quem comprar cartas comprará 1 carta a mais","Lorsque quelqu'un tire une carte, il en tire une autre.","Aquel que sortee cartas también sorteará una más","Когда кто-то берёт карту, он берет дополнительную.","當有人抽卡, 要額外再罰抽一張。","Kto dobiera karty, dobiera o 1 kartę więcej","Ha valaki kártyát húzna, húznia kell mégegyet.","Birisi bir kart çektiğinde, başka bir kart çeker."},
CURSE_ICE ={"No one can draw cards.","Ninguém pode comprar cartas","Personne ne peut tirer de cartes.","No podrá sortear cartas","Никто не может брать карты.","沒有人能抽卡。　","Nikt nie może dobrać kart","Senki sem húzhat kártyákat.","Kimse kart çekemez."},
CURSE_SHOE ={"When someone plays an action card, they draw 1 card.","Quem jogar carta de ação compra 1 carta","Quand quelqu'un joue une carte action, il tire 1 carte.","El que juega una acción recibirá una carta","Когда кто-то кладёт карту действия, он берёт одну карту.","當有人發出行動卡牌, 他們需要罰抽一張卡。","Kto zagra kartą akcji dobiera jedną kartę","Ha valaki akciókártyát játszik, húznia kell 1 kártyát","Birisi bir aksiyon kartı oynadığında 1 kart çeker."},
CURSE_THORN ={"Anyone that draws cards will be eliminated.","Quem comprar cartas será eliminado","Quiconque tire des cartes sera éliminé.","Aquel que sortee cartas será eliminado","Любой, кто берёт карты, будет удален.","任何人要抽卡的話就會被淘汰。","Kto dobierze karty zostanie wyeliminowany","Aki kártyát húz, az kiesik a játékból.","Kart çeken herkes elenecek."},
CURSE_TIME ={"Everyone has only 3 seconds to play.","São apenas 3 segundos para jogar","Tout le monde n'a que 3 secondes pour jouer.","Todos los jugadores solo tienen tres segundos para jugar","У всех есть только 3 секунды, чтобы играть.","所有人只有 3 秒回合時間。","Wszyscy gracze mają tylko 3 sekundy by zagrać","Mindenkinek csak 3 másodperce van játszani.","Herkesin oynaması için sadece 3 saniyesi vardır."},
CURSE_POISON ={"Everyone becomes confused.","Todos ficam confusos","Tout le monde devient confus.","Todos se confunden","Все смущаются.","所有人都被困惑了。","Wszyscy gracze są zdezorientowani","Mindenki zavarodott lesz.","Herkesin kafası karışır."},
DICE_1 ={"Take 1 card from the previous player.","Pegue 1 carta do jogador anterior.","Prenez 1 carte du joueur précédent.","Toma una carta del jugador anterior.","Возьмите 1 карту от предыдущего игрока.","從上一個玩家手中拿一張卡。","Weź 1 kartę od poprzedniego gracza.","Vegyél el 1 kártyát az előző játékostól.","Önceki oyuncudan 1 kart alın."},
DICE_2 ={"Draw 2 cards.","Compre 2 cartas.","Tirez 2 cartes.","Sortea dos cartas.","Возьмите 2 карты.","抽取 2 張卡。","Dobierz 2 karty.","Húzz 2 kártyát.","2 kart çizin."},
DICE_3 ={"Discard cards until you have 3 cards in your hand.","Descarte cartas até ficar com 3 cartas na mão.","Jetez des cartes jusqu'à ce que vous en ayez 3 dans votre main.","Descarta cartas hasta que tengas tres cartas en tu baraja.","Сбрасывайте карты, пока в вашей руке не окажется 3 карты.","一直丟棄卡牌直到手中只剩 3 張卡。","Odrzuć karty, dopóki nie masz 3 kart w ręce","Dobj el kártyákat a kezedből, amíg csak 3 kártya marad.","Elinizde 3 kart olana kadar kartları atın."},
DICE_4 ={"Play a 4 or draw 4 cards.","Jogue um 4 ou compre 4 cartas.","Jouez un 4 ou tirez 4 cartes.","Juega un +4 o sortea cuatro cartas.","Сыграйте 4 или возьмите 4 карты.","發出數字 4 的卡牌不然罰抽 4 張卡。","Zagraj kartą o numerze 4 lub dobierz 4 karty.","Játssz ki egy 4-es számkártyát, vagy húzz 4 kártyát.","4 oynayın veya 4 kart çekin."},
DICE_5 ={"Hand out 5 cards to the other players.","Distribua 5 cartas para os outros jogadores.","Distribuez 5 cartes aux autres joueurs.","Barajea cinco cartas a los otros jugadores.","Раздайте 5 карт другим игрокам.","分發 5 張卡牌給其他玩家。","Rozdaj 5 kart innym graczom.","Adj oda 5 kártyát a többi játékosnak.","Diğer oyunculara 5 kart dağıtın."},
DICE_6 ={"Draw cards until you have 6 cards in your hand.","Compre cartas até ficar com 6 cartas na mão.","Tirez des cartes jusqu'à ce que vous en ayez 6 dans votre main.","Sortea cartas hasta que tengas seis cartas en tu baraja.","Берите карты, пока в вашей руке не будет 6 карт.","一直抽牌直到手中有 6 張卡。","Wyciągaj karty, dopóki nie masz 6 kart w ręce.","Húzz kártyákat, amíg 6 kártya lesz a kezedben.","Elinizde 6 kart olana kadar kartları çizin."},
FORBIDEN_ODD ={"Unable to win with odd numerical cards.","Proibido vencer com cartas ÍMPARES","Impossible de gagner avec des cartes impaires.","Prohibido ganar con cartas IMPARES","Невозможно выиграть с нечётными цифровых картами.","不能夠用單數數字卡牌勝出。","Zabronione jest wygrywanie kartami o numerach nieparzystych.","Nem lehet páratlan számmal nyerni.","Tek sayısal kartlarla kazanılamıyor."},
FORBIDEN_EVEN ={"Unable to win with even numerical cards.","Proibido vencer com cartas PARES","Impossible de gagner avec des cartes paires.","Prohibido ganar con cartas PARES","Невозможно выиграть даже с помощью цифровых карт.","不能夠用雙數數字卡牌勝出。","Zabronione jest wygrywanie kartami o numerach parzystych.","Nem lehet páros számmal nyerni.","Sayısal kartlarla bile kazanılamıyor."},
UNLOCK_RULE ={"Win a match with this rule to unlock it!","Vença uma partida com essa regra para desbloqueá-la!","Gagnez une partie avec cette règle pour déverouiller!","¡Gana una partida con esta regla para desbloquearla!","Выиграйте матч с этим правилом, чтобы разблокировать его!","在用這規矩的一場遊戲裡勝出後解鎖它!","Wygraj rundę z daną zasadą aby ją odblokować!","Nyerj meg egy játékot ezzel a szabállyal, hogy feloldd magadnak!","Kilidini açmak için bu kuralla bir maç kazanın!"},
TEAM_RULE ={"Win 10 matches with this rule to unlock it!","Vença 10 jogos com esta regra pra desbloqueá-la.","Gagnez 10 parties avec cette règle pour déverouiller!","¡Gana diez partidas con esta regla para desbloquearla!","Выиграйте 10 матчей с этим правилом, чтобы разблокировать его!","在 10 場用這規矩的遊戲裡勝出後解鎖它!","Wygraj 10 rund z tą zasadą, aby ją odblokować!","Nyerj meg 10 játékot ezzel a szabállyal, hogy feloldd magadnak!","Kilidini açmak için bu kuralla 10 maç kazanın!"},
ACTION_DRAW ={"Draw cards","Comprar cartas","Tirer des cartes","Sortear cartas","Брать карты","抽卡","Dobierz karty","Kártyahúzás","Kartları çiz"},
ACTION_DISCARD ={"Discard cards","Descartar cartas","Défausser des cartes","Descartar cartas","Сбросить карты","棄卡","Odrzuć karty","Kártyaeldobás","Kartları sil"},
ACTION_DONATE ={"Donate cards","Doar cartas","Donner des cartes","Donar cartas","Пожертвовать карты","捐獻卡牌","Podaruj kartę","Kártyaadományozás","Bağış kartları"},
ACTION_SHOW ={"Show card","Mostrar carta","Montrer les cartes","Mostrar carta","Показать карту","顯示卡牌","Pokaż kartę","Kártya megmutatása","Reklam afişi"},
ACTION_SKIP ={"Lose a turn","Perder a vez","Rater un tour","Perder turno","Пропустить поворот","錯過了回合","Strać kolejkę","Körből kimaradás","Bir tur kaybet"},
ACTION_SWAP ={"Exchange places","Trocar de lugar","Échanger les places","Intercambiar lugares","Обмен местами","交換了位子","Wymień miejsca","Helycsere","Yerleri değiştirin"},
ACTION_TRADE ={"Swap cards","Trocar de cartas","Échanger les cartes","Cambiar cartas","Обменять карты","交換卡牌","Zmień karty","Kártyák cserélése",""},
ACTION_ELIMINATE ={"Eliminate","Eliminar","Éliminer","Eliminar","Устранить","淘汰","Eliminacja","Kiejtés",""},
WHO_YOURSELF ={"yourself","você mesmo","vous-même","tú mismo","сам","你","siebie","te",""},
WHO_NEXT ={"next player","próximo jogador","joueur suivant","siguiente jugador","следующий игрок","下一個玩家","następny gracz","a következő játékos",""},
WHO_PREVIOUS ={"previous player","jogador anterior","joueur précédent","anterior jugador","предыдущий игрок","上一個玩家","poprzedni gracz","az előző játékos",""},
WHO_ALL ={"all players","todos os jogadores","tous les joueurs","todos los jugadores","все игроки","所有玩家","wszyscy gracze","minden játékos",""},
WHO_OTHERS ={"other players","os outros jogadores","autres joueurs","otros jugadores","другие игроки","其他玩家","inni gracze","más játékosok",""},
WHO_CHOOSE ={"a player of your choice","um jogador a sua escolha","un joueur de votre choix","un jugador a tu elección","игрок по вашему выбору","你選擇的一個玩家","gracz twojego wyboru","egy általad választott játékos",""},
WHO_RANDOM ={"a random player","um jogador aleatório","un joueur au hasard","un jugador aleatorio","случайный игрок","隨機一個玩家","losowy gracz","egy véletlenszerű játékos",""},
WHO_RANDOM2 ={"two random players","dois jogadores aleatórios","deux joueurs au hasard","dos jugadores aleatorios","два случайных игрока","隨機兩個玩家","dwóch losowych graczy","két véletlenszerű játékos",""},
WHO_RANDOM3 ={"three random players","três jogadores aleatórios","trois joueurs au hasard","tres jugadores aleatorios","три случайных игрока","隨機三個玩家","trzech losowych graczy","három véletlenszerű játékos",""},
AMOUNT_X ={"%s card(s)","%s carta(s)","carte(s) de %s","%s cartas","%s карт(ы)","%s 張卡","%s karta(y)","%s kártya",""},
AMOUNT_RANGE ={"%s-%s cards","de %s a %s cartas","cartes de %s-%s","%s-%s cartas","%s-%s карты","%s-%s 張卡","%s-%s kart","%s-%s kártya",""},
AMOUNT_UNTIL ={"until to have %s card(s)","até ter %s carta(s)","","hasta tener %s cartas","пока не будет %s карт(ы)","直到有 %s 張卡","aż do %s kart","amíg %s kártya van",""},
AMOUNT_RETURN ={"return of action %s","saída da ação %s","","retorno de acción %s","возврат действия %s","撤銷行動 %s","wróć do akcji %s","a %s akció visszatérése",""},
CONDITION_ANY ={"any card","qualquer carta","n'importe quelle carte","cualquier carta","любая карта","任何一張卡牌","dowolna karta","bármely kártya",""},
CONDITION_NUMBER ={"numerical cards","cartas numéricas","cartes numériques","cartas numéricas","цифровые карты","數字卡牌","karty ponumerowane","számkártyák",""},
CONDITION_ACTION ={"action cards","cartas de ação","cartes action","cartas de acción","карты действий","行動卡牌","karty akcji","akciókártyák",""},
CONDITION_RED ={"red cards","cartas vermelhas","cartes rouges","cartas rojas","красные карты","紅色卡牌","czerwone karty","piros kártyák",""},
CONDITION_BLUE ={"blue cards","cartas azuis","cartes bleues","cartas azules","синие карты","藍色卡牌","niebieskie karty","kék kártyák",""},
CONDITION_YELLOW ={"yellow cards","cartas amarelas","cartes jaunes","cartas amarillas","жёлтые карты","黃色卡牌","żółte karty","sárga kártyák",""},
CONDITION_GREEN ={"green cards","cartas verdes","cartes vertes","cartas verdes","зелёные карты","綠色卡牌","zielone karty","zöld kártyák",""},
CONDITION_WILD ={"wild cards","curingas","cartes noires","cartas comodín","чёрные карты","換色卡牌","karty wild","Színváltó kártyák",""},
CONDITION_SAME ={"cards of the same color as this","cartas da mesma cor que esta","cartes de la même couleur que celle-ci","cartas del mismo color que éste","карты того же цвета, что и этот","跟這一樣顏色的卡牌","karty z takim samym kolorem jak to","ugyanolyan színű kártyák, mint ez",""},
ADD_ACTION ={"add action","adicionar ação","ajouter une action","añadir acción","добавить действие","增加行動","dodaj akcję","akció hozzáadása",""},
CUSTOM_DESC ={"Description","Descrição","Description","Descripción","Описание","描述","Opis","Leírás",""},
CUSTOM_DESC_INFO ={"Describe what the card does","Descreva o que a carta faz","Décrit ce que la carte fait","Describe que hace la carta","Описывает, что делает карта","描述卡牌會有什麼功能","Opisz co karta robi","Írd le, hogy mit tud a kártya",""},
CUSTOM_COPIES ={"Copies of each color","Cópias de cada cor","Copies de chaque couleur","Copia de cada color","Копии каждого цвета","每一個顏色的複本","Kopie każdego koloru","Minden színből darab",""},
CUSTOM_EDIT ={"Edit","Editar","Modifier","Editar","Редактировать","編輯","Edytuj","Szerkesztés",""},
CUSTOM_ERROR ={"There was an error in editing","Houve um erro ao editar","Il y a eu une erreur dans les modifications","Hubo un error al editar","Произошла ошибка при редактировании","編輯中有錯誤","Wystąpił błąd w edycji","Hiba történt szerkesztéskor",""},
CUSTOM ={"Customize card","Customizar carta","Personnaliser la carte","Personalizar carta","Настроить карту","自定義卡牌","Dostosuj kartę","Kártya testreszabása",""},
CUSTOM_LOAD ={"Load card","Carregar carta","Charger une carte","Cargar carta","Загрузить карту","加載卡牌","Załaduj kartę","Kártya betöltése",""},
CUSTOM_SAVE ={"Copy card","Copiar carta","Copier la carte","Copiar carta","Копировать карту","複製卡牌","Kopiuj kartę","Kártya másolása",""},
CUSTOM_CODE ={"Save this code to share your card: <vp>%s","Guarde este código para compartilhar sua carta: <vp>%s","Sauvegardez ce code pour partager votre carte: <vp>%s","Guarda este código para compartir tu carta: <vp>%s","Сохраните этот код, чтобы поделиться своей картой: <vp>%s","把這個代碼儲存下來以分享你的卡牌: <vp>%s","Zapisz ten kod, aby udostępnić swoją kartę: <vp>%s","Mentsd le ezt a kódot, hogy megoszthasd a kártyád: <vp>%s",""},
TOURNAMENT_HELP ={"The winner of a match earns points from the opponents' remaining cards. Whoever reaches %s points wins the tournament!\n\nNumerical cards: Their face value.\nAction cards: 20 points.\nWild cards: 50 points.","O vencedor da partida ganha pontos das cartas que restaram nas mãos dos adversários. Quem atingir %s pontos vence o torneio!\n\nCartas numéricas: seus valores de face\nCartas de ação: 20 pontos\nCartas curinga: 50 pontos","Le vainqueur d'un match gagne des points sur les cartes restantes de l'adversaire. Celui qui atteint %s points gagne la partie! Cartes numériques: leur valeur est sur la carte. Cartes Action: 20 points. Cartes Noires: 50 points.","El ganador de una partida gana puntuación por las cartas restantes de los oponentes. ¡Cuando un jugador alcanza %s puntos, se corona ganador!\n\nCartas numéricas: El número que representan\nCartas de acción: 20 puntos\nCarta comodín: 50 puntos.","Победитель матча зарабатывает очки с оставшихся карт противников. Тот, кто наберёт %s очков, выигрывает турнир!\n\nЦифровые карты: Их номинал.\nКарты действий: 20 очков.\nЧёрные карты: 50 очков.","在每場遊戲中勝出的玩家會從對手剩下的卡牌中贏得分數。 只要有人贏得 %s 分他就會勝出聯賽!\n\n數字卡: 數字面值就是分數。\n行動卡: 20 分。\n換色卡: 50 分。","Zwycięzca meczu zdobywa punkty od przeciwników z pozostałych kart. Kiedy gracz osiągnie %s punktów, zostanie zwycięzcą!\n\nPonumerowane karty: zgodnie z ich numeracją\nKarty Akcji: 20 points\nKarty Wild: 50 points","A játék nyertese összesített pontszámot kap az ellenfelei hátralévő kártyáinak értékéből. Aki eléri a(z) %s pontot megnyeri a bajnokságot!\n\nSzámkártyák: A rajtuk lévő számérték.\nAkciókártyák: 20 pont.\nSzínváltó kártyák: 50 pont. ","Bir maçın galibi, rakiplerin kalan kartlarından puan kazanır. %s puana ulaşan herkes turnuvayı kazanır!\n\nNumerik kartlar: Yüz değeri.\nAksiyon kartları: 20 puan.\nWild kartları: 50 puan."},
TOURNAMENT_HELP2 ={"When a match ends, the players earn points from their own remaining cards. Whoever reaches %s points gets eliminated.\n\nNumerical cards: Their face value.\nAction cards: 20 points.\nWild cards: 50 points.","Quando uma partida terminar, os jogadores recebem pontos das suas próprias cartas. Quem atingir %s pontos será eliminado do torneio.\n\nCartas numéricas: seus valores de face\nCartas de ação: 20 pontos\nCartas curinga: 50 pontos","Quand une partie se termine, les joueurs gagnent des points à partir de leurs propres cartes restantes. Celui qui atteint %s points sera éliminé. Cartes numériques: leur valeur est sur la carte. Cartes Action: 20 points. Cartes Noires: 50 points.","El ganador de una partida gana puntuación por las cartas restantes de los oponentes. ¡Cuando un jugador alcanza %s puntos, se corona ganador!\n\nCartas numéricas: El número que representan\nCartas de acción: 20 puntos\nCarta comodín: 50 puntos.","Когда матч заканчивается, игроки зарабатывают очки со своих оставшихся карт. Тот, кто наберёт %s очков, будет удалён.\n\nЦифровые карты: Их номинал.\nКарты действий: 20 очков.\nДикие карты: 50 очков.","當一場遊戲結束, 玩家會從自己剩下的卡牌中得到分數。 只要有人達到 %s 分就會被淘汰。\n\n數字卡: 數字面值就是分數。\n行動卡: 20 分。\n換色卡: 50 分。","Po zakończeniu rundy gracze otrzymają punkty z pozostałych kart. Kiedy gracz osiągnie %s punktów, zostanie wyeliminowany!\n\nPonumerowane karty: zgodnie z ich numeracją\nKarty Akcji: 20 points\nKarty Wild: 50 points","A játék végén a játékosok pontokat kapnak a hátralévő kártyáik értékéből. Aki eléri a(z) %s pontot kiesik a bajnokságból.\n\nSzámkártyák: A rajtuk lévő számérték.\nAkciókártyák: 20 pont.\nSzínváltó kártyák: 50 pont. ","Bir maç sona erdiğinde, oyuncular kalan kartlarından puan kazanırlar. %s puana ulaşan herkes elenir.\n\ nNumerik kartlar: Yüz değeri.\nAksiyon kartları: 20 puan.\nWild kartları: 50 puan."},
TOURNAMENT_EDIT ={"Edit score","Editar pontuação","Modifier le score","Editar puntuación","Изменить счёт","編輯分數","Edytuj wynik","Pontszám módosítása","Skoru düzenle"},
HOUSE_FIXED ={"Fixed rules","Regras fixas","Règles fixes","Reglas Fijas","Исправить правила","固定規則","Popraw zasady","Megszabott szabályok","Sabit kurallar"},
ROOM_OPTIONS ={"Room options","Opções da Sala","Options de salon","Opciones de la sala","Настройки комнаты","房間選項","Opcje pokoju","Szoba beállítások","Oda seçenekleri"},
CLEAR_HOUSE ={"Reset rules","Limpar regras","Réinitialiser les règles","Resetear Reglas","Сбросить правила","重置規矩","Zrestartuj zasady","Szabályok alapértelmezése","Kuralları sıfırla"},
HOUSE_NEW_PLAYER ={"Allow new players","Permitir novos jogadores","Autoriser les nouveaux joueurs","Permitir nuevos jugadores","Разрешить новым игрокам","准許新玩家加入","Wpuszczać nowych graczy","Új játékosok engedélyezése","Yeni oyunculara izin ver"},
HOUSE_FIXED_CHAIRS ={"Fixed chairs","Cadeiras fixas","Chaises fixes","Sillas Fijas","Исправить кресла","固定座位","Poprawiono fotele","Foglalt ülőhelyek","Sabit sandalyeler"},
HOUSE_AUTOSTART ={"Start automatically","Iniciar automaticamente","Démarrer automatiquement","Empezar automáticamente","Начать автоматически","自動開始遊戲","Automatyczny start","Automatikus indulás","Otomatik başlat"},
SCORE_BY ={"Score","Pontuação","","Puntuación","Счёт","分數","Punkty","Pontszám","Puan"},
SCORE_1 ={"from opponents' cards","das cartas dos adversários","des cartes de l'adversaire","de las cartas de los oponentes","с карт противника","從對手剩下的卡牌中計算","z kart przeciwnika","az ellenfelek kártyáiból",""},
SCORE_2 ={"from own cards","das próprias cartas","de ses propres cartes","de las cartas propias","с собственных карт","從自己剩下的卡牌中計算","z własnych kart","a saját kártyáidból","Kendi kartlarından"},
SCORE_3 ={"1 point per victory","1 ponto por vitória","1 point par victoire","un punto por victoria","1 очко за победу","每次勝出就得到 1 分","1 punkt do zwycięstwa","1 pont győzelmenként","Zafer başına 1 puan"},
RESET_SCORE ={"Reset score","Zerar pontuação","Réinitialiser le score","resetear puntuación","Сбросить счёт","重置分數","Restartuj punkty","Pontszám alapértelmezése","Skoru sıfırla"},
YES ={"yes","sim","oui","sí","да","是","tak","igen","Evet"},
NO ={"no","não","non","no","нет","不是","nie","nem","Hayır"},
COMMANDS ={"See commands","Ver comandos","Voir les commandes","Ver comandos","Посмотреть команды","查看指令","Zobacz komendy","Parancsok mutatása","Komutlara bakın"},
PARTY_ROOM ={"Make your room!","Crie sua sala!","Créez votre salon!","¡Haz tu sala!","Сделай свою комнату!","創建自己的房間!","Zrób swój pokój!","Készítsd el a szobád!","Odanı yap!"},
COMMAND_START ={"start the round manually","inicia a partida manualmente","démarrer la partie manuellement","comienza la ronda manualmente","начать раунд вручную","手動開始遊戲","manualny start rundy","játék kézi indítása","raundu elle başlat"},
COMMAND_NEW ={"start a new round","inicia uma nova partida","démarrer une nouvelle partie","inicia una nueva ronda","начать новый раунд","開始新一輪遊戲","start nowej rundy","új kör indítása","yeni bir raunt başla"},
COMMAND_MAP ={"put a specific map","coloca um mapa específico","jouer une carte spécifique","pone un mapa en específico","поставить конкретную карту","用指定的圖","włącza konkretną mapę","megadott pálya berakása","belirli bir harita koy"},
COMMAND_RESET ={"reset the room score","zera a pontuação da sala","réinitialiser le score du salon","resetea la puntuación en la sala","сбросить счёт комнаты","重設房間分數","restartuje punkty w pokoju","a szoba pontszámának lenullázása","oda puanını sıfırla"},
COMMAND_KICK ={"kick a player from the round","tira um jogador da partida","éjecter un joueur de la partie","expulsa a un jugador de la ronda","выгнать игрока из раунда","把玩家從一局遊戲中踢除","wyrzuca gracza z tej rundy","játékos kirúgása a játékból","turdan bir oyuncu vur"},
COMMAND_BAN ={"ban a player from the room","bane um jogador da sala","bannir un joueur de la partie","sanciona a un jugador de la sala","забанить игрока в комнате","把玩家從房間裡 ban 掉","banuje gracza w tym pokoju","játékos kizárása a szobából","oyuncuyu odadan yasakla"},
COMMAND_UNBAN ={"unban a player","desbane um jogador","retirer le ban d'un joueur","remueve la sanción a un jugador","разблокировать игрока","解除被 ban 了的玩家","odbanowywuje gracza","játékos kizárásának feloldása","oyuncunun yasağını kaldır"},
COMMAND_ADM ={"give/revoke admin powers to a player","dá/tira poderes de administrador para um jogador","donner/retirer le pouvoir d'administrateur à un joueur","da/remueve poderes de administrador a un jugador","дать / отменить полномочия администратора для игрока","給予/撤銷 玩家房間管理能力","daje/wycofuje admina graczowi","admin képességek adása/elvétele játékosnak","bir oyuncuya yönetici yetkileri verme/iptal etme"},
COMMAND_CHAIR ={"put a player on a chair manually","coloca um jogador em uma cadeira manualmente","déplacer manuellement un joueur sur une chaise","pone a un jugador manualmente en un asiento","посадить игрока на кресло вручную","手動把玩家安排到座位上","umieszcza gracza w fotelu manualnie","játékos kézi leültetése","oyuncuyu manuel olarak sandalyeye oturtmak"},
COMMAND_PW ={"equal to /pw","igual ao /pw","équivaut à /pw","pone contraseña a la sala","равно /pw","跟 /pw 用途一樣","jak /pw","ugyanaz mint a /pw","eşit /pw"},
COMMAND_SPECTATOR ={"allows you to view the cards of every player, but you can't play","permite ver as cartas de todos os jogadores, mas você não pode jogar","vous permet de voir les cartes de chaque joueur, mais vous ne pouvez pas jouer","deja mirar las cartas de todos los jugadores, no podrás jugar con el comando activo","позволяет просматривать карты каждого игрока, но вы не можете играть","准許你可以查看所有玩家手中的卡牌, 但是你不能加入遊戲","pozwala obserwować karty wszystkich graczy, ale nie można grać","láthatod mások kártyáit, de te magad nem játszhatsz","her oyuncunun kartlarını görmenizi sağlar, ancak oynayamazsınız"},
PASSWORD ={"Password","Senha","Mot de passe","Contraseña","Пароль.","密碼","Hasło","Jelszó","Şifre "},
PASSWORD_REMOVED ={"Password disabled.","Senha desativada.","Mot de passe désactivé.","Contraseña desactivada","Пароль неправильный.","密碼解除了。","Wyłączone hasło","Jelszó kikapcsolva.","Şifre devre dışı."},
MANAGE_OWNER ={"%s is the room owner!","%s é o dono da sala!","%s est le maître du salon!","%s es el dueño de la sala!","%s владелец комнаты!","%s 是房主!","%s jest właścicielem pokoju.","%s a szoba tulajdonosa!","%s oda sahibi!"},
MANAGE_ADM ={"%s is now room manager.","%s agora é gerenciador da sala.","%s est maintenant maître du salon.","%s ahora es administrador de la sala.","%s сейчас менеджер комнаты.","%s 現在是房間管理員。","%s jest teraz pokojowym menadżerem.","%s mostmár szobakezelő.","%s şimdi oda yöneticisidir."},
MANAGE_ADM_REMOVE ={"%s is not room manager anymore.","%s não é mais gerenciador da sala.","%s n'est plus maître du salon.","%s ya no es más administador.","%s больше не менеджер комнаты.","%s 不再是房間管理員了。","%s nie jest już menadżerem.","%s már nem szobakezelő.","%s artık oda yöneticisi değil."},
MANAGE_KICK ={"%s kicked from round.","%s kickado da partida.","%s a été éjecté de la partie.","%s ha sido expulsado de la ronda.","%s выгнали из раунда.","%s 從遊戲中被踢除了。","%s został wyrzucony z bieżącej rundy.","%s kirúgva a játékból.","%s turdan atıldı."},
MANAGE_BAN ={"%s banned from room.","%s banido da sala.","%s a été banni du salon.","%s ha sido sancionado de la sala.","%s забанен в комнате.","%s 從房間中被踢除了。","%s został zbanowany w tym pokoju.","%s kitiltva a szobából.","%s odadan yasaklandı."},
MANAGE_UNBANED ={"%s unbanned from room.","%s desbanido da sala.","%s n'est plus banni du salon.","Se le ha removido la sanción a %s de la sala.","%s не забанен в комнате.","%s 的 ban 解除了。","%s został odbanowany w tym pokoju.","%s kitiltása feloldva.","%s odadan yasak kaldırıldı."},
UNO_FAIL ={"You did not say UNO!","Você não disse UNO!","Vous n'avez pas dit UNO!","¡No dijiste UNO!","Вы не сказали УНО!","你沒有說 UNO!","Nie powiedziałeś UNO!","Nem mondtál UNO-t!","UNO demedin!"},
DRAW_TWO ={"Discard a +2 or draw %s cards!","Descarte um +2 ou compre %s cartas!","Défaussez un +2 ou tirez %s cartes!","¡Descarta un +2 o toma %s cartas!","Сбросьте +2 или возьмите %s карт(ы)!","發出 +2 卡牌或是罰抽 %s 張卡!","Odrzuć +2 lub dobierz %s kart!","Játssz ki egy +2-t vagy húzz %s kártyát!"," +2 atın veya %s kart çekin!"},
DRAW_FOUR ={"Discard a +4, challenge or draw %s cards!","Descarte um +4, desafie ou compre %s cartas!","Défaussez un +2, défiez, ou tirez %s cartes!","¡Descarta un +4, desafía o toma %s cartas! ","Сбросьте +4, бросьте вызов или возьмите %s карт(ы)!","發出 +4 卡牌, 質疑 或是罰抽 %s 張卡!","Odrzuć +4, wyzwanie lub dobierz %s kart!","Játssz ki egy +4-et, hívd ki az előző játékost vagy húzz %s kártyát!","Bir +4 atın, meydan okuyun veya %s kart çekin!"},
DRAW_FOUR_ANTICHALLENGE ={"Discard a +4 or draw %s cards!","Descarte um +4 ou compre %s cartas!","Défaussez un +4 ou tirez %s cartes!","¡Descarta un +4 o toma %s cartas!","Сбросьте +4 или возьмите %s карт(ы)!","發出 +4 卡牌或是罰抽 %s 張卡!","Odrzuć +4 lub dobierz %s kart!","Játssz ki egy +4-et vagy húzz %s kártyát!","Bir +4 atın veya %s kart çekin!"},
DRAW_PLUS ={"Discard a card with + or draw %s cards!","Descarte uma carta com + ou compre %s cartas!","Défaussez une carte avec un + ou tirez %s cartes!","¡Descarta una carta con + o toma %s cartas!","Сбросьте карту с + или возьмите %s карт(ы)!","發出帶 + 號的卡或是罰抽 %s 張卡!","Odrzuć kartę z + lub dobierz %s kart!","Játssz ki egy kártyát + szimbólummal vagy húzz %s kártyát!"," + İşaretli bir kartı atın veya %s kart çekin!"},
DRAW_PLUS_FOUR ={"Discard a card with +, challenge or draw %s cards!","Descarte uma carta com +, desafie ou compre %s cartas!","Défaussez une carte avec un +, défiez, ou tirez %s cartes!","¡Descarta una carta con +, desafía o toma %s cartas!","Сбросьте карту с +, бросьте вызов или возьмите %s карт(ы)!","發出帶 + 號的卡, 質疑 或是罰抽 %s 張卡!","Odrzuć kartę z +, wyzwanie lub dobierz %s kart!","Játssz ki egy kártyát + szimbólummal, hívd ki az előző játékost vagy húzz %s kártyát!"," + İle bir kartı atın, meydan okuyun veya %s kart çekin! "},
DRAW_PLUS_FOUR_ANTICHALLENGE ={"Discard a card with + or draw %s cards!","Descarte uma carta com + ou compre %s cartas!","Défaussez une carte avec un + ou tirez %s cartes!","¡Descarta una carta con + o toma %s cartas!","Сбросьте карту с + или возьмите %s карт(ы)!","發出帶 + 號的卡或是罰抽 %s 張卡!","Odrzuć kartę z + lub dobierz %s kart!","Játssz ki egy kártyát + szimbólummal vagy húzz %s kártyát!"," + İşaretli bir kartı atın veya %s kart çekin!"},
DRAW_HELL ={"Discard an action card or draw %s cards!","Descarte uma carta de ação ou compre %s cartas!","Défaussez une carte action ou tirez %s cartes!","¡Descarta una carta de acción o toma %s cartas!","Сбросьте карту действий или возьмите %s карт(ы)!","發出行動卡牌或是罰抽 %s 張卡!","Odrzuć kartę akcji lub dobierz %s kart!","Játssz ki egy akciókártyát vagy húzz %s kártyát!","Bir eylem kartını atın veya %s kart çekin!"},
DRAW_HELL_FOUR ={"Discard an action card, challenge or draw %s cards!","Descarte uma carta de ação, desafie ou compre %s cartas!","Défaussez une carte action, défiez, ou tirez %s cartes!","¡Descarta una carta de acción, desafía o toma %s cartas!","Сбросьте карту действий, бросьте вызов или возьмите %s карт(ы)!","發出行動卡牌, 質疑 或是罰抽 %s 張卡!","Odrzuć kartę akcji, wyzwanie lub dobierz %s kart!","Játssz ki egy akciókártyát, hívd ki az előző játékost vagy húzz %s kártyát!","Bir aksiyon kartını atın, meydan okuyun veya %s kart çekin!"},
DRAW_HELL_FOUR_ANTICHALLENGE ={"Discard an action card or draw %s cards!","Descarte uma carta de ação ou compre %s cartas!","Défaussez une carte action ou tirez %s cartes!","¡Descarta una carta de accióm o toma %s cartas!","Сбросьте карту действий или возьмите %s карт(ы)!","發出行動卡牌或是罰抽 %s 張卡!","Odrzuć kartę akcji lub dobierz %s kart!","Játssz ki egy akciókártyát vagy húzz %s kártyát!","Bir eylem kartını atın veya %s kart çekin!"},
DRAW_CHALLENGE ={"Challenge or draw %s cards!","Desafie ou compre %s cartas!","Défiez ou défaussez %s cartes!","¡Desafía o toma %s cartas!","Бросьте вызов или возьмите %s карты(ы)!","質疑或是罰抽 %s 張卡!","Wyzwanie lub dobranie %s kart!","Hívd ki az előző játékost vagy húzz %s kártyát!","%s kartlarına meydan oku veya çek!"},
WARN_PERFECTION ={"Play again!","Jogue novamente!","Rejouez!","¡Juega otra vez!","Играть снова!","再發一張卡!","Zagraj ponownie!","Játssz még egyszer.","Tekrar oyna!"},
WARN_STACKING ={"Play more %s or pass your turn.","Jogue outros %s ou passe a vez.","Play more %s or pass your turn.","Juega más %s o pasa tu turno.","Играй больше %s или пропусти свой ход.","多發一張 %s 或是輪到下一個玩家。","Zagraj więcej %s lub przeczekaj kolejkę.","Játssz még %s kártyát vagy add át a kört.","Daha fazla %s oynayın veya sıranızı geçin."},
WARN_UP_DOWN ={"Play a numerical card with a value of either 1 higher or 1 lower, or pass your turn.","Jogue um número acima ou abaixo ou passe a vez.","Jouez une carte numérique d'une valeur supérieure ou inférieure de 1 ou passez votre tour.","Juega una carta numérica con un valor mayor o menor por uno, o pasa tu turno.","Сыграйте с цифровой картой со значением выше 1 или ниже 1, или пропустите ход.","發出一張數值比剛剛 多/少 1 的數字卡牌, 或是輪到下一個玩家。","Graj numerowaną kartą z wartością większą od 1 lub mniejszą od 1, albo oddaj swoją kolejkę.","Játssz egy számkártyát amely értéke eggyel kisebb vagy nagyobb, vagy add át a köröd.","1 veya daha yüksek bir değere sahip bir sayısal kart oynayın veya sıranızı geçin."},
WARN_UP ={"Play a numerical card with a value of 1 higher, or pass your turn.","Jogue um número acima ou passe a vez.","Jouez une carte numérique d'une valeur supérieure de 1, ou passez votre tour.","Juega una carta numérica con un valor superior por uno, o pasa tu turno.","Сыграйте с цифровой картой со значением выше 1 или пропусти ход.","發出一張數值比剛剛多 1 的數字卡牌, 或是輪到下一個玩家。","Graj numerowaną kartą z wartością większą od 1, albo oddaj swoją kolejkę.","Játssz egy számkártyát amely értéke eggyel nagyobb, vagy add át a köröd.","Değeri 1 daha yüksek olan bir sayısal kart oynayın veya sıranızı geçin."},
WARN_DOWN ={"Play a numerical card with a value of 1 lower, or pass your turn.","Jogue um número abaixo ou passe a vez.","Jouez une carte numérique d'une valeur inférieure de 1, ou passez votre tour.","Juega una carta numérica con un valor inferior por uno, o pasa tu turno.","Сыграйте с цифровой картой со значением ниже 1 или пропустите ход.","發出一張數值比剛剛少 1 的數字卡牌, 或是輪到下一個玩家。","Graj numerowaną kartą z wartośnią mniejszą od 1, albo oddaj swoją kolejkę.","Játssz egy számkártyát amely értéke eggyel kisebb, vagy add át a köröd.","Değeri 1 daha düşük olan bir sayısal kart oynayın veya sıranızı geçin."},
WARN_IMITATE ={"Perform this emote!","Imite essa expressão!","Faîtes cette émote!","¡Imita este emote!","Выполните эту эмоцию!","做出這個動作!","Wykonaj tę emotkę!","Fejezd ki ezt az érzést!","Bu ifadeyi gerçekleştir!"},
ONLY_NUMBERS ={"You can only play numerical cards on this turn.","Você pode jogar apenas cartas numéricas neste turno.","Vous ne pouvez jouer que des cartes numériques à ce tour.","Sólo puedes jugar cartas numéricas en este turno.","В этом ходу вы можете играть только с цифровыми картами.","你只可以在這回合發出數字卡牌。","Możesz grać tylko kartami z numerami w tej kolejce.","A körödben csak számkártyát játszhatsz.","Bu sırada yalnızca sayısal kartları oynayabilirsiniz."},
WELCOME_TEXT ={"<j>Welcome to <b>UNO!</b> Press <vp>H <j>to learn how to play. Wait for the next map to play.","<j>Bem vindo ao <b>UNO!</b> Pressione <vp>H <j>para aprender como jogar. Aguarde o próximo mapa para jogar.","<j>Bienvenue dans <b>UNO!</b> Appuyez sur <vp>H<j> pour apprendre à jouer. Attendez la prochaine partie pour jouer.","<j>¡Bienvenido/a a <b>UNO!</b> Presiona <vp>H <j>para aprender a jugar. Espera el siguiente mapa para jugar.","<j>Добро подаловать в <b>УНО!</b> Нажми <vp>H <j>чтобы научиться играть. Дождитесь следующей карты, чтобы играть.","<j>歡迎來到 <b>UNO!</b> 請按 <vp>H 鍵 <j>了解遊戲玩法。 請等待下一張圖來加入遊戲。","<j>Witaj w <b>UNO</b> Kliknij <vp>H<j> by poczytać jak grać. Zaczekaj do następnej mapy by zagrać.","<j>Üdvözlet az <b>UNO</b> játékban! Nyomd meg a <vp>H <j>betűt, hogy megismerkedj a játékszabályokkal. Várd meg a következő pályát, hogy játszhass.",""},
WELCOME_DISCORD ={"<j>Enter #unotfm Discord group to interact with other players and pick up on game news: <vp>%s","<j>Entre no grupo de #unotfm no Discord para interagir com outros jogadores e ficar por dentro de novidades do jogo: <vp>%s","<j>Rejoignez le groupe Discord d'#unotfm pour intéragir avec les autres joueurs et être au courant des nouveautés sur le jeu: <vp>https://discord.gg/xu5GVuj","<j>Entra al grupo de #unotfm en Discord para interactuar con otros jugadores y conocer antes todas las novedades: <vp>https://discord.gg/xu5GVuj","<j>Вступите в группу #unotfm Discord, чтобы взаимодействовать с другими игроками и получать новости об игре: <vp>https://discord.gg/xu5GVuj","<j>加入 #unotfm Discord 伺服器與其他玩家交流以及得到小遊戲最新的資訊: <vp>https://discord.gg/xu5GVuj","<j>Wejdź w grupę #unotfm na Discordzie, aby wchodzić w interakcje z innymi graczami i odbierać wiadomości z gry: <vp>https://discord.gg/xu5GVuj","<j>Lépj be az #unotfm Discord csoportba, hogy beszélgethess más játékosokkal, és elolvashasd a játékbeli híreket: <vp>https://discord.gg/xu5GVuj","<j>Diğer oyuncularla etkileşim kurmak ve oyun haberlerini almak için #unotfm Discord sunucusuna katılın: <vp>https://discord.gg/xu5GVuj"},
WARNING_SOURIS ={"Create an account on Transformice to be able to play in this room.","Crie uma conta no Transformice para poder jogar nesta sala.","Créez un compte sur Transformice pour pouvoir jouer dans ce salon.","Crea una cuenta en Transformice para que se te permita el acceso a jugar.","Создайте аккаунт в Transformice, чтобы иметь возможность играть в этой комнате.","註冊一個 Transformice 用戶來在這房間遊玩。","Załóż konto na Transformice by zagrać w tym pokoju.","Regisztrálj egy Transformice felhasználót, hogy ebben a szobában játszhass.","Bu odada oynayabilmek için Transformice'de bir hesap oluşturun."},
TIME_REMAINING ={"60 seconds remaining!","60 segundos restantes!","60 secondes restantes!","¡Quedan 60 segundos!","осталось 60 секунд!","剩下 60 秒!","Pozostało 60 sekund!","60 másodperc van hátra!","60 saniye kaldı!"},
WARNING_DATA ={"Your data was not loaded. Please reenter the room or return later.","Seus dados não foram carregados corretamente. Por favor reentre na sala ou volte mais tarde.","Vos données n'ont pas été chargées. Merci de partir et revenir, ou de rejoindre un peu plus tard.","Tus datos no han sido cargados. Por favor, entra nuevamente a la sala o regresa después.","Ваши данные не были загружены. Пожалуйста, войдите в комнату или вернитесь позже.","你的資料加載失敗。 請重新進入房間或是晚點再進來。","Twoje dane nie zostały wczytane. Proszę wrócić do pokoju za chwile lub później.","Nem tudtuk betölteni az adataid. Lépj be újra a szobába, vagy térj vissza később.","Verileriniz yüklenmedi. Lütfen odaya tekrar girin veya daha sonra geri dönün."},
CHAIR_UNLOCKED ={"You unlocked the chair '%s'!","Você desbloqueou a cadeira '%s'!","Vous avez débloqué la chaise \"%s\"!","¡La silla ''%s'' ha sido desbloqueada!","Вы разблокировали стул '%s'!","你解鎖了椅子 '%s'!","Odblokowałeś nowy fotel '%s'!","Feloldottad a következő trónt: '%s'!","%s' sandalyesinin kilidini açtınız!"},
RULE_UNLOCKED ={"You unlocked the rule '%s'!","Você desbloqueou a regra '%s'!","Vous avez débloqué la règle \"%s\"!","¡La regla ''%s'' ha sido desbloqueada!","Вы разблокировали правило '%s'!","你解鎖了規矩 '%s'!","Odblokowałeś zasadę '%s'!","Feloldottad a következő szabályt: '%s'!","%s' kuralının kilidini açtınız!"},
MEDAL_UNLOCKED ={"You unlocked a medal!","Você desbloqueou uma medalha!","Vous avez débloqué une médaille!","¡Has desbloqueado una medalla!","Вы разблокировали медаль!","你解鎖了一個獎牌!","Odblokowałeś medal!","Feloldottál egy medált!","Madalyayı açtın!"},
TIP_1 ={"Press the 'UNO!' button before playing your penultimate card.","Pressione o botão 'UNO!' antes de jogar sua penúltima carta.","Appuyez sur le bouton \"UNO!\" avant de jouer votre avant-dernière carte.","Presiona el botón de ''UNO!'' antes de jugar tu penúltima carta. ","Нажмите кнопку «УНО!», прежде чем ложить вашу предпоследнюю карту.","剩下最後二張卡牌的時候, 你在發牌之前應該先按 UNO 鍵。","Kliknij 'UNO' przed zagraniem twoją ostatnią kartą.","Nyomd meg az 'UNO!' gombot, mielőtt kijátszanád az utolsó előtti kártyád.",""},
TIP_2 ={"Click on the name of each rule to find out their meaning.","Clique nos nomes das regras para saber o que elas significam.","Cliquez sur le nom de chaque règle pour en savoir plus sur celles-ci.","Da clic en el nombre de cada regla para conocer su significado.","Нажмите на название каждого правила, чтобы узнать их значение.","點擊每一道規矩的名字來查看詳情。","Kliknij nazwę zasad by dowiedzieć się więcej.","Kattints a házszabályok neveire, hogy megtudd mit jelentenek.",""},
TIP_3 ={"The more you play, the more the delay to get a seat will increase.","Quanto mais partidas consecutivas você jogar, maior é o delay para pegar uma cadeira.","Plus vous jouez, plus le plus le délai pour obtenir une place augmentera.","Cuanto más juegues, el retraso al escojer un asiento incrementará.","Чем больше вы играете, тем больше будет увеличиваться задержка, чтобы получить место.","你玩的愈久, 你每局開始前坐下的緩衝時間愈久。","Jeśli grasz więcej, opóźnienie aby dostać krzesło wzrośnie.","Minél több játékot játszol egy huzamban, annál hosszabb ideig nem fogsz tudni leülni.",""},
TIP_4 ={"Clicking on the wrong card will show it to the other players.","Clicar em carta errada fará você mostrá-la para os outros jogadores.","Cliquer sur la mauvaise carte la montrera aux autres joueurs.","Darle clic a la carta equivocada hará que sea mostrada a los demás jugadores.","Нажатие на неправильную карту покажет её другим игрокам.","要是按到了不能發出的卡牌它就會顯示給其他人看。","Kliknięcie niewłaściwej karty poskutkuje pokazaniem jej innym graczom.","A helytelen kártyára kattintás felfedi a kártyát a többi játékosnak.",""},
TIP_5 ={"If you stay idle for 2 rounds, you'll lose your chair!","Se você ficar ausente por 2 turnos seguidos, você perde o seu lugar!","Si vous restez inactif pendant 2 rounds, vous perdrez votre chaise!","¡Si te quedas ausente por dos rondas, perderás tu silla!","Если вы будете бездействовать в течение 2 раундов, вы потеряете свое место!","如果你掛著超過 2 回合, 你會失去你的座位並從遊戲中踢出!","Jeśli będziesz afk podczas 2 kolejek stracisz krzesło!","Ha két körön át tétlen maradsz, elveszíted az ülőhelyed!",""},
TIP_6 ={"If someone leaves the game, you can sit on their chair before their turn.","Se alguém sair da partida, você pode pegar seu lugar até que seja a vez dele.","Si quelqu'un quitte la partie, vous pouvez vous asseoir sur leur chaise avant son tour.","Si alguien deja el juego, podrás sentarse en su silla antes de que toque su turno.","Если кто-то выйдет из игры, вы можете сесть на его место до своей очереди.","如果有人中途離開了遊戲, 你可以在輪到他的回合前坐上他的座位取代他。","Jeśli ktoś opuści grę możesz zająć jego miejsce.","Ha valaki elhagyja a játékot, leülhetsz a helyére a köre előtt.",""},
TIP_7 ={"Create your own UNO room with your rules by going to #unotfm0Yournickname","Crie sua própria sala de UNO com suas regras indo em #unotfm0Seunick","Créez votre propre salon UNO, avec vos propres règles en allant en #unotfm0Votrepseudo","Crea tu propia sala de UNO con tus propias reglas yendo a #unotfm0nombre#tag","Создайте свою собственную комнату УНО с вашими правилами, перейдя в #unotfm0ТвойПсевдоним","你可以到 #unotfm0(你的名字) 創建你自己的 UNO 房間並使用自己設定的規矩遊玩 。","Stwórz własny pokój UNO z twoimi zasadami idąc do #unotfm0TwójNick","Készíts saját UNO szobát saját szabályokkal: #unotfm0Sajátnév",""},
TIP_8 ={"Unlock house rules so you can use them in your private rooms.","Desbloqueie regras da casa para poder usar em suas salas privadas.","Débloquez des règles de la maison pour pouvoir les utiliser dans vos salons privés.","Desbloquea más reglas de la casa, las podrás usar en tus salas privadas.","Разблокируйте домашние правила, чтобы вы могли использовать их в своих комнатах.","解鎖自訂規矩之後你就可以在自己的私人房間裡使用。","Odblokuj domowe zasady których możesz używać w twoich prywatnych pokojach.","Ha feloldasz egy házszabályt, használhatod azt privát szobákban.",""},
TIP_9 ={"Challenge a +4 only when you believe someone has played it unnecessarily.","Desafie um +4 apenas quando você acredita que alguém jogou de propósito.","Défiez un +4 uniquement lorsque vous pensez que quelqu'un l'a joué inutilement.","Desafia un +4 solamente cuando creas que alguien la ha jugado innecesariamente.","Бросьте вызов +4, только если вы считаете, что кто-то сыграл без необходимости.","你只應該在相信有人不適當的發出了 +4 卡牌後才作出質疑。","Wyzwij +4 tylko wtedy kiedy uważasz że ktoś je niepotrzebnie rozegrał.","Csak akkor hívj ki egy +4-et ha szerinted valaki feleslegesen játszotta ki.",""},
TIP_10 ={"Zero is the only number that has no duplicates in the deck.","O zero é o único número que não possui duplicatas no baralho.","Zéro est le seul nombre qui n'a pas de double dans le jeu.","El cero es el único numero que no tiene duplicados en la baraja.","Ноль - это единственное число, которое не имеет дубликатов в колоде.","0 號卡牌是唯一一個在牌庫中沒有重複的數字卡牌。","Zero jest jedyną liczbą która nie ma duplikatu w talii.","Csak a nullás kártyákból nincs másolat a pakliban.",""},
TIP_11 ={"House rules can be unlocked in any room.","Regras da casa podem ser desbloqueadas em qualquer sala.","Les règles de la maison peuvent être débloquée dans n'importe quel salon.","Reglas de la Casa se pueden desbloquear en cualquier sala.","Домашние правила можно разблокировать в любой комнате.","自定規矩可以在任何 uno 房間中解鎖。","Domowe zasady można odblokować w każdym pokoju.","A házszabályokat bármely szobában fel lehet oldani.",""},
TIP_12 ={"Victories and chairs can only be obtained in rooms #unotfm1 to #unotfm9 with 4 or more players.","Vitórias e cadeiras só são adquiridos nas salas #unotfm1 até #unotfm9 com 4 ou mais jogadores.","Les victoires et les chaises peuvent être obtenues uniquement dans les salons #unotfm1 à #unotfm9 avec 4 joueurs ou plus","Victorias y sillas solamente pueden ser obtenidas en salas de #unotfm1 hasta #unotfm9 con cuatro o más jugadores.","Победы и кресла можно получить только в комнатах с #unotfm1 до #unotfm9 с 4 или более игроками.","勝利次數/資料 及椅子只可以在4人或以上的 #unotfm1 至 #unotfm9 房間裡得到。","Zwycięstwa i fotele mogą być odblokowywane tylko w pokojach #unotfm1 do #unotfm9 z 4 lub więcej graczy.","Győzelmeket és székeket csak 4 vagy több játékossal rendelkező, #unotfm1-től #unotfm9-ig terjedő tartományba tartozó szobákban lehet szerezni.",""},
TIP_13 ={"Are the visual effects confusing you? You can disable visual effects from Transformice's configuration menu.","Os efeitos visuais estão te atrapalhando? Desative-os nas configurações do Transformice.","Les effets visuels vous troublent ? Vous pouvez désactiver les effets visuels à partir du menu de configuration de Transformice.","¿Los efectos visuales te están confundiendo? Puedes desactivarlos en cualquier momento desde el menú de opciones de Transformice.","Вас смущают визуальные эффекты? Вы можете отключить их в меню конфигурации Transformice.","視覺效果讓你困擾? 你可以在 Transformice 的設置菜單裡關閉效果。","Wizualne efekty mylą cię? Możesz wyłączyć wizualne efekty w ustawieniach Transformice.","Megzavarnak a vizuális effektek és hatások? Kikapcsolhatod őket a Transformice beállításaiban.",""},
TIP_14 ={"Click on the top card on the table to see the previously played card underneath it.","Clique na carta da mesa para ver a carta que está por baixo.","Cliquez sur la carte du haut de la table pour voir la carte précédemment jouée en dessous.","Da clic en la carta superior de la tabla para ver la carta anteriormente jugada debajo de ella.","Нажмите на верхнюю карту на столе, чтобы увидеть под ней ранее сыгранную карту.","點按桌面翻開了的卡來查看下面之前發出的卡牌。","Kliknij na górną kartę na stole by zobaczyć wcześniej zagraną.","Kattints az asztalon lévő kártyára, hogy lásd az előtte kijátszott, alatta lévő kártyát.",""},
TIP_15 ={"Try memorizing the colors that your opponent doesn't have.","Procure memorizar cores que seus adversários não possuem.","Essayez de mémoriser les couleurs que vos adversaires n'ont pas.","Intenta memorizar los colores que tu oponente no tiene.","Попробуйте запомнить цвета, которых нет у вашего оппонента.","嘗試記著對手手中卡牌沒有的顏色。","Spróbuj zapamiętać kolory, których twój przeciwnik nie ma.","Próbáld meg megjegyezni, hogy milyen színnel nem rendelkeznek ellenfeleid.",""},
TIP_16 ={"If you press space repeatedly at the beginning of the game, your chances of getting a chair are reduced.","Pressionar espaço muitas vezes diminui suas chances de garantir seu lugar no início da partida.","Si vous appuyez sur espace plusieurs fois au début d'une partie, les chances d'avoir une chaise sont réduites.","Si precionas espacio repetidamente al inicio del juego, las posibilidades de que obtengas una silla se reducirán.","Если вы нажимаете пробел несколько раз в начале игры, ваши шансы получить место уменьшаются.","如果你在遊戲要開始之前一直按空格鍵, 你得到座位的機率會減少。","Jeśli naciśniesz spację na początku gry, twoje szanse na zdobycie fotela są ograniczone.","Ha a játék kezdetekor folyamatosan nyomkodod a szóközt, a székszerzési esélyeid csökkennek.",""},
TIP_17 ={"Complete objectives and win special chairs! Press C and click on a chair for more information about it.","Complete objetivos e adquira cadeiras especiais! Pressione C e clique nas cadeiras para mais informações.","Complétez vos objectifs et gagnez des chaises spéciales! Appuyez sur C et cliquez sur une chaise pour plus d'informations à son sujet.","¡Completa objetivos y gana sillas especiales! Presiona C y da clic en una silla para más información al respecto.","Выполняй задания и выигрывай специальные кресла! Нажмите C и нажмите на стул для получения дополнительной информации о нём.","達到指定要求來得到特別的椅子吧! 按 C鍵 及點擊椅子來查看它的資訊。","Spełniaj cele i wygrywaj specjalne fotele! Wciśnij C a następnie kliknij na wybrany fotel by zobaczyć informacje o nim.","Teljesíts célokat és nyerj érte különleges székeket! Nyomd meg a C betűt és kattints egy székre több információért.",""},
TIP_18 ={"Wild cards are worth 50 points, action cards 20 and numerical cards are worth the number they depict (0,1,2...9).","Curingas valem 50 pontos, cartas de ação valem 20 e cartas numéricas valem seus próprios números de face.","Les cartes noires valent 50 points, les cartes action valent 20 et les cartes numériques valent le nombre qui leur est affiché (0,1,2...9).","Las cartas comodín tienen un valor de cincuenta puntos, las cartas de acción veinte y las cartas numéricas tienen el valor del respectivo número que tienen.","Чёрные карты приносят 50 очков, карты действий 20 и цифровые карты приносят то число, которое они изображают (0,1,2...9).","換色卡牌價值 50 分數, 行動卡牌價值 20分數而數字卡牌價值牌等於上面的數字 (0,1,2...9)。","Karty Wild warte są 50 punktów, karty akcji 20, a karty z numerami są warte numerom (0,1,2...9).","A Színváltó kártyák 50 pontot értnek, az akciókártyák 20 pontot, és a számkártyák a rajtuk ábrázolt szám értékével rendelkeznek.",""},
TIP_19 ={"The Reverse card has the effect of the Skip card when there are only 2 players in the round.","A carta Reverter tem o efeito da carta Pular quando há somente 2 jogadores na partida.","","La carta de reversa tiene el efecto de la carta de omisión cuando hay dos jugadores en la ronda.","Обратная карта имеет эффект карты пропуска, когда в раунде всего 2 игрока.","反轉卡在只有兩個玩家的情況下有著跟跳過卡牌一樣的效果。","Karta zmiany ruchu ma podobny efekt jak karta pomiń, gdy w grze są tylko 2 gracze.","A Visszafordító kártya a Kimaradsz kártya hatását veszi fel 2 játékost tartalmazó játékokban.",""},
TIP_20 ={"If you have any doubts about the rules, press H.","Dúvidas sobre as regras? Pressione H.","Si vous avez des doutes à propos des règles, appuyez sur H.","Por cualquier duda respecto a las reglas, presiona H.","Если у вас есть какие-либо сомнения относительно правил, нажмите H.","如果你對規矩有疑惑, 可以按 H鍵 查看。","Jeśli masz wątpliwości co do zasad wciśnij H.","Ha kételyeid merülnének fel a szabályokkal kapcsolatban, nyomd meg a H betűt, hogy felhozd a segítség ablakot.",""},
TIP_21 ={"Do you want to know what a card does? Hold <b>Ctrl</b> and click on it!","Quer saber o que uma carta faz? Segure <b>Ctrl</b> e clique nela!","Vous voulez savoir ce qu'une carte fait? Appuyez sur <b>Ctrl</b> et cliquez dessus!","¿Quieres saber qué es lo que hace una carta? ¡Presiona <b>Ctrl</b> y cliquea en la cual desees conocer!","Вы хотите знать, что делает карта? Удержиайте <b>Ctrl</b> и нажмите на неё!","你想知道那一張卡牌可以幹嘛? 同時按著 <b>Ctrl</b> 及鼠標點擊它!","Chcesz wiedzieć co robi karta? Przytrzymaj klawisz <b>Ctrl</b> i kliknij na to!","Szeretnéd tudni mire képes egy kártya? Tartsd nyomva a <b>Ctrl</b> billentyűt és kattints rá!",""},
TIP_23 ={"Learn about the house rules by pressing U and clicking on their names.","Aprenda sobre as regras da casa pressionando U e clicando sobre os nomes delas.","Apprenez-en plus à propos des règles de la maison en appuyant sur U et en cliquant sur leur nom. Learn about the house rules by pressing U and clicking on their names.","Aprende las reglas de la casa presionando U y cliqueando en sus nombres.","Узнайте о домашних правилах, нажав U и на их имена.","按 U鍵 或點擊自訂規矩的名字來了解它們的內容。","Dowiedz się więcej o zasadach wciskając U i klikając nazwę zasady.","Ha szeretnél a házszabályokról tanulni, nyomd meg az U betűt, és kattints a nevükre.",""},
TIP_24 ={"Try to have as many available moves as possible.","Procure ter o maior número de possíveis jogadas na mão.","Essayez de pouvoir faire le plus de déplacements que possible.","Intenta tener la mayor cantidad de movimientos posibles.","Постарайтесь сделать как можно больше доступных ходов.","嘗試讓自己有多一些可行的方法來獲得勝利。","Staraj się miec jak najwięcej dostępnych ruchów jak to możliwe.","Próbálj úgy játszani, hogy minél több lehetséges lépéssel és lehetőséggel tudj élni.",""},
TIP_25 ={"You can see other players' profiles by typing !p [username] or by clicking on their names during a game.","Veja o perfil de outros jogadores digitando !p [nome] ou clicando no nome deles durante a partida.","Vous pouvez voir le profil des autres joueurs en tapant !p [pseudo] ou en cliquant sur leur pseudo pendant la partie.","Podrás ver el perfil de otros jugadores escribiendo !p [nombre] o cliqueando su nombre durante algún juego.","Вы можете просмотреть профили других игроков набрав !p [имя пользователя] или нажав на их имена во время игры.","你可以輸入 !p [玩家名稱] 或是在遊戲裡點擊他們的名字來查看他們的個人資料。","Profile innych graczy możesz zobaczyć wpisując !p [nick] lub klikając na nazwy podczas gry.","Mások profilját megtekintheted a !p [felhasználónév] paranccsal, illetve ha rákattintasz a nevükre játék közben.",""},
TIP_26 ={"Difficult to tell colors apart? Press O and activate colorblind mode to show symbols on the cards.","Dificuldades para diferenciar as cores? Pressione O e ative o modo daltônico para mostrar símbolos nas cartas.","","","","","","",""},
TIP_27 ={"When you show a card in Team Matches, only your partner can see it.","No Jogo em Duplas, as cartas que você mostra são visíveis apenas para sua dupla.","Quand vous montrez une carte dans une Partie en Équipe, seul votre coéquipier peut la voir.","Cuando muestras una carta en partidas en equipo, sólo tu compañero puede verla.","Когда вы показываете карту в Командной Игре, её может видеть только ваш партнёр.","當你在團隊模式中顯示卡牌, 只有你的搭檔才看的見。","Kiedy pokażesz kartę w Rundzie Drużynowej, tylko twój partnej może ją zobaczyć.","Ha felfedsz egy kártyát egy Csapatmérkőzésben, csak a társad láthatja.",""},
TIP_28 ={"Complete quests and earn tickets to spend at the #unotfm shop! Press N for more information.","Conclua missões e receba tickets para gastar na loja do #unotfm! Pressione N para mais informações..","","","","","","",""},
TIP_29 ={"Your favorite map will appear in the room if you are the player with the most points.","O seu mapa favorito aparecerá na sala caso você seja o jogador com mais pontos.","","","","","","",""},
TIP_30 ={"At the #unotfm shop you can buy chairs and rules, among other cool items!","Na loja do #unotfm você pode comprar cadeiras, regras, entre outros itens legais!","","","","","","",""},
TIP_31 ={"The shop offers 10 random items. The prices and the color of the ticket charged can be different every day!","A loja oferece 10 itens aleatórios. Os preços e a cor do ticket cobrado podem ser diferentes!","","","","","","",""},
TIP_32 ={"You receive a ticket for each victory and also randomly when playing games.","Você recebe um ticket por cada vitória e também alguns aleatoriamente ao jogar partidas.","","","","","","",""},
TIP_33 ={"#unotfm is a non-profit voluntary project. If you want to support it, visit the Credits area in the Menu.","O #unotfm é um projeto voluntário. Se você quiser apoiar, visite a área Créditos no Menu.","","","","","","",""},
TIP_34 ={"Consumables can be purchased at the #unotfm shop and provide you with some extra help.","Consumíveis podem ser comprados na loja do #unotfm e oferecem algumas ajudas para você.","","","","","","",""},
QUOTE_1 ={"welcome to my mansion","boas vindas à minha mansão","bienvenue dans mon manoir","bienvenido a mi mansión","добро пожаловать в мой особняк","歡迎來到我的大宅","witam w mojej rezydencji","üdvözöllek a kastélyomban",""},
QUOTE_2 ={"how about we bet candy?","que tal apostarmos doces?","et si on pariait des bonbons?","¿qué tal si apostamos caramelos?","как насчет ставок на конфеты?","我們來打賭糖果怎麼樣?","jak zakładamy sie o cukierki?","mit szólnál, ha cukorban fogadnánk?",""},
QUOTE_3 ={"I arrived well in time for the party","cheguei bem a tempo para a festa","je suis arrivé dans les temps pour faire la fête","llegué en buen momento para la fiesta","я прибыл вовремя на вечеринку","我剛好準時在派對開始前參加","Przybyłem dobrze w czasie na imprezę.","úgy néz ki éppen időben érkeztem a bulihoz",""},
QUOTE_4 ={"I hope you forgive me","espero que me perdoe","j'espère que tu me pardonneras","creo que te olvidastes de mí","я надеюсь ты меня простишь","我希望你會原諒我","Mam nadzieję, że mi wybaczysz","remélem meg tudsz nekem bocsátani",""},
QUOTE_5 ={"nice try","boa tentativa","bien essayé","buen intento","хорошая попытка","不錯的嘗試","Niezła próba","szép próbálkozás",""},
QUOTE_6 ={"mmmph mph","","","hmmmmm hmmm","ммм ","嗯嗯呃 呃","",""},
QUOTE_7 ={"%s plays worse than Buffy","%s joga pior que a Buffy","Buffy joue mieux que %s","%s juega peor que Buffy","%s играет хуже Buffy","%s 比 Buffy 玩的還要糟糕","%s gra gorzej niż Buffy","%s rosszabbul játszik mint Buffy",""},
QUOTE_8 ={"arggh!","","аргх!","啊呀!","",""},
QUOTE_9 ={"easy game","fácil fácil","c'était facile","juego sencillo","лёгкая игра","真容易","łatwa gra","könnyű",""},
QUOTE_10 ={"did anyone doubt my victory?","alguém duvidava da minha vitória?","quelqu'un a-t-il douté de ma victoire?","¿acaso alguien duda de mi victoria?","кто-нибудь сомневался в моей победе?","有人要否定我的勝利嗎?","Ktoś wątpił w moje zwycięstwo?","volt bárki, aki kételkedni mert a győzelmemben?",""},
QUOTE_11 ={"this was a scheme! I want a rematch","isso foi complô! quero revanche","c'était un coup monté! je veux une revanche","¡esto es culpa del sistema! exijo una revancha","это была схема! я хочу реванш","這只是我計劃的一部分! 我要重來一局","to była fabuła! Chcę rewanżu","ez csak egy csel volt! új játékot követelek",""},
QUOTE_12 ={"my cards are great","minhas cartas estão ótimas","mes cartes sont intéressantes","mis cartas son buenas","мои карты великолепны","我手上的卡牌真棒","moje karty są świetne","a kártyáim remekek",""},
QUOTE_13 ={"#!@%","","","","","","","",""},
QUOTE_85 ={"beginners' luck","sorte de principiante","la chance du débutant","suerte de principiante","новичкам везёт","新手運吧","fart","kezdő szerencséje",""},
QUOTE_86 ={"treachery!","na trairagem","triche!","¡traición!","предательство!","你背叛我!","zdrada!","árulás!",""},
QUOTE_87 ={"ok, sweetie","tá bem, meu amor","ok, ma puce","ok, cariño","хорошо, милая","很好, 寶貝","ok, kochanie","rendben, édesem",""},
QUOTE_14 ={"does anyone need help?","alguém precisa de ajuda?","quelqu'un a besoin d'aide?","¿nadie me quiere ayudar?","кому-нибудь нужна помощь?","有人需要幫忙嗎?","czy ktoś potrzebuje pomocy?","szüksége van valakinek segítségre?",""},
QUOTE_15 ={"uhu, I knew we could do it!","uhu, eu sabia que nós conseguiríamos!","huhu, je savais qu'on pouvait le faire!","¡huu, sabía que podíamos hacerlo!","юхуу, я знала, что мы можем это сделать!","呃, 我知道我們做的到!","uhu, wiedziałam, że możemy to zrobić!","uhu, tudtam hogy menni fog nekünk!",""},
QUOTE_16 ={"good job!","mandou bem!","bien joué!","¡buen trabajo!","хорошая работа!","做的好!","dobra robota!","szép munka!",""},
QUOTE_17 ={"merry christmas! give me presents","feliz natal! doem presentes para mim","joyeux noël! donnez moi des cadeaux!","¡feliz navidad! denme mis regalos","счастливого Рождества! подарите мне подарки","聖誕快樂! 快給我禮物","wesołych świąt! dajcie mi prezenty","boldog karácsonyt! kérem az ajándékokat!",""},
QUOTE_18 ={"no presents for you, you phoney Santa Claus!","nada de presentes para você, seu papai noel fajuto!","pas de cadeaux pour toi, faux Père Noël !","no hay regalos para ti, ¡tú... falso Santa Claus!","нет подарков для тебя, ты фальшивый Санта-Клаус!","沒有給你的禮物, 你這假聖誕老人騙子!","żadnych prezentów dla ciebie, ty fałszywy Święty Mikołaju!","nem érdemelsz ajándékot, te kis hamis Télapó!",""},
QUOTE_19 ={"hohoho! merry christmas!","hohoho! feliz natal!","hohoho! joyeux noël!!","¡hohoho! ¡feliz navidad!","хо-хо-хо! счастливого Рождества!","呵呵呵! 聖誕快樂!","hohoho! wesołych świąt!","hohoho! boldog karácsonyt!",""},
QUOTE_20 ={"I thought you were just something grown-ups created to make us behave","achei que você era só uma invenção para sermos bons ratinhos","","pensé que solo eres alguien mayor hecho para hacernos comportarnos","я думал, что ты просто взрослый человек, созданный, чтобы заставить нас вести себя взрослее","我以為你只是為了讓我們乖乖聽話而塑造的人物","Myślałem, że jesteś kimś dorosłym stworzonym po to, abyśmy się zachowywali","Azt hittem te csak egy dolog vagy amelyet a felnőttek készítettek, hogy fogadjunk szót",""},
QUOTE_21 ={"I thought you were just selling trinkets in room 801","e eu achei que você só vendia muambas na sala 801","je croyais que tu vendais des babioles dans le salon 801","pensé que solo estabas vendiendo trincheras en la sala 801","я думал, что ты просто продавал безделушки в комнате 801","我以為你只是在 801 房間賣廉價裝飾品的小鼠","Myślałem, że sprzedajesz ozdóbki w pokoju 801","Azt hittem bizsut árulsz a 801-es szobában",""},
QUOTE_22 ={"I'm the real Transformice Christmas NPC","eu que sou o verdadeiro NPC de natal do Transformice","je suis le vrai PNJ de noël sur Transformice","soy el verdadero NPC de navidad de Transformice","я настоящий Рождественский Transformice NPC","我是 Trasnformice 真正的聖誕 NPC","Jestem prawdziwym Myszkowym Świątecznym NPC","Én vagyok az igazi Transformice Karácsonyi NPC",""},
QUOTE_23 ={"so why does nobody remember you?","então por que ninguém lembra de você?","alors pouquoi personne se souvient de toi?","¿por qué nadie te recuerda?","так почему никто не помнит тебя?","那為什麼沒有人記得你?","więc czemu nikt ciebie nie pamięta? ","nos, miért nem emlékszik rád senki?",""},
QUOTE_24 ={"why don't you go back to your shop?","por que você não volta para sua loja?","pourquoi ne retournes-tu pas à ton magasin?","¿por qué no te regresas a tu tienda?","почему бы тебе не вернуться в свой магазин?","為什麼你不回去你的店鋪繼續工作?","czemu nie wrócisz do swojego sklepu?","miért nem mész vissza a boltocskádba?",""},
QUOTE_25 ={"presents for everyone!","presentes para todos!","cadeaux pour tout le monde!","¡regalos para todos!","подарки для всех!","給所有人的聖誕禮物!","prezenty dla wszystkich!","ajándékok mindenkinek!",""},
QUOTE_26 ={"yay","oba","","","ура","好棒","jej","",""},
QUOTE_27 ={"except for you","menos para você","sauf pour toi","excepto para ti","кроме тебя","除了你","oprócz ciebie","kivéve neked",""},
QUOTE_28 ={"%s behaved this year","%s se comportou muito bem neste ano","%s s'est bien comportée cette année","%s se portó bien este año","%s хорошо вёл себя в этом году","%s 今年有好好聽話哦","%s zachowywał się w tym roku","%s idén jól viselkedett",""},
QUOTE_29 ={"thank you! you are very kind","obrigado! você é muito gentil","merci! tu es très gentil","¡gracias! ¡eres muy amable!","благодарю тебя! ты очень добрый","謝謝! 你人真好","dziękuje! jesteś bardzo miły!","köszönöm! nagyon kedves tőled",""},
QUOTE_30 ={"why, you...","ora, seu...","pourquoi, tu...","por qué, tú...","почему, ты...","為什麼, 你...","czemu, ty...","miért, te kis...",""},
QUOTE_31 ={"humph!","","","","гм!","碰!","","",""},
QUOTE_32 ={"thank you, but I'll leave this gift for %s","agradeço, mas vou deixar este presente para %s","merci, mais je laisserai ce cadeau à %s","gracias, pero dejaré este regalo para %s","спасибо, но я оставлю этот подарок для %s","謝謝, 但我會把這禮物送給 %s","dziękuję, ale dam ten prezent %s","köszönöm, de ezt az ajándékot inkább meghagyom %s számára",""},
QUOTE_33 ={"thanks for the gift, but I'd rather win","obrigado pelo presente, mas eu prefiro ganhar","merci pour le cadeau, mais je préfère gagner","gracias por el regalo, pero prefiero ganar","спасибо за подарок, но лучше бы я выиграл","謝謝你的禮物, 可是我比較想勝出這局遊戲","dziękuje za prezent, ale wole wygrać","köszönöm az ajándékot, de inkább nyernék",""},
QUOTE_34 ={"thanks for the gift, guys! merry christmas!","obrigado pelo presente, pessoal! feliz natal!","merci pour le cadeau les gars! joyeux noël!","¡gracias por el regalo, chicos! ¡feliz navidad!","спасибо за подарок, ребята! счастливого Рождества!","謝謝你的禮物, 各位! 聖誕快樂!","dziękuje za prezent, chłopaki! wesołych świąt!","köszönöm az ajándékot, srácok! boldog karácsonyt!",""},
QUOTE_35 ={"now go back to your toys!","agora volte para seus brinquedinhos!","maintenant retournes à tes jouets!","¡ahora de vuelta a jugar!","теперь возвращайся к своим игрушкам!","現在你們繼續玩吧!","teraz wracaj do swoich zabawek!","most pedig menj szépen vissza a játékaidhoz!",""},
QUOTE_36 ={"great victory! thanks guys!","grande vitória! obrigado gente!","belle victoire! merci les gars!","¡gran victoria! ¡gracias chicos!","отличная победа! спасибо, ребята!","真是精彩的勝利! 謝謝各位!","wielkie zwycięstwo! dzięki chłopaki!","szép győzelem! köszönöm, srácok!",""},
QUOTE_37 ={"you didn't deserve this!","você não merecia isso!","tu ne méritais pas ça!","¡tú no mereces esto!","ты этого не заслужил!","你才不值得勝利!","nie zasłużyłeś na to!","te nem ezt érdemelted volna!",""},
QUOTE_38 ={"zzzz...","","","","","","","",""},
QUOTE_39 ={"nom nom...","nam nam...","miam miam...","","ням ням...","呼 噢...","","",""},
QUOTE_40 ={"what, are we playing?","ué, estamos jogando?","quoi, est-ce qu'on joue?","¿qué? ¿estamos jugando?","что? мы играем?","什麼, 我們在玩嗎?","chwila, gramy?","hogy mi, már megy a játék?",""},
QUOTE_41 ={"did you start without me?","começaram sem mim?","as-tu commencé sans moi?","¿empezastes sin mí?","ты начал без меня?","你剛剛沒等我就開始了遊戲?","zaczeliście beze mnie?","elkezdtétek nélkülem?",""},
QUOTE_42 ={"it started? but no one warned me","começou? mas ninguém me avisou","ça a commencé? personne ne m'a prévenu","¿empezó? pero si nadie me había dicho","игра началась? но никто не предупредил меня","遊戲開始了? 可是沒有人提醒我","zaczęło się? nikt mnie nie ostrzegł","elkezdődött? de senki sem figyelmeztetett",""},
QUOTE_43 ={"it's over already?","já acabou?","c'est déjà fini?","¿ya se acabó?","все уже кончено?","已經完結了嗎?","to już koniec?","máris vége?",""},
QUOTE_44 ={"I was not prepared!","eu não estava preparada!","j'étais pas prête!","¡no estaba preparada!","я не был готова!","我還沒有準備!","Nie byłam gotowa!","nem voltam felkészülve!",""},
QUOTE_45 ={"I won!","ganhei!","j'ai gagné!","¡gané!","я победила!","我勝出了!","Wygrałam!","én nyertem!",""},
QUOTE_46 ={"now I'm going to take a... zzzz","agora eu vou tirar um... zzzz","maintenant je vais faire une... zzzz","ahora me voy a... zzzz","теперь я собираюсь взять... zzzz","現在我要去睡一下了... zzzz","teraz wezmę... zzzz","most pedig lefekszek kicsit... zzzz...",""},
QUOTE_47 ={"let me play!","deixa eu jogar!","laisse moi jouer!","¡déjame jugar!","дай мне поиграть!","讓我玩嘛!","daj mi zagrać!","hadd játsszak én is!",""},
QUOTE_48 ={"one less","menos um","un de moins","uno menos","на одного меньше","還差一個","jeden mniej","eggyel kevesebb!",""},
QUOTE_49 ={"so close, but I am prepared","quase, mas estou preparada","si proche, mais je suis prête","muy cerca, pero estoy preparada","так близко, но я готова","差點, 不過我已經準備好了","tak blisko, ale jestem przygotowana","közeli, de fel vagyok készülve",""},
QUOTE_50 ={"I AM ALREADY AWAKE","JÁ ESTOU ACORDADA","JE SUIS DÉJÀ RÉVEILLÉE","ESTOY DESPIERTA OK","Я УЖЕ ПРОСНУЛАСЬ","我.已.經.醒.來.了.","JUŻ SIĘ OBUDZIŁAM","MÁR ÉBREN VAGYOK",""},
QUOTE_51 ={"it's not fair!","não é justo!","c'est pas du jeu!","¡no es justo!","это нечестно!","這不公平!","to niesprawiedliwe!","nem ér!",""},
QUOTE_52 ={"thanks ^^","obrigada ^^","merci ^^","gracias ^^","спасибо ^^","謝謝 ^^","dzięki ^^","köszönöm ^^",""},
QUOTE_53 ={"%s is gone","%s se foi","%s est parti","%s está perdido","%s ушёл","%s 離開了","%s zniknął","%s eltűnt",""},
QUOTE_54 ={"welcome to my temple!","boas vindas ao meu templo!","bienvenue dans mon temple!","¡bienvenido/a a mi templo!","добро пожаловать в мой храм!","歡迎來到我的廟宇!","witam w mojej świątyni!","üdvözöllek a templomomban!",""},
QUOTE_55 ={"today you will be put to the test!","hoje vocês serão colocados a prova!","aujourd'hui tu seras mis à l'épreuve!","¡hoy serán puestas a prueba tus capacidades!","сегодня вас будут проверять!","今天你要面對一個挑戰!","dzisiaj zostaniecie wystawieni na próbę!","a mai napon te teszel megmérettetve!",""},
QUOTE_56 ={"get ready!","estejam preparados!","prépare-toi!","¡prepárate!","приготовьтесь!","準備囉!","przygotujcie się!","készülj fel!",""},
QUOTE_57 ={"a penalty for anyone who dares to touch the sacred deck!","uma penalidade para quem ousar tocar no baralho sagrado!","une penalité pour tous ceux qui osent toucher le jeu sacré!","¡le daré una penalización a quien se atreva a tocar el mazo sagrado!","наказание для тех, кто осмелится прикоснуться к священной колоде!","誰敢碰那可怕的牌庫誰就會得到懲罰!","kara dla każdego, kto ośmieli się dotknąć świętej talii!","büntetés azoknak, akik hozzá mernek érni a szent paklihot!",""},
QUOTE_58 ={"winter has come! supplies are scarce!","o inverno chegou! os suprimentos estão escassos!","l'hiver est arrivé! les provisions se font rares!","¡el invierno arrivó! las reservas se agotan...","зима пришла! запасы ограничены!","冬天來了! 資源變稀少了!","nadeszła zima! dostawy są rzadkością!","a tél megérkezett! az ellátmányok szűkösek",""},
QUOTE_59 ={"peace? anything but that","paz? quase isso","paix? tout sauf ça","¿paz? todo menos eso","мир? что-нибудь кроме этого","和平? 除了這個其他的都沒所謂","pokój? cokolwiek ale to","békesség? bármit, csak azt nem",""},
QUOTE_60 ={"deja vu","","déjà vu","déjà vu","дежавю","deja vu (幻覺記憶)","","",""},
QUOTE_61 ={"hurry up! time is running out!","se apressem! o tempo está acabando!","dépèche-toi! le temps presse!","¡arriba! ¡es tiempo de marcharse!","поторопись! время идёт!","快點! 要沒時間了!","szybciej! czas się kończy!","siess! fogy az időd!",""},
QUOTE_62 ={"don't lose control!","não percam o controle!","ne perds pas le contrôle!","¡no pierdas el contro!l","не теряй контроль!","別失去理智!","nie trać kontroli!","ne veszítsd el az irányítást",""},
QUOTE_63 ={"you are not ready","vocês não estão prontos","tu n'es pas prêt","no es suficiente","ты не готов","你還沒有準備好","nie jesteś gotowy","nem állsz készen",""},
QUOTE_64 ={"better luck next time!","mais sorte da próxima vez!","plus de chance la prochaine fois!","¡buena suerte la próxima vez!","повезёт в следующий раз!","祝你下次好運!","następnym razem będzie lepiej!","sok sikert legközelebb!",""},
QUOTE_65 ={"%s will be a great shaman!","%s será um ótimo shaman!","%s va être un excellent chamane!","¡%s será una gran chamán!","%s будет великим шаманом!","%s 將會成為一個強大的薩滿!","%s będzie świetnym szamanem!","%s kitűnő sámán lesz!",""},
QUOTE_66 ={"I'm mad, even though I shouldn't be","acho que estou sentindo raiva, mas eu não deveria","Je suis en colère, même si je ne devrais pas l'être","creo que estoy enfurecida, no debería de estarlo","я злюсь, хотя я не должна быть такой","我要抓狂了, 雖然我不應該這樣","Myślę, że jestem wściekły, a nie powinienem być","mérges vagyok, pedig nem kellene annak lennem",""},
QUOTE_67 ={"%s unlocked the title «Adorer»","%s desbloqueou o título «Adorador»","%s a débloqué le titre «Adorer»","%s ha desbloqueado el título «Adorador»","%s разблокировал титул «Обожатель»","%s 解鎖了稱號 «偶像»","%s odblokował tytuł «Wielbiciel»","%s megszerezte a(z) «Imádó» címet.",""},
QUOTE_68 ={"or not","só que não","ou pas","o no","или нет","不然呢","albo nie","vagy nem",""},
QUOTE_69 ={"hey, how dare you!","ei, como ousa!","eh! comment oses-tu!","hey, ¡cómo pudiste!","эй, как ты смеешь!","喂, 你竟敢這樣對我!","hej, jak mogłeś! ","hé, hogy merészeled!",""},
QUOTE_70 ={"did you play this card on me? suffer the wrath of the sacred cannon!","jogaste esta carta em mim? sofra com a ira do cannon sagrado!","as-tu joué cette carte sur moi? did you play this card on me? subis la colère du canon sacré!","¿acabas de jugar esa carta en mí? ¡ahora sufrirás el dolor del cañón sagrado!","ты положил эту карту мне? терпи гнев священной пушки!","你剛剛是向我發出了這張卡嗎? 承受被嚇倒而憤怒的炮彈的反擊吧!","użyłeś tej karty na mnie? ponieś gniew świętej armaty!","ellenem merészelted játszani ezt a kártyát? tapasztald meg a szentelt ágyúgolyó haragját!",""},
QUOTE_71 ={"it could have been a better curse...","podia ter vindo uma maldição melhor...","ça aurait pu être une meilleure malédiction...","pudo ser una mejor maldición...","это могло быть лучшее проклятие...","那個本來可以是更好的詛咒...","mogło to być lepsze przekleństwo ...","lehetett volna valami jobb átok is...",""},
QUOTE_72 ={"you have a good taste for appearances, %s!","você tem um bom gosto para visuais, %s!","tu as un bon goût pour les apparences, %s!","¡tienes un buen gusto por las apariencias, %s!","у тебя хороший вкус к внешнему виду %s!","%s, 你對時裝的品味真好!","masz dobry gust do występów, %s!","remek divatérzéked van, %s!",""},
QUOTE_73 ={"we have visitors!","oba temos visitas!","on a des visiteurs!","¡tenemos visitantes!","у нас есть посетители!","我們有訪客了!","mamy gości!","látogatóink vannak!",""},
QUOTE_74 ={"no bets! don't you remember what happened the last time?","nada de apostas! você sabe o que aconteceu da última vez","pas de paris! tu ne te souviens pas de ce qui s'est passé la dernière fois?","¡sin apuestas! ¿no recuerdas lo que ocurrió la última vez?","нет ставок! ты не помнишь, что случилось в прошлый раз?","別打賭! 你忘記了上次的事嗎?","bez zakładów! nie pamiętasz, co się stało ostatnim razem?","nincs fogadás! nem emlékszel mi történt legutóbb?",""},
QUOTE_75 ={"I will never forgive you!","eu não vou perdoar!","Je ne te pardonnerai jamais !","¡nunca te lo perdonaré!","я никогда не прощу тебя!","我不會原諒你的!","Nigdy Ci nie wybaczę!","soha nem bocsátok meg neked!",""},
QUOTE_76 ={"my mother was right, I shouldn't have married a vampire","minha mãe estava certa, eu não devia ter casado com um vampiro","ma mère avait raison, je n'aurais pas du me marier avec un vampire.","mi madre tenía razón, nunca debí casarme con un vampiro","моя мама была права, я не должен был жениться на вампире","我媽說的對, 我不應該嫁給一個吸血鬼","moja matka miała rację, nie powinnam była poślubić wampira","az anyukámnak igaza volt, nem kellett volna hozzámennem egy vámpírhoz",""},
QUOTE_77 ={"calm down, honey, it's just a game","calma, meu amor, é só um jogo","du calme, chéri, ce n'est qu'un jeu.","cálmate amigo, es sólo un juego","успокойся, милая, это просто игра","放輕鬆點, 寶貝, 這只是一個遊戲","uspokój się, kochanie, to tylko gra","nyugodj meg, édesem, ez csak egy játék",""},
QUOTE_78 ={"but they're still better than you","mas ainda não chega aos seus pés","mais ils sont toujours meilleurs que toi","pero ellos no son oponentes dignos para ti","но они все равно лучше тебя","可是他們還是比你玩的更好","ale one nie pasują do ciebie","de még mindig jobbak nálad",""},
QUOTE_79 ={"congratulations, my love","parabéns, meu amor","félicitations, mon amour","felicidades, mi amor","поздравляю, моя любовь","恭喜, 我親愛的","gratulacje, kochanie","gratulálok, szerelmem",""},
QUOTE_80 ={"can you choose what to draw? people, he's cheating!","você pode escolher o que vai comprar? gente ele tá trapaceando!","tu peux choisir la carte à tirer? les gens, c'est un tricheur!","¿puedes elegir que sortear? ¡gente, está haciendo trampa!","ты можешь выбрать, что взять? люди, он обманывает!","你可以選擇要抽到什麼卡? 各位, 他在作弊!","czy możesz wybrać to co chcesz dobrać? ludzie, on oszukuje!","kiválaszthatod mit húzol fel? emberek, egy csaló!",""},
QUOTE_81 ={"I'm beginning to get the hang of it","já estou começando a pegar o jeito","je commence à m'y faire","estoy empezando a entender esto","я начинаю понимать это","我開始知道它的竅門了","Zaczynam rozumieć to","kezdem érteni a lényegét",""},
QUOTE_82 ={"is that how you play?","é assim que se joga?","est-ce comme ça que tu joues?","¿así es como juegas?","так ты играешь?","這就是你的玩法?","to właśnie tak byś zagrał? ","szóval úgy kell játszani?",""},
QUOTE_83 ={"ok, now go take care of Voldemouse, he's crying","ok, agora vá cuidar do Voldemouse, ele está chorando","ok, maintenant, va t'occuper de Voldemouse, il est en train de pleurer","bien, ahora ve a consolar a Voldemouse, está llorando","хорошо, теперь иди позаботься о Voldemouse, он плачет Voldemouse","好的, 現在去照顧一下 Voldemouse, 他在哭了","ok, teraz zajmij się Voldemousem, on płacze","rendben, most figyelj oda Voldemouse-ra, elkezdett sírni",""},
QUOTE_84 ={"uno! hahahahaha","","","","уно! ахахахаха","uno! 哈哈哈哈哈","",""},
QUOTE_88 ={"this cave is melting, we'd better finish soon!","esta caverna está derretendo, melhor terminarmos logo!","cette cave est en train de fondre, on devrait terminer au plus tôt!","¡esta cueva se está derritiedo, deberíamos salir de aquí!","эта пещера тает, нам лучше поторопиться!","這個洞穴在融化, 我們最好快點把這局遊戲完結掉!","ta jaskinia topnieje, lepiej już niedługo kończyć!","olvadozik a barlang, fejezzük be minél hamarabb!",""},
QUOTE_89 ={"welcome to my house! I don't remember typing /inv...","bem vindos ao meu cafofo! ué eu não lembro de ter dado /inv...","bienvenue chez moi! je me souviens pas avoir tapé /inv...","¡bienvenido/a a mi casa! no me acuerdo de haber escrito /inv...","добро пожаловать ко мне домой! Я не помню как печатать /inv...","歡迎來到我家! 我記得我沒有輸入 /inv...","Witamy w moim domu! Nie pamiętam pisania / inv ...","üdvözöllek a házamban! nem emlékszem hogy beírtam volna hogy /inv...",""},
QUOTE_90 ={"how kind of you, %s!","bondade a sua, %s!","comme c'est gentil de ta part, %s!","¡cómo pudiste, %s!","how kind of you, %s!","%s, 你人真好!","jak miło z twojej strony, %s!","mily kedves tőled, %s!",""},
QUOTE_91 ={"I'm just a snowmouse, I can't hold so many cards!","sou só um boneco de neve, não posso segurar tantas cartas!","je ne suis juste qu'une souris de neige, je ne peux pas tenir autant de cartes!","sólo soy un ratón de nieve, ¡no puedo tener tantas cartas!","я просто снежная мышка, я не могу держать столько карт!","我只是一個雪鼠, 我手拿不到那麼多卡牌啦!","Jestem tylko myszką ze śniegu, nie mogę trzymać tak wielu kart!","én csak egy szerény hóegér vagyok, nem tudok annyi kártyát tartani",""},
QUOTE_92 ={"is there a title with my name?","será que existe um título com meu nome?","il y a un titre avec mon nom?","¿hay un título con mi nombre?","есть ли титул с моим именем?","是不是有一個稱號用上我的名字了?","czy istnieje tytuł z moim imieniem?","létezik egy cím a nevemmel?",""},
QUOTE_93 ={"you're so quiet... let's break the ice, people!","vocês estão tão calados... vamos quebrar esse gelo galera!","vous êtes si silencieux... brisons la glace, tout le monde!","estás muy tieso... ¡hay que romper el hielo, gente!","вы такой тихие... давайте сломаем лёд, люди!","你真安靜... 我們來玩個破冰遊戲吧, 各位!","jesteś taki cichy ... pora przełamać lód, ludzie!","annyira csendesek vagytok.. törjük fel a jeget, emberek!",""},
QUOTE_94 ={"...","","","","","","","",""},
QUOTE_95 ={"I think I'm melting!","acho que estou derretendo!","je crois que je fond!","¡creo que me estoy derritiendo!","я думаю, что я таю!","我覺得我在融化了!","Myślę, że topnieję!","úgy tűnik olvadok!",""},
QUOTE_96 ={"great game! visit more often!","ótimo jogo! venham mais vezes!","super jeu! rends moi visite plus souvent!","¡buen juego! ¡visita más seguido!","отличная игра! приходите чаще!","好一場遊戲! 多點來探望我吧!","świetna gra! odwiedzaj częściej!","remek játék! meglátogathatnál gyakrabban!",""},
QUOTE_97 ={"oh, no! %s's cards got wet!","oh, não! as cartas de %s molharam!","oh, non! les cartes %s sont mouillées!","¡oh no! ¡las cartas de %s se mojaron!","ох, нет! у %s's промокли карты!","噢, 不! %s 的卡牌都濕透了!","o nie! Karty %s zamoczyły się!","ó ne, %s kártyái benedvesedtek!",""},
QUOTE_98 ={"Papaille? don't talk to me about him! he sells canned snowmen...","Papaille? não me fale dele! ele vende bonecos de neve enlatados...","Papaille? ne me parle pas de lui, il vend des bonhommes de neige en conserve...","¿Papaille? ¡no me hables de él! vende hombres de nieve enlatados...","Papaille? не говори со мной о нём! он продает консервированных снеговиков...","Papaille? 不要跟我說到他! 他售賣罐裝雪人...","Papaille? nie mów mi o nim! sprzedaje puszkowane bałwany ...","Papaille? ne beszélj róla hozzám, konzerv hóembereket árul...",""},
QUOTE_99 ={"nice title, %s!","título legal, %s!","joli titre, %s!","¡buen título, %s!","хороший титул, %s!","%s, 你的稱號不錯啊!","niezły tytuł, %s!","szép cím, %s!",""},
QUOTE_100 ={"Jingle is too busy sending mice to fetch things for him","Jingle está muito ocupado mandando ratos buscarem as coisas para ele","Jingle est trop occupé à envoyer des souris chercher des choses pour lui","Jingle estará tan ocupado como para enviar ratones para recuparle cosas","Jingle слишком занят, отправляя мышей за вещами для него","Jingle 他常常忙著叫小鼠幫他找東西","Jingle jest zbyt zajęty wysyłaniem myszy do przyniesienia rzeczy dla niego.","Jingle túlságosan elfoglalt azzal, hogy egereket küld tárgyakat hordozni neki",""},
QUOTE_101 ={"Icemice is frozen, he can't talk","Icemice está congelado, ele não pode falar","Icemice est gelé, il ne peut pas parler","Icemice está congelado, no puede hablar","Icemice заморожен, он не может говорить","Icemice 是完全的凍住了, 他不能說話","Icemice jest zamrożony, nie może mówić","Icemice lefagyott, nem tud beszélni",""},
QUOTE_102 ={"I just don't know how he plays...","eu só não sei como ele joga...","je ne sais même pas comment il joue...","no sé cómo es que él juega...","я просто не знаю, как он играет...","我不知道他怎麼玩的...","Po prostu nie wiem jak on gra...","nem tudom hogy mégis hogyan tud játszani...",""},
}
